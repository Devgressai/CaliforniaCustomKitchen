...
export const metadata: Metadata = {
  title: 'Custom Kitchens San Mateo | Luxury Cabinetry Peninsula | PineWood Cabinets',
  description: 'Museum-grade custom kitchens and bespoke cabinetry for San Mateo\'s most prestigious homes. Serving Peninsula\'s luxury market with uncompromising craftsmanship since 2006.',
  keywords: [
    'custom kitchens San Mateo',
    'luxury cabinetry Peninsula',
    'bespoke cabinetry San Mateo',
    'custom kitchen cabinets San Mateo',
    'architectural millwork Peninsula',
    'luxury kitchen design San Mateo',
    'custom cabinets San Mateo',
    'high-end kitchen renovation',
    'premium cabinetry San Mateo',
    'custom millwork Peninsula',
    'kitchen design consultation San Mateo',
    'luxury home renovation Peninsula',
    'custom storage solutions San Mateo',
    'wine cellar design San Mateo',
    'kitchen remodeling San Mateo'
  ],
  openGraph: {
    title: 'Custom Kitchens San Mateo | Luxury Cabinetry Peninsula',
    description: 'Museum-grade custom kitchens and bespoke cabinetry for San Mateo\'s most prestigious homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Custom Kitchens San Mateo",
  "Museum-grade custom kitchens and bespoke cabinetry for San Mateo's most prestigious homes in Peninsula",
  "Custom Kitchens",
  ["San Mateo, CA", "Peninsula, CA", "Burlingame, CA", "Foster City, CA", "Redwood City, CA"]
)
...
export default function SanMateoPage() {
  return (
    <>
      ...
      <HeroQuiet
        title="Custom Kitchens San Mateo"
        subtitle="Museum-Grade Cabinetry for Peninsula Luxury"
        description="Serving San Mateo's discerning homeowners with uncompromising craftsmanship and luxury kitchen design since 2006."
        imageSrc="service-areas/san-mateo-hero.webp"
        imageAlt="Luxury custom kitchen in San Mateo home with premium cabinetry and Peninsula views"
      />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in san-mateo</h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                San Mateo represents the sophisticated heart of Peninsula living—where suburban tranquility meets refined luxury. Our San Mateo clients understand that true elegance lies in creating spaces that honor both the neighborhood's charming character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From traditional family homes to contemporary architectural gems, San Mateo's diverse residential landscape demands cabinetry solutions that seamlessly blend suburban comfort with luxury design and uncompromising quality.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-ivory p-6 rounded-lg">
                  <h3 className="font-semibold text-charcoal mb-2">Population</h3>
                  <p className="text-2xl font-bold text-brass">100,000+</p>
                ...
                <div className="bg-ivory p-6 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-brass">$1.5M+</p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/san-mateo-overview.webp"
                alt="San Mateo neighborhood landscape with luxury homes and Peninsula views"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our deep understanding of San Mateo's unique Peninsula environment enables us to deliver cabinetry solutions that perfectly complement both the neighborhood's character and sophisticated living standards.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                San Mateo's Peninsula setting requires cabinetry that works with the natural environment and maximizes views while maintaining functionality.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                San Mateo's suburban setting requires cabinetry that balances family functionality with sophisticated design and luxury materials.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                San Mateo's social lifestyle demands kitchens that can host both intimate family meals and larger social gatherings.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in san-mateo</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              From the historic downtown to the exclusive hillside communities, we serve all of San Mateo's most prestigious neighborhoods.
            </p>
          </div>
      ...
      <section className="py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 font-display">Luxury Kitchen Design in san-mateo</h2>
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                San Mateo's unique Peninsula environment creates distinct requirements for luxury kitchen design. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with Peninsula views to evening entertaining that showcases the home's refined character, every design decision reflects an understanding of how San Mateo residents truly live and enjoy their Peninsula lifestyle.
              </p>
            </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in san-mateo</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of custom kitchens and cabinetry projects throughout San Mateo's most prestigious Peninsula neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/san-mateo-peninsula-kitchen.webp"
                alt="Peninsula kitchen in San Mateo with custom cabinetry and bay views"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/san-mateo-traditional-kitchen.webp"
                alt="Traditional kitchen in San Mateo with classic cabinetry and sophisticated design"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/san-mateo-contemporary-kitchen.webp"
                alt="Contemporary kitchen in San Mateo with modern cabinetry and clean design"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in san-mateo</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our San Mateo kitchens are designed to support the unique Peninsula lifestyle and values of this special community.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80">
              Common questions about custom kitchen design in San Mateo
            </p>
          </div>

          <div className="space-y-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              <h3 className="text-xl font-semibold text-charcoal mb-4">How do you handle San Mateo's Peninsula construction challenges?</h3>
              <p className="text-charcoal/70 leading-relaxed">
                San Mateo's Peninsula locations often present unique structural and access challenges. We work closely with local contractors and engineers to ensure our cabinetry installations are properly supported and accessible. This includes custom mounting systems, reinforced wall attachments, and careful consideration of seismic requirements. Our project management approach includes detailed site analysis and coordination with all trades to ensure smooth installation.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Create Your San Mateo Dream Kitchen?"
        description="Join San Mateo's most discerning homeowners who have chosen PineWood Cabinets for their custom cabinetry needs. Schedule a private consultation to discuss how we can bring your vision to life with uncompromising craftsmanship."
        primaryCTA={{
