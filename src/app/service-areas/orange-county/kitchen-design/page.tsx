...
export const metadata: Metadata = {
  title: 'Kitchen Design Orange County | Kitchen Design | PineWood Cabinets',
  description: 'Luxury kitchen design services for Orange County luxury homes. Expert craftsmen serving Southern California with luxury kitchen solutions.',
  keywords: [
    'kitchen-design orange-county',
    'kitchen-design orange-county',
    'luxury kitchen-design orange-county',
    'custom kitchen-design orange-county',
    'kitchen-design southern california',
    'kitchen-design California'
  ],
  openGraph: {
    title: 'Kitchen Design Orange County | Kitchen Design | PineWood Cabinets',
    description: 'Luxury kitchen design services for Orange County luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Design Orange County",
  "Luxury kitchen design services for Orange County luxury homes for Orange County luxury homes in Southern California",
  "Kitchen Design",
  ["Orange County, CA", "Southern California, CA", "California"]
)

export default function KitchenDesignOrangeCountyPage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Kitchen Design Orange County"
        subtitle="Kitchen Design"
        description="Serving Orange County's most discerning homeowners with Luxury kitchen design services that transform Southern California homes into luxury culinary spaces."
        imageSrc="service-areas/orange-county-kitchen-design-hero.webp"
        imageAlt="Kitchen Design in Orange County home with luxury finishes and Southern California views"
      />

      {/* Orange County Kitchen Design Overview */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic estates to contemporary architectural gems, Orange County's diverse residential landscape demands kitchen-design solutions that seamlessly blend Southern California sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/orange-county-kitchen-design-overview.webp"
                alt="Kitchen Design in Orange County home with luxury finishes and Southern California views"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Full kitchen-design from concept to completion, tailored to your Orange County home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive renovation services that update your Orange County kitchen-design while preserving its architectural integrity and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cosmetic updates that give your Orange County kitchen-design a fresh, modern look without the complexity of a full renovation.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Strategic expansion of your Orange County kitchen-design space to improve functionality and accommodate your growing needs.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Modern updates that bring your Orange County kitchen-design up to current standards while maintaining its unique character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert restoration of historic and vintage Orange County kitchen-design to preserve their original beauty and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your Orange County kitchen-design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your Orange County kitchen-design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
                <li>• Material selection</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional construction and installation of your approved Orange County kitchen-design design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Demolition</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive final walkthrough and project completion for your Orange County kitchen-design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/orange-county-kitchen-design-1.webp"
                alt="Kitchen Design in Orange County home with Southern California views and luxury finishes"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/orange-county-kitchen-design-2.webp"
                alt="Traditional kitchen-design in Orange County with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/orange-county-kitchen-design-3.webp"
                alt="Contemporary kitchen-design in Orange County with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, most of our Orange County kitchen-design clients choose to stay in their homes during the project. We work to minimize disruption by setting up temporary facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Create Your Dream Kitchen Design in Orange County?"
        description="Join Orange County's most discerning homeowners who have chosen PineWood Cabinets for their kitchen-design needs. Schedule a private consultation to discuss how we can bring your vision to life with comprehensive kitchen-design services."
        primaryCTA={{
