...
export const metadata: Metadata = {
  title: 'Kitchen Remodel Marina | Custom Kitchen Services | PineWood Cabinets',
  description: 'Professional complete kitchen renovation and remodeling services for Marina luxury homes. Expert kitchen services serving Monterey Bay with museum-grade craftsmanship.',
  keywords: [
    'kitchen remodel marina',
    'kitchen remodel marina CA',
...
const serviceSchema = generateServiceSchema(
  "Kitchen Remodel Marina",
  "Professional complete kitchen renovation and remodeling services for Marina luxury homes in Monterey Bay",
  "Kitchen Remodel",
  ["Marina, CA", "Monterey Bay, CA", "Monterey, Seaside, Pacific Grove"]
)

export default function KitchenRemodelMarinaPage() {
  return (
    ...
    >
      <ServiceAreaHero
        location="Marina"
        service="Kitchen Remodel"
        description="Serving Marina's discerning homeowners with complete kitchen renovation and remodeling services that transform Monterey Bay homes into luxury culinary spaces."
        imageSrc="service-areas/marina-kitchen-remodel-hero.webp"
        imageAlt="Custom kitchen remodel in Marina home with Monterey Bay views and luxury finishes"
      />

      {/* Marina Kitchen Remodel Overview */}
      <ContentSection background="white" padding="xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionHeader
              title="Marina Kitchen Remodel Excellence"
              description="Marina is experiencing a renaissance as one of Monterey Bay's most promising luxury development areas. With its proximity to world-class golf courses, pristine beaches, and the Monterey Peninsula, Marina offers exceptional opportunities for custom home development and luxury living. Our Marina kitchen remodel clients understand that true elegance lies in creating spaces that honor both the community's unique character and their own sophisticated lifestyle."
            />
            <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
              From growing luxury market and golf course proximity, Marina's diverse residential landscape demands kitchen remodel solutions that seamlessly blend beach access and development opportunities with luxury functionality and uncompromising quality.
            </p>
          ...
          <div className="relative">
            <img
              src="/images/service-areas/marina-kitchen-remodel-overview.webp"
              alt="Custom kitchen remodel in Marina home with Monterey Bay views and luxury finishes"
      ...
      <ContentSection background="ivory" padding="xl">
        <SectionHeader
          title="Kitchen Remodel Services for Marina"
          description="Our comprehensive complete kitchen renovation and remodeling services are tailored to meet the unique needs of Marina's diverse architectural styles and Monterey Bay lifestyle."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={3} gap="lg">
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Full kitchen remodel transformation from design to completion, tailored to your Marina home's unique character and your lifestyle needs.
            </p>
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Premium kitchen remodel services that elevate your Marina home with museum-grade materials and craftsmanship.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Bespoke kitchen remodel solutions designed specifically for your Marina home's unique requirements and aesthetic vision.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Contemporary kitchen remodel designs that bring your Marina home up to current standards while maintaining its unique character.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Classic kitchen remodel designs that honor traditional craftsmanship while providing modern functionality for your Marina home.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Sustainable kitchen remodel solutions that combine environmental responsibility with luxury living in your Marina home.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <ContentSection background="white" padding="xl">
        <SectionHeader
          ...
          description="Our proven kitchen remodel process ensures your Marina project exceeds expectations and perfectly reflects your vision."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={4} gap="lg">
          <Feature
            ...
            description="Comprehensive consultation to understand your vision, needs, and budget for your Marina kitchen remodel project."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">2</span>}
            title="Design Development"
            description="Creation of detailed design plans and 3D renderings for your Marina kitchen remodel project."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">3</span>}
            title="Construction"
            description="Professional construction and installation of your approved Marina kitchen remodel design."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">4</span>}
            title="Final Walkthrough"
            description="Comprehensive final walkthrough and project completion for your Marina kitchen remodel project."
          />
        </Grid>
      </ContentSection>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionHeader
              ...
              description="Marina's unique Monterey Bay environment creates distinct requirements for kitchen remodel projects. Our approach honors the community's character while delivering the functionality and elegance modern residents demand."
              className="text-ivory"
            />
            <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
              From morning coffee with growing luxury market to evening entertaining that showcases the home's refined character, every kitchen remodel decision reflects an understanding of how Marina residents truly live and enjoy their golf course proximity lifestyle.
            </p>
          </div>
      ...
      <ContentSection background="ivory" padding="xl">
        <SectionHeader
          title="Featured Marina Kitchen Remodel Projects"
          description="Explore our portfolio of kitchen remodel projects throughout Marina's most prestigious Monterey Bay neighborhoods."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={3} gap="lg">
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/marina-kitchen-remodel-1.webp"
              alt="Custom kitchen remodel in Marina with Monterey Bay views and luxury finishes"
          ...
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/marina-kitchen-remodel-2.webp"
              alt="Traditional kitchen remodel in Marina with classic design and sophisticated finishes"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
          ...
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/marina-kitchen-remodel-3.webp"
              alt="Contemporary kitchen remodel in Marina with modern design and clean lines"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
      ...
      <ContentSection background="white" padding="xl" maxWidth="2xl">
        <SectionHeader
          title="Marina Kitchen Remodel FAQ"
          description="Common questions about kitchen remodel services in Marina"
          centered
          className="mb-16"
        />
        ...
        <div className="space-y-8">
          <Card>
            ...
            <p className="text-charcoal/70 leading-relaxed">
              A complete kitchen remodel project in Marina typically takes 6-10 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for preparation, 3-5 weeks for construction and installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the scope of work and any unexpected issues that arise.
            </p>
          </Card>
          ...
          <Card>
            ...
            <p className="text-charcoal/70 leading-relaxed">
              Yes, most of our Marina kitchen remodel clients choose to stay in their homes during the project. We work to minimize disruption by setting up temporary facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
            </p>
          </Card>
