...
export const metadata: Metadata = {
  title: 'Kitchen Cabinets Capitola | Custom Kitchen Services | PineWood Cabinets',
  description: 'Professional custom cabinet manufacturing and installation for Capitola luxury homes. Expert kitchen services serving Monterey Bay with museum-grade craftsmanship.',
  keywords: [
    'kitchen cabinets capitola',
    'kitchen cabinets capitola CA',
  ...
  openGraph: {
    title: 'Kitchen Cabinets Capitola | Custom Kitchen Cabinets | PineWood Cabinets',
    description: 'Professional custom cabinet manufacturing and installation for Capitola luxury homes in Monterey Bay.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Cabinets Capitola",
  "Professional custom cabinet manufacturing and installation for Capitola luxury homes in Monterey Bay",
  "Kitchen Cabinets",
  ["Capitola, CA", "Monterey Bay, CA", "Santa Cruz, Aptos, Soquel"]
)

export default function KitchenCabinetsCapitolaPage() {
  return (
    ...
    >
      <ServiceAreaHero
        location="Capitola"
        service="Kitchen Cabinets"
        description="Serving Capitola's discerning homeowners with custom cabinet manufacturing and installation that transform Monterey Bay homes into luxury culinary spaces."
        imageSrc="service-areas/capitola-kitchen-cabinets-hero.webp"
        imageAlt="Custom kitchen cabinets in Capitola home with Monterey Bay views and luxury finishes"
      />

      {/* Capitola Kitchen Cabinets Overview */}
      <ContentSection background="white" padding="xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionHeader
              title="Capitola Kitchen Cabinets Excellence"
              description="This charming beach town along the Santa Cruz coastline offers a unique blend of coastal sophistication and artistic flair. Capitola's colorful architecture and vibrant community create the perfect backdrop for custom homes that celebrate both ocean views and creative expression. Our Capitola kitchen cabinets clients understand that true elegance lies in creating spaces that honor both the community's unique character and their own sophisticated lifestyle."
            />
            <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
              From beach town charm and colorful architecture, Capitola's diverse residential landscape demands kitchen cabinets solutions that seamlessly blend artistic community and coastal views with luxury functionality and uncompromising quality.
            </p>
          ...
          <div className="relative">
            <img
              src="/images/service-areas/capitola-kitchen-cabinets-overview.webp"
              alt="Custom kitchen cabinets in Capitola home with Monterey Bay views and luxury finishes"
      ...
      <ContentSection background="ivory" padding="xl">
        <SectionHeader
          title="Kitchen Cabinets Services for Capitola"
          description="Our comprehensive custom cabinet manufacturing and installation are tailored to meet the unique needs of Capitola's diverse architectural styles and Monterey Bay lifestyle."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={3} gap="lg">
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Full kitchen cabinets transformation from design to completion, tailored to your Capitola home's unique character and your lifestyle needs.
            </p>
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Premium kitchen cabinets services that elevate your Capitola home with museum-grade materials and craftsmanship.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Bespoke kitchen cabinets solutions designed specifically for your Capitola home's unique requirements and aesthetic vision.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Contemporary kitchen cabinets designs that bring your Capitola home up to current standards while maintaining its unique character.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Classic kitchen cabinets designs that honor traditional craftsmanship while providing modern functionality for your Capitola home.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Sustainable kitchen cabinets solutions that combine environmental responsibility with luxury living in your Capitola home.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <ContentSection background="white" padding="xl">
        <SectionHeader
          ...
          description="Our proven kitchen cabinets process ensures your Capitola project exceeds expectations and perfectly reflects your vision."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={4} gap="lg">
          <Feature
            ...
            description="Comprehensive consultation to understand your vision, needs, and budget for your Capitola kitchen cabinets project."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">2</span>}
            title="Design Development"
            description="Creation of detailed design plans and 3D renderings for your Capitola kitchen cabinets project."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">3</span>}
            title="Construction"
            description="Professional construction and installation of your approved Capitola kitchen cabinets design."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">4</span>}
            title="Final Walkthrough"
            description="Comprehensive final walkthrough and project completion for your Capitola kitchen cabinets project."
          />
        </Grid>
      </ContentSection>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionHeader
              ...
              description="Capitola's unique Monterey Bay environment creates distinct requirements for kitchen cabinets projects. Our approach honors the community's character while delivering the functionality and elegance modern residents demand."
              className="text-ivory"
            />
            <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
              From morning coffee with beach town charm to evening entertaining that showcases the home's refined character, every kitchen cabinets decision reflects an understanding of how Capitola residents truly live and enjoy their colorful architecture lifestyle.
            </p>
          </div>
      ...
      <ContentSection background="ivory" padding="xl">
        <SectionHeader
          title="Featured Capitola Kitchen Cabinets Projects"
          description="Explore our portfolio of kitchen cabinets projects throughout Capitola's most prestigious Monterey Bay neighborhoods."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={3} gap="lg">
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/capitola-kitchen-cabinets-1.webp"
              alt="Custom kitchen cabinets in Capitola with Monterey Bay views and luxury finishes"
          ...
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/capitola-kitchen-cabinets-2.webp"
              alt="Traditional kitchen cabinets in Capitola with classic design and sophisticated finishes"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
          ...
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/capitola-kitchen-cabinets-3.webp"
              alt="Contemporary kitchen cabinets in Capitola with modern design and clean lines"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
      ...
      <ContentSection background="white" padding="xl" maxWidth="2xl">
        <SectionHeader
          title="Capitola Kitchen Cabinets FAQ"
          description="Common questions about kitchen cabinets services in Capitola"
          centered
          className="mb-16"
        />
        ...
        <div className="space-y-8">
          <Card>
            ...
            <p className="text-charcoal/70 leading-relaxed">
              A complete kitchen cabinets project in Capitola typically takes 6-10 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for preparation, 3-5 weeks for construction and installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the scope of work and any unexpected issues that arise.
            </p>
          </Card>
