...
export const metadata: Metadata = {
  title: 'Kitchen Remodel Del Rey Oaks | Custom Kitchen Services | PineWood Cabinets',
  description: 'Professional complete kitchen renovation and remodeling services for Del Rey Oaks luxury homes. Expert kitchen services serving Monterey Bay with museum-grade craftsmanship.',
  keywords: [
    'kitchen remodel del rey oaks',
    'kitchen remodel del rey oaks CA',
...
const serviceSchema = generateServiceSchema(
  "Kitchen Remodel Del Rey Oaks",
  "Professional complete kitchen renovation and remodeling services for Del Rey Oaks luxury homes in Monterey Bay",
  "Kitchen Remodel",
  ["Del Rey Oaks, CA", "Monterey Bay, CA", "Monterey, Seaside, Marina"]
)

export default function KitchenRemodelDelReyOaksPage() {
  return (
    ...
    >
      <ServiceAreaHero
        location="Del Rey Oaks"
        service="Kitchen Remodel"
        description="Serving Del Rey Oaks's discerning homeowners with complete kitchen renovation and remodeling services that transform Monterey Bay homes into luxury culinary spaces."
        imageSrc="service-areas/del-rey-oaks-kitchen-remodel-hero.webp"
        imageAlt="Custom kitchen remodel in Del Rey Oaks home with Monterey Bay views and luxury finishes"
      />

      {/* Del Rey Oaks Kitchen Remodel Overview */}
      <ContentSection background="white" padding="xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionHeader
              title="Del Rey Oaks Kitchen Remodel Excellence"
              description="This small, exclusive community offers the perfect blend of privacy and convenience. Del Rey Oaks residents enjoy a quiet, upscale lifestyle while being minutes away from the cultural attractions and natural beauty of the Monterey Peninsula. Our Del Rey Oaks kitchen remodel clients understand that true elegance lies in creating spaces that honor both the community's unique character and their own sophisticated lifestyle."
            />
            <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
              From exclusive small community and privacy, Del Rey Oaks's diverse residential landscape demands kitchen remodel solutions that seamlessly blend convenience and upscale lifestyle with luxury functionality and uncompromising quality.
            </p>
          ...
          <div className="relative">
            <img
              src="/images/service-areas/del-rey-oaks-kitchen-remodel-overview.webp"
              alt="Custom kitchen remodel in Del Rey Oaks home with Monterey Bay views and luxury finishes"
      ...
      <ContentSection background="ivory" padding="xl">
        <SectionHeader
          title="Kitchen Remodel Services for Del Rey Oaks"
          description="Our comprehensive complete kitchen renovation and remodeling services are tailored to meet the unique needs of Del Rey Oaks's diverse architectural styles and Monterey Bay lifestyle."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={3} gap="lg">
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Full kitchen remodel transformation from design to completion, tailored to your Del Rey Oaks home's unique character and your lifestyle needs.
            </p>
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Premium kitchen remodel services that elevate your Del Rey Oaks home with museum-grade materials and craftsmanship.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Bespoke kitchen remodel solutions designed specifically for your Del Rey Oaks home's unique requirements and aesthetic vision.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Contemporary kitchen remodel designs that bring your Del Rey Oaks home up to current standards while maintaining its unique character.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Classic kitchen remodel designs that honor traditional craftsmanship while providing modern functionality for your Del Rey Oaks home.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Sustainable kitchen remodel solutions that combine environmental responsibility with luxury living in your Del Rey Oaks home.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <ContentSection background="white" padding="xl">
        <SectionHeader
          ...
          description="Our proven kitchen remodel process ensures your Del Rey Oaks project exceeds expectations and perfectly reflects your vision."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={4} gap="lg">
          <Feature
            ...
            description="Comprehensive consultation to understand your vision, needs, and budget for your Del Rey Oaks kitchen remodel project."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">2</span>}
            title="Design Development"
            description="Creation of detailed design plans and 3D renderings for your Del Rey Oaks kitchen remodel project."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">3</span>}
            title="Construction"
            description="Professional construction and installation of your approved Del Rey Oaks kitchen remodel design."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">4</span>}
            title="Final Walkthrough"
            description="Comprehensive final walkthrough and project completion for your Del Rey Oaks kitchen remodel project."
          />
        </Grid>
      </ContentSection>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionHeader
              ...
              description="Del Rey Oaks's unique Monterey Bay environment creates distinct requirements for kitchen remodel projects. Our approach honors the community's character while delivering the functionality and elegance modern residents demand."
              className="text-ivory"
            />
            <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
              From morning coffee with exclusive small community to evening entertaining that showcases the home's refined character, every kitchen remodel decision reflects an understanding of how Del Rey Oaks residents truly live and enjoy their privacy lifestyle.
            </p>
          </div>
      ...
      <ContentSection background="ivory" padding="xl">
        <SectionHeader
          title="Featured Del Rey Oaks Kitchen Remodel Projects"
          description="Explore our portfolio of kitchen remodel projects throughout Del Rey Oaks's most prestigious Monterey Bay neighborhoods."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={3} gap="lg">
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/del-rey-oaks-kitchen-remodel-1.webp"
              alt="Custom kitchen remodel in Del Rey Oaks with Monterey Bay views and luxury finishes"
          ...
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/del-rey-oaks-kitchen-remodel-2.webp"
              alt="Traditional kitchen remodel in Del Rey Oaks with classic design and sophisticated finishes"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
          ...
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/del-rey-oaks-kitchen-remodel-3.webp"
              alt="Contemporary kitchen remodel in Del Rey Oaks with modern design and clean lines"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
      ...
      <ContentSection background="white" padding="xl" maxWidth="2xl">
        <SectionHeader
          title="Del Rey Oaks Kitchen Remodel FAQ"
          description="Common questions about kitchen remodel services in Del Rey Oaks"
          centered
          className="mb-16"
        />
        ...
        <div className="space-y-8">
          <Card>
            ...
            <p className="text-charcoal/70 leading-relaxed">
              A complete kitchen remodel project in Del Rey Oaks typically takes 6-10 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for preparation, 3-5 weeks for construction and installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the scope of work and any unexpected issues that arise.
            </p>
          </Card>
          ...
          <Card>
            ...
            <p className="text-charcoal/70 leading-relaxed">
              Yes, most of our Del Rey Oaks kitchen remodel clients choose to stay in their homes during the project. We work to minimize disruption by setting up temporary facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
            </p>
          </Card>
