...
export const metadata: Metadata = {
  title: 'Kitchen Remodel Carmel Valley | Custom Kitchen Services | PineWood Cabinets',
  description: 'Professional complete kitchen renovation and remodeling services for Carmel Valley luxury homes. Expert kitchen services serving Monterey Bay with museum-grade craftsmanship.',
  keywords: [
    'kitchen remodel carmel valley',
    'kitchen remodel carmel valley CA',
...
const serviceSchema = generateServiceSchema(
  "Kitchen Remodel Carmel Valley",
  "Professional complete kitchen renovation and remodeling services for Carmel Valley luxury homes in Monterey Bay",
  "Kitchen Remodel",
  ["Carmel Valley, CA", "Monterey Bay, CA", "Carmel, Monterey, Pebble Beach"]
)

export default function KitchenRemodelCarmelValleyPage() {
  return (
    ...
    >
      <ServiceAreaHero
        location="Carmel Valley"
        service="Kitchen Remodel"
        description="Serving Carmel Valley's discerning homeowners with complete kitchen renovation and remodeling services that transform Monterey Bay homes into luxury culinary spaces."
        imageSrc="service-areas/carmel-valley-kitchen-remodel-hero.webp"
        imageAlt="Custom kitchen remodel in Carmel Valley home with Monterey Bay views and luxury finishes"
      />

      {/* Carmel Valley Kitchen Remodel Overview */}
      <ContentSection background="white" padding="xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionHeader
              title="Carmel Valley Kitchen Remodel Excellence"
              description="Nestled in the rolling hills of Monterey County, Carmel Valley represents the pinnacle of California wine country living. This exclusive enclave is home to some of the most prestigious estates and custom homes in the region, where residents enjoy the perfect blend of rural tranquility and sophisticated luxury. Our Carmel Valley kitchen remodel clients understand that true elegance lies in creating spaces that honor both the community's unique character and their own sophisticated lifestyle."
            />
            <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
              From wine country estates and rolling hills, Carmel Valley's diverse residential landscape demands kitchen remodel solutions that seamlessly blend exclusive residential community and equestrian properties with luxury functionality and uncompromising quality.
            </p>
          ...
          <div className="relative">
            <img
              src="/images/service-areas/carmel-valley-kitchen-remodel-overview.webp"
              alt="Custom kitchen remodel in Carmel Valley home with Monterey Bay views and luxury finishes"
      ...
      <ContentSection background="ivory" padding="xl">
        <SectionHeader
          title="Kitchen Remodel Services for Carmel Valley"
          description="Our comprehensive complete kitchen renovation and remodeling services are tailored to meet the unique needs of Carmel Valley's diverse architectural styles and Monterey Bay lifestyle."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={3} gap="lg">
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Full kitchen remodel transformation from design to completion, tailored to your Carmel Valley home's unique character and your lifestyle needs.
            </p>
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Premium kitchen remodel services that elevate your Carmel Valley home with museum-grade materials and craftsmanship.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Bespoke kitchen remodel solutions designed specifically for your Carmel Valley home's unique requirements and aesthetic vision.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Contemporary kitchen remodel designs that bring your Carmel Valley home up to current standards while maintaining its unique character.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Classic kitchen remodel designs that honor traditional craftsmanship while providing modern functionality for your Carmel Valley home.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Sustainable kitchen remodel solutions that combine environmental responsibility with luxury living in your Carmel Valley home.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <ContentSection background="white" padding="xl">
        <SectionHeader
          ...
          description="Our proven kitchen remodel process ensures your Carmel Valley project exceeds expectations and perfectly reflects your vision."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={4} gap="lg">
          <Feature
            ...
            description="Comprehensive consultation to understand your vision, needs, and budget for your Carmel Valley kitchen remodel project."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">2</span>}
            title="Design Development"
            description="Creation of detailed design plans and 3D renderings for your Carmel Valley kitchen remodel project."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">3</span>}
            title="Construction"
            description="Professional construction and installation of your approved Carmel Valley kitchen remodel design."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">4</span>}
            title="Final Walkthrough"
            description="Comprehensive final walkthrough and project completion for your Carmel Valley kitchen remodel project."
          />
        </Grid>
      </ContentSection>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionHeader
              ...
              description="Carmel Valley's unique Monterey Bay environment creates distinct requirements for kitchen remodel projects. Our approach honors the community's character while delivering the functionality and elegance modern residents demand."
              className="text-ivory"
            />
            <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
              From morning coffee with wine country estates to evening entertaining that showcases the home's refined character, every kitchen remodel decision reflects an understanding of how Carmel Valley residents truly live and enjoy their rolling hills lifestyle.
            </p>
          </div>
      ...
      <ContentSection background="ivory" padding="xl">
        <SectionHeader
          title="Featured Carmel Valley Kitchen Remodel Projects"
          description="Explore our portfolio of kitchen remodel projects throughout Carmel Valley's most prestigious Monterey Bay neighborhoods."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={3} gap="lg">
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/carmel-valley-kitchen-remodel-1.webp"
              alt="Custom kitchen remodel in Carmel Valley with Monterey Bay views and luxury finishes"
          ...
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/carmel-valley-kitchen-remodel-2.webp"
              alt="Traditional kitchen remodel in Carmel Valley with classic design and sophisticated finishes"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
          ...
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/carmel-valley-kitchen-remodel-3.webp"
              alt="Contemporary kitchen remodel in Carmel Valley with modern design and clean lines"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
      ...
      <ContentSection background="white" padding="xl" maxWidth="2xl">
        <SectionHeader
          title="Carmel Valley Kitchen Remodel FAQ"
          description="Common questions about kitchen remodel services in Carmel Valley"
          centered
          className="mb-16"
        />
        ...
        <div className="space-y-8">
          <Card>
            ...
            <p className="text-charcoal/70 leading-relaxed">
              A complete kitchen remodel project in Carmel Valley typically takes 6-10 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for preparation, 3-5 weeks for construction and installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the scope of work and any unexpected issues that arise.
            </p>
          </Card>
          ...
          <Card>
            ...
            <p className="text-charcoal/70 leading-relaxed">
              Yes, most of our Carmel Valley kitchen remodel clients choose to stay in their homes during the project. We work to minimize disruption by setting up temporary facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
            </p>
          </Card>
