...
export const metadata: Metadata = {
  title: 'Kitchen Design La Selva Beach | Custom Kitchen Services | PineWood Cabinets',
  description: 'Professional professional kitchen design and consultation services for La Selva Beach luxury homes. Expert kitchen services serving Monterey Bay with museum-grade craftsmanship.',
  keywords: [
    'kitchen design la selva beach',
    'kitchen design la selva beach CA',
...
const serviceSchema = generateServiceSchema(
  "Kitchen Design La Selva Beach",
  "Professional professional kitchen design and consultation services for La Selva Beach luxury homes in Monterey Bay",
  "Kitchen Design",
  ["La Selva Beach, CA", "Monterey Bay, CA", "Aptos, Capitola, Soquel"]
)

export default function KitchenDesignLaSelvaBeachPage() {
  return (
    ...
    >
      <ServiceAreaHero
        location="La Selva Beach"
        service="Kitchen Design"
        description="Serving La Selva Beach's discerning homeowners with professional kitchen design and consultation services that transform Monterey Bay homes into luxury culinary spaces."
        imageSrc="service-areas/la-selva-beach-kitchen-design-hero.webp"
        imageAlt="Custom kitchen design in La Selva Beach home with Monterey Bay views and luxury finishes"
      />

      {/* La Selva Beach Kitchen Design Overview */}
      <ContentSection background="white" padding="xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionHeader
              title="La Selva Beach Kitchen Design Excellence"
              description="La Selva Beach represents the pinnacle of exclusive coastal living along the Monterey Bay. This private beach community offers residents unparalleled ocean access and privacy, making it one of the most sought-after locations for luxury custom homes in the region. Our La Selva Beach kitchen design clients understand that true elegance lies in creating spaces that honor both the community's unique character and their own sophisticated lifestyle."
            />
            <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
              From exclusive beach community and private beach access, La Selva Beach's diverse residential landscape demands kitchen design solutions that seamlessly blend luxury homes and privacy with luxury functionality and uncompromising quality.
            </p>
          ...
          <div className="relative">
            <img
              src="/images/service-areas/la-selva-beach-kitchen-design-overview.webp"
              alt="Custom kitchen design in La Selva Beach home with Monterey Bay views and luxury finishes"
      ...
      <ContentSection background="ivory" padding="xl">
        <SectionHeader
          title="Kitchen Design Services for La Selva Beach"
          description="Our comprehensive professional kitchen design and consultation services are tailored to meet the unique needs of La Selva Beach's diverse architectural styles and Monterey Bay lifestyle."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={3} gap="lg">
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Full kitchen design transformation from design to completion, tailored to your La Selva Beach home's unique character and your lifestyle needs.
            </p>
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Premium kitchen design services that elevate your La Selva Beach home with museum-grade materials and craftsmanship.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Bespoke kitchen design solutions designed specifically for your La Selva Beach home's unique requirements and aesthetic vision.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Contemporary kitchen design designs that bring your La Selva Beach home up to current standards while maintaining its unique character.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Classic kitchen design designs that honor traditional craftsmanship while providing modern functionality for your La Selva Beach home.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Sustainable kitchen design solutions that combine environmental responsibility with luxury living in your La Selva Beach home.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <ContentSection background="white" padding="xl">
        <SectionHeader
          ...
          description="Our proven kitchen design process ensures your La Selva Beach project exceeds expectations and perfectly reflects your vision."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={4} gap="lg">
          <Feature
            ...
            description="Comprehensive consultation to understand your vision, needs, and budget for your La Selva Beach kitchen design project."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">2</span>}
            title="Design Development"
            description="Creation of detailed design plans and 3D renderings for your La Selva Beach kitchen design project."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">3</span>}
            title="Construction"
            description="Professional construction and installation of your approved La Selva Beach kitchen design design."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">4</span>}
            title="Final Walkthrough"
            description="Comprehensive final walkthrough and project completion for your La Selva Beach kitchen design project."
          />
        </Grid>
      </ContentSection>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionHeader
              ...
              description="La Selva Beach's unique Monterey Bay environment creates distinct requirements for kitchen design projects. Our approach honors the community's character while delivering the functionality and elegance modern residents demand."
              className="text-ivory"
            />
            <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
              From morning coffee with exclusive beach community to evening entertaining that showcases the home's refined character, every kitchen design decision reflects an understanding of how La Selva Beach residents truly live and enjoy their private beach access lifestyle.
            </p>
          </div>
      ...
      <ContentSection background="ivory" padding="xl">
        <SectionHeader
          title="Featured La Selva Beach Kitchen Design Projects"
          description="Explore our portfolio of kitchen design projects throughout La Selva Beach's most prestigious Monterey Bay neighborhoods."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={3} gap="lg">
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/la-selva-beach-kitchen-design-1.webp"
              alt="Custom kitchen design in La Selva Beach with Monterey Bay views and luxury finishes"
          ...
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/la-selva-beach-kitchen-design-2.webp"
              alt="Traditional kitchen design in La Selva Beach with classic design and sophisticated finishes"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
          ...
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/la-selva-beach-kitchen-design-3.webp"
              alt="Contemporary kitchen design in La Selva Beach with modern design and clean lines"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
      ...
      <ContentSection background="white" padding="xl" maxWidth="2xl">
        <SectionHeader
          title="La Selva Beach Kitchen Design FAQ"
          description="Common questions about kitchen design services in La Selva Beach"
          centered
          className="mb-16"
        />
        ...
        <div className="space-y-8">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 leading-relaxed">
              Yes, most of our La Selva Beach kitchen design clients choose to stay in their homes during the project. We work to minimize disruption by setting up temporary facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
            </p>
          </Card>
