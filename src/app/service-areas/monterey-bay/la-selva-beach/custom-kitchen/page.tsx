...
export const metadata: Metadata = {
  title: 'Custom Kitchen La Selva Beach | Custom Kitchen Services | PineWood Cabinets',
  description: 'Professional bespoke kitchen design and construction for La Selva Beach luxury homes. Expert kitchen services serving Monterey Bay with museum-grade craftsmanship.',
  keywords: [
    'custom kitchen la selva beach',
    'custom kitchen la selva beach CA',
    'custom kitchen la selva beach',
...
const serviceSchema = generateServiceSchema(
  "Custom Kitchen La Selva Beach",
  "Professional bespoke kitchen design and construction for La Selva Beach luxury homes in Monterey Bay",
  "Custom Kitchen",
  ["La Selva Beach, CA", "Monterey Bay, CA", "Aptos, Capitola, Soquel"]
)

export default function CustomKitchenLaSelvaBeachPage() {
  return (
    ...
    >
      <ServiceAreaHero
        location="La Selva Beach"
        service="Custom Kitchen"
        description="Serving La Selva Beach's discerning homeowners with bespoke kitchen design and construction that transform Monterey Bay homes into luxury culinary spaces."
        imageSrc="service-areas/la-selva-beach-custom-kitchen-hero.webp"
        imageAlt="Custom custom kitchen in La Selva Beach home with Monterey Bay views and luxury finishes"
      />

      {/* La Selva Beach Custom Kitchen Overview */}
      <ContentSection background="white" padding="xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionHeader
              title="La Selva Beach Custom Kitchen Excellence"
              description="La Selva Beach represents the pinnacle of exclusive coastal living along the Monterey Bay. This private beach community offers residents unparalleled ocean access and privacy, making it one of the most sought-after locations for luxury custom homes in the region. Our La Selva Beach custom kitchen clients understand that true elegance lies in creating spaces that honor both the community's unique character and their own sophisticated lifestyle."
            />
            <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
              From exclusive beach community and private beach access, La Selva Beach's diverse residential landscape demands custom kitchen solutions that seamlessly blend luxury homes and privacy with luxury functionality and uncompromising quality.
            </p>
          ...
          <div className="relative">
            <img
              src="/images/service-areas/la-selva-beach-custom-kitchen-overview.webp"
              alt="Custom custom kitchen in La Selva Beach home with Monterey Bay views and luxury finishes"
      ...
      <ContentSection background="ivory" padding="xl">
        <SectionHeader
          title="Custom Kitchen Services for La Selva Beach"
          description="Our comprehensive bespoke kitchen design and construction are tailored to meet the unique needs of La Selva Beach's diverse architectural styles and Monterey Bay lifestyle."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={3} gap="lg">
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Full custom kitchen transformation from design to completion, tailored to your La Selva Beach home's unique character and your lifestyle needs.
            </p>
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Premium custom kitchen services that elevate your La Selva Beach home with museum-grade materials and craftsmanship.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Bespoke custom kitchen solutions designed specifically for your La Selva Beach home's unique requirements and aesthetic vision.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Contemporary custom kitchen designs that bring your La Selva Beach home up to current standards while maintaining its unique character.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Classic custom kitchen designs that honor traditional craftsmanship while providing modern functionality for your La Selva Beach home.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <Card>
            ...
            <p className="text-charcoal/70 mb-4">
              Sustainable custom kitchen solutions that combine environmental responsibility with luxury living in your La Selva Beach home.
            </p>
            <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <ContentSection background="white" padding="xl">
        <SectionHeader
          ...
          description="Our proven custom kitchen process ensures your La Selva Beach project exceeds expectations and perfectly reflects your vision."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={4} gap="lg">
          <Feature
            ...
            description="Comprehensive consultation to understand your vision, needs, and budget for your La Selva Beach custom kitchen project."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">2</span>}
            title="Design Development"
            description="Creation of detailed design plans and 3D renderings for your La Selva Beach custom kitchen project."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">3</span>}
            title="Construction"
            description="Professional construction and installation of your approved La Selva Beach custom kitchen design."
          />

          <Feature
            icon={<span className="text-2xl font-bold text-brass">4</span>}
            title="Final Walkthrough"
            description="Comprehensive final walkthrough and project completion for your La Selva Beach custom kitchen project."
          />
        </Grid>
      </ContentSection>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionHeader
              ...
              description="La Selva Beach's unique Monterey Bay environment creates distinct requirements for custom kitchen projects. Our approach honors the community's character while delivering the functionality and elegance modern residents demand."
              className="text-ivory"
            />
            <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
              From morning coffee with exclusive beach community to evening entertaining that showcases the home's refined character, every custom kitchen decision reflects an understanding of how La Selva Beach residents truly live and enjoy their private beach access lifestyle.
            </p>
          </div>
      ...
      <ContentSection background="ivory" padding="xl">
        <SectionHeader
          title="Featured La Selva Beach Custom Kitchen Projects"
          description="Explore our portfolio of custom kitchen projects throughout La Selva Beach's most prestigious Monterey Bay neighborhoods."
          centered
          className="mb-16"
        />
        ...
        <Grid columns={3} gap="lg">
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/la-selva-beach-custom-kitchen-1.webp"
              alt="Custom custom kitchen in La Selva Beach with Monterey Bay views and luxury finishes"
          ...
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/la-selva-beach-custom-kitchen-2.webp"
              alt="Traditional custom kitchen in La Selva Beach with classic design and sophisticated finishes"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
          ...
          <Card className="overflow-hidden">
            <img
              src="/images/portfolio/la-selva-beach-custom-kitchen-3.webp"
              alt="Contemporary custom kitchen in La Selva Beach with modern design and clean lines"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
      ...
      <ContentSection background="white" padding="xl" maxWidth="2xl">
        <SectionHeader
          title="La Selva Beach Custom Kitchen FAQ"
          description="Common questions about custom kitchen services in La Selva Beach"
          centered
          className="mb-16"
        />
        ...
        <div className="space-y-8">
          <Card>
            ...
            <p className="text-charcoal/70 leading-relaxed">
              A complete custom kitchen project in La Selva Beach typically takes 6-10 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for preparation, 3-5 weeks for construction and installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the scope of work and any unexpected issues that arise.
            </p>
          </Card>
          ...
          <Card>
            ...
            <p className="text-charcoal/70 leading-relaxed">
              Yes, most of our La Selva Beach custom kitchen clients choose to stay in their homes during the project. We work to minimize disruption by setting up temporary facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
            </p>
          </Card>
