...
export const metadata: Metadata = {
  title: 'Kitchen Design Pebble Beach | Kitchen Design | PineWood Cabinets',
  description: 'Luxury kitchen design services for Pebble Beach luxury homes. Expert craftsmen serving Central California with luxury kitchen solutions.',
  keywords: [
    'kitchen-design pebble-beach',
    'kitchen-design pebble-beach',
    'luxury kitchen-design pebble-beach',
  ...
  openGraph: {
    title: 'Kitchen Design Pebble Beach | Kitchen Design | PineWood Cabinets',
    description: 'Luxury kitchen design services for Pebble Beach luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Design Pebble Beach",
  "Luxury kitchen design services for Pebble Beach luxury homes for Pebble Beach luxury homes in Central California",
  "Kitchen Design",
  ...
  return (
    <>
      ...
      <HeroQuiet
        ...
        description="Serving Pebble Beach's most discerning homeowners with Luxury kitchen design services that transform Central California homes into luxury culinary spaces."
        imageSrc="service-areas/pebble-beach-kitchen-design-hero.webp"
        imageAlt="Kitchen Design in Pebble Beach home with luxury finishes and Central California views"
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Pebble Beach represents the pinnacle of Central California luxury—where sophistication meets refined elegance. Our Pebble Beach kitchen-design clients understand that true luxury lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic estates to contemporary architectural gems, Pebble Beach's diverse residential landscape demands kitchen-design solutions that seamlessly blend Central California sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                ...
                alt="Kitchen Design in Pebble Beach home with luxury finishes and Central California views"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive kitchen-design services are tailored to meet the unique needs of Pebble Beach's diverse architectural styles and Central California lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive renovation services that update your Pebble Beach kitchen-design while preserving its architectural integrity and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cosmetic updates that give your Pebble Beach kitchen-design a fresh, modern look without the complexity of a full renovation.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Strategic expansion of your Pebble Beach kitchen-design space to improve functionality and accommodate your growing needs.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Modern updates that bring your Pebble Beach kitchen-design up to current standards while maintaining its unique character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert restoration of historic and vintage Pebble Beach kitchen-design to preserve their original beauty and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven process ensures your Pebble Beach kitchen-design exceeds expectations and perfectly reflects your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional construction and installation of your approved Pebble Beach kitchen-design design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Demolition</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive final walkthrough and project completion for your Pebble Beach kitchen-design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Pebble Beach's unique Central California environment creates distinct requirements for kitchen-design. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of kitchen-design projects throughout Pebble Beach's most prestigious Central California neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                ...
                alt="Kitchen Design in Pebble Beach home with Central California views and luxury finishes"
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A complete kitchen-design in Pebble Beach typically takes 8-12 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for demolition and preparation, 4-6 weeks for construction and installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the scope of work and any unexpected issues that arise.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, most of our Pebble Beach kitchen-design clients choose to stay in their homes during the project. We work to minimize disruption by setting up temporary facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Create Your Dream Kitchen Design in Pebble Beach?"
        description="Join Pebble Beach's most discerning homeowners who have chosen PineWood Cabinets for their kitchen-design needs. Schedule a private consultation to discuss how we can bring your vision to life with comprehensive kitchen-design services."
        primaryCTA={{
