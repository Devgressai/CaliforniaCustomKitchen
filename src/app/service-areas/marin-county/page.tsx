...
export const metadata: Metadata = {
  title: 'Custom Kitchens Marin County | Luxury Cabinetry | AV\'s Cabinets California',
  description: 'Custom kitchens and luxury cabinetry for Marin County\'s most prestigious estates. AV\'s Cabinets brings European craftsmanship to California\'s premier luxury community.',
  keywords: 'custom kitchens Marin County, luxury cabinetry Marin County, estate kitchens, luxury kitchens California, Marin County homes',
  openGraph: {
    title: 'Custom Kitchens Marin County | Luxury Cabinetry | AV\'s Cabinets California',
    description: 'Custom kitchens and luxury cabinetry for Marin County\'s most prestigious estates.',
    type: 'website',
  },
}
...
const localArchitecture = [
  {
    style: 'Contemporary Marin',
    description: 'Marin County\'s contemporary homes feature clean lines, natural materials, and expansive windows that frame the stunning bay and mountain views. Our cabinetry complements these elements with minimalist designs and premium materials.',
    characteristics: ['Clean lines', 'Natural materials', 'Bay views', 'Minimalist design']
  },
  {
    style: 'Traditional Marin',
    description: 'Traditional Marin homes embrace the area\'s natural setting with classic details, natural materials, and timeless charm. Our cabinetry honors this tradition with hand-crafted details and authentic materials.',
    characteristics: ['Classic details', 'Natural materials', 'Timeless charm', 'Hand-crafted elements']
  },
  {
    style: 'Hillside Modern',
    description: 'Hillside modern homes maximize views and natural light while maintaining luxury finishes. Our cabinetry integrates seamlessly with these spaces, offering clean lines and premium materials.',
...
const localInsights = [
  {
    title: 'Bay Area Lifestyle',
    description: 'Marin County residents value the connection to nature and outdoor living. We design cabinetry that enhances this connection while providing the luxury and functionality expected in bay area estates.',
    icon: '🌊'
  },
  {
    title: 'Entertainment Focus',
    description: 'Many Marin County homes are designed for entertaining, with open floor plans and integrated indoor-outdoor living. We create cabinetry that supports this lifestyle with flexible storage and serving solutions.',
    icon: '🍽️'
  },
  {
    title: 'Luxury Living',
    description: 'Marin County residents expect the finest materials and finishes. We work exclusively with premium hardwoods, custom hardware, and luxury finishes that meet the highest standards.',
    icon: '💎'
  },
  {
    title: 'Natural Integration',
    description: 'The natural environment requires special consideration for views and natural light. We use materials and finishes that complement the natural setting while maintaining luxury aesthetics.',
    icon: '🌲'
  }
]
...
const bayAreaConsiderations = [
  {
    aspect: 'Bay Views',
    description: 'Marin County\'s bay views require special consideration for maximizing natural light and scenery. We design cabinetry that enhances these views while providing practical storage and functionality.',
    features: ['View enhancement', 'Natural light', 'Bay integration', 'Functional design']
  },
  {
    aspect: 'Indoor-Outdoor Living',
    description: 'Bay area living emphasizes the connection between indoor and outdoor spaces. We design cabinetry that supports this lifestyle with flexible storage and serving solutions.',
    features: ['Outdoor integration', 'Flexible storage', 'Serving solutions', 'Lifestyle support']
  },
  {
    aspect: 'Luxury Standards',
    description: 'Marin County residents expect the highest standards of luxury and quality. We provide cabinetry solutions that meet these expectations with premium materials and finishes.',
...
const localMaterials = [
  {
    name: 'Walnut',
    description: 'Rich walnut provides exceptional beauty and durability for high-end Marin County applications. Its warm color and fine grain create a sophisticated appearance perfect for luxury homes.',
...
const luxuryCommunities = [
  {
    name: 'Tiburon',
    description: 'An exclusive waterfront community with stunning bay views and luxury amenities. Our cabinetry designs complement the luxury waterfront lifestyle.',
    features: ['Waterfront community', 'Bay views', 'Luxury amenities', 'Exclusive access']
  },
  {
    name: 'Ross',
  ...
  {
    name: 'Mill Valley',
    description: 'A private hillside community with custom homes and mountain views. Our cabinetry designs complement the luxury lifestyle and natural setting.',
    features: ['Private community', 'Custom homes', 'Mountain views', 'Luxury lifestyle']
  }
]
...
const seasonalConsiderations = [
  {
    season: 'Summer',
    description: 'Summer in Marin County is all about outdoor living and entertaining. Our cabinetry designs support this lifestyle with integrated outdoor kitchen connections and flexible storage for seasonal items.',
...
const bayAreaFeatures = [
  {
    feature: 'Bay View Integration',
    description: 'Custom cabinetry designed to complement and enhance bay views, with materials and finishes that work harmoniously with the natural setting.',
    benefits: ['View enhancement', 'Natural integration', 'Harmonious design', 'Bay area aesthetic']
  },
  {
  ...
  },
  {
    ...
    description: 'Premium materials and finishes that meet the highest standards of luxury living expected in Marin County.',
    ...
    <div className="min-h-screen bg-ivory">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <span className="bg-deep-green/20 text-ivory px-4 py-2 rounded-full">Bay Area Estates</span>
              <span className="bg-deep-green/20 text-ivory px-4 py-2 rounded-full">Waterfront Views</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="prose-luxury text-charcoal/80 mb-8">
                ...
                <p>
                  We understand the unique characteristics of Marin County living, from the emphasis on indoor-outdoor living to the integration of natural materials and finishes. Our designs incorporate materials and finishes that celebrate the bay area aesthetic while providing practical solutions for luxury living.
                </p>
                <p>
                  Our local knowledge extends to Marin County\'s diverse architectural styles, from contemporary hillside homes to traditional bay area estates. We work closely with each client to ensure our cabinetry complements their home\'s unique character while meeting their specific lifestyle requirements.
                </p>
                <p>
                  The Marin County lifestyle emphasizes quality, natural beauty, and attention to detail. Our cabinetry reflects these values through hand-crafted details, premium materials, and designs that enhance the bay area living experience. We understand that Marin County homes are not just places to live, but spaces for entertaining, relaxation, and creating lasting memories.
                </p>
                <p>
                  Marin County\'s natural setting and luxury amenities create a unique environment for high-end living. Our designs honor this setting while providing modern functionality and luxury finishes that meet the highest standards of bay area living.
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="bg-french-gray/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-charcoal/70">Serving Marin County</p>
                </div>
                <div className="bg-french-gray/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-charcoal mb-2">85+ Projects</h4>
                  <p className="text-sm text-charcoal/70">Completed in Marin County</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-french-gray/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-charcoal mb-2">Bay Views</h4>
      ...
      <section className="py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {bayAreaFeatures.map((feature, index) => (
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {bayAreaConsiderations.map((aspect, index) => (
              <div key={aspect.aspect} className="text-center">
                <div className="text-4xl mb-4">
                  {aspect.aspect === 'Bay Views' ? '🌊' : aspect.aspect === 'Indoor-Outdoor Living' ? '🏡' : '💎'}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-ivory/10 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-ivory mb-3 font-display">
                How do you design for bay views and natural light?
              </h3>
              <p className="text-french-gray leading-relaxed">
                We design cabinetry that enhances bay views and maximizes natural light. This includes strategic placement, materials that complement the natural setting, and designs that don\'t obstruct the views that make Marin County special.
              </p>
            </div>

            <div className="bg-ivory/10 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-ivory mb-3 font-display">
                Can you work with hillside properties and their unique requirements?
              </h3>
              <p className="text-french-gray leading-relaxed">
                Absolutely. We have extensive experience working with hillside properties, including considerations for views, natural light, and the integration of indoor-outdoor living spaces that are essential to the Marin County lifestyle.
              </p>
            </div>
            ...
            <div className="bg-ivory/10 p-6 rounded-lg">
              ...
              <p className="text-french-gray leading-relaxed">
                Yes, we work exclusively with premium materials and luxury finishes that meet the highest standards expected in Marin County. This includes custom hardware, premium hardwoods, and finishes that enhance the luxury living experience.
              </p>
            </div>

            <div className="bg-ivory/10 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-ivory mb-3 font-display">
                What is the typical timeline for a Marin County project?
              </h3>
              <p className="text-french-gray leading-relaxed">
                Most Marin County projects take 6-8 months from consultation to completion. This includes 2-3 months for design and planning, 3-4 months for fabrication, and 2-3 weeks for installation. We can work around vacation schedules and seasonal considerations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-grain">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="btn-primary">
              Schedule Marin County Consultation
            </Link>
            <Link href="/portfolio" className="btn-ghost">
              View Marin County Projects
            </Link>
          </div>
        </div>
      </section>
