...
export const metadata: Metadata = {
  title: 'Kitchen Cabinets Belvedere | Kitchen Cabinets | PineWood Cabinets',
  description: 'Custom kitchen cabinets and cabinetry for Belvedere luxury homes. Expert craftsmen serving Marin County with luxury kitchen solutions.',
  keywords: [
    'kitchen-cabinets belvedere',
    'kitchen-cabinets belvedere',
    'luxury kitchen-cabinets belvedere',
  ...
  openGraph: {
    title: 'Kitchen Cabinets Belvedere | Kitchen Cabinets | PineWood Cabinets',
    description: 'Custom kitchen cabinets and cabinetry for Belvedere luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Cabinets Belvedere",
  "Custom kitchen cabinets and cabinetry for Belvedere luxury homes for Belvedere luxury homes in Marin County",
  "Kitchen Cabinets",
  ...
  return (
    <>
      ...
      <HeroQuiet
        ...
        description="Serving Belvedere's most discerning homeowners with Custom kitchen cabinets and cabinetry that transform Marin County homes into luxury culinary spaces."
        imageSrc="service-areas/belvedere-kitchen-cabinets-hero.webp"
        imageAlt="Kitchen Cabinets in Belvedere home with luxury finishes and Marin County views"
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Belvedere represents the pinnacle of Marin County luxury—where sophistication meets refined elegance. Our Belvedere kitchen-cabinets clients understand that true luxury lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic estates to contemporary architectural gems, Belvedere's diverse residential landscape demands kitchen-cabinets solutions that seamlessly blend Marin County sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                ...
                alt="Kitchen Cabinets in Belvedere home with luxury finishes and Marin County views"
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Kitchen Cabinets Services for Belvedere
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive kitchen-cabinets services are tailored to meet the unique needs of Belvedere's diverse architectural styles and Marin County lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Full kitchen-cabinets from concept to completion, tailored to your Belvedere home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive renovation services that update your Belvedere kitchen-cabinets while preserving its architectural integrity and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cosmetic updates that give your Belvedere kitchen-cabinets a fresh, modern look without the complexity of a full renovation.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Strategic expansion of your Belvedere kitchen-cabinets space to improve functionality and accommodate your growing needs.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Modern updates that bring your Belvedere kitchen-cabinets up to current standards while maintaining its unique character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven process ensures your Belvedere kitchen-cabinets exceeds expectations and perfectly reflects your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your Belvedere kitchen-cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your Belvedere kitchen-cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
                <li>• Material selection</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional construction and installation of your approved Belvedere kitchen-cabinets design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Demolition</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive final walkthrough and project completion for your Belvedere kitchen-cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Featured Belvedere Kitchen Cabinets Projects
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of kitchen-cabinets projects throughout Belvedere's most prestigious Marin County neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                ...
                alt="Kitchen Cabinets in Belvedere home with Marin County views and luxury finishes"
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80">
              Common questions about kitchen-cabinets services in Belvedere
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A complete kitchen-cabinets in Belvedere typically takes 8-12 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for demolition and preparation, 4-6 weeks for construction and installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the scope of work and any unexpected issues that arise.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Create Your Dream Kitchen Cabinets in Belvedere?"
        description="Join Belvedere's most discerning homeowners who have chosen PineWood Cabinets for their kitchen-cabinets needs. Schedule a private consultation to discuss how we can bring your vision to life with comprehensive kitchen-cabinets services."
        primaryCTA={{
