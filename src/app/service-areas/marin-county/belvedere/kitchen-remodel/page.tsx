...
export const metadata: Metadata = {
  title: 'Kitchen Remodel Belvedere | Kitchen Remodel | PineWood Cabinets',
  description: 'Complete kitchen remodeling services for Belvedere luxury homes. Expert craftsmen serving Marin County with luxury kitchen solutions.',
  keywords: [
    'kitchen-remodel belvedere',
    'kitchen-remodel belvedere',
    'luxury kitchen-remodel belvedere',
    'custom kitchen-remodel belvedere',
    'kitchen-remodel marin county',
    'kitchen-remodel California'
  ],
  openGraph: {
    title: 'Kitchen Remodel Belvedere | Kitchen Remodel | PineWood Cabinets',
    description: 'Complete kitchen remodeling services for Belvedere luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Remodel Belvedere",
  "Complete kitchen remodeling services for Belvedere luxury homes for Belvedere luxury homes in Marin County",
  "Kitchen Remodel",
  ...
  return (
    <>
      ...
      <HeroQuiet
        ...
        description="Serving Belvedere's most discerning homeowners with Complete kitchen remodeling services that transform Marin County homes into luxury culinary spaces."
        imageSrc="service-areas/belvedere-kitchen-remodel-hero.webp"
        imageAlt="Kitchen Remodel in Belvedere home with luxury finishes and Marin County views"
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Belvedere represents the pinnacle of Marin County luxury—where sophistication meets refined elegance. Our Belvedere kitchen-remodel clients understand that true luxury lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic estates to contemporary architectural gems, Belvedere's diverse residential landscape demands kitchen-remodel solutions that seamlessly blend Marin County sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                ...
                alt="Kitchen Remodel in Belvedere home with luxury finishes and Marin County views"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Full kitchen-remodel from concept to completion, tailored to your Belvedere home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive renovation services that update your Belvedere kitchen-remodel while preserving its architectural integrity and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cosmetic updates that give your Belvedere kitchen-remodel a fresh, modern look without the complexity of a full renovation.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Strategic expansion of your Belvedere kitchen-remodel space to improve functionality and accommodate your growing needs.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Modern updates that bring your Belvedere kitchen-remodel up to current standards while maintaining its unique character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert restoration of historic and vintage Belvedere kitchen-remodel to preserve their original beauty and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven process ensures your Belvedere kitchen-remodel exceeds expectations and perfectly reflects your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Belvedere's unique Marin County environment creates distinct requirements for kitchen-remodel. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                ...
                alt="Kitchen Remodel in Belvedere home with Marin County views and luxury finishes"
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, most of our Belvedere kitchen-remodel clients choose to stay in their homes during the project. We work to minimize disruption by setting up temporary facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Create Your Dream Kitchen Remodel in Belvedere?"
        description="Join Belvedere's most discerning homeowners who have chosen PineWood Cabinets for their kitchen-remodel needs. Schedule a private consultation to discuss how we can bring your vision to life with comprehensive kitchen-remodel services."
        primaryCTA={{
