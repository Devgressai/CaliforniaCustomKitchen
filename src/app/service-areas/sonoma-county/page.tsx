...
export const metadata: Metadata = {
  title: 'Custom Kitchens Sonoma County | Luxury Cabinetry | AV\'s Cabinets California',
  description: 'Custom kitchens and luxury cabinetry for Sonoma County\'s most prestigious wine country estates. AV\'s Cabinets brings European craftsmanship to California\'s premier wine region.',
  keywords: 'custom kitchens Sonoma County, luxury cabinetry Sonoma County, wine country kitchens, estate cabinetry, luxury kitchens California',
  openGraph: {
    title: 'Custom Kitchens Sonoma County | Luxury Cabinetry | AV\'s Cabinets California',
    description: 'Custom kitchens and luxury cabinetry for Sonoma County\'s most prestigious wine country estates.',
    type: 'website',
  },
}
...
const localArchitecture = [
  {
    ...
    description: 'Sonoma County\'s traditional wine country homes feature natural materials, warm finishes, and expansive windows that frame the stunning vineyard views. Our cabinetry complements these elements with rustic elegance and premium materials.',
    characteristics: ['Natural materials', 'Warm finishes', 'Vineyard views', 'Rustic elegance']
  },
  {
    style: 'Farmhouse Revival',
    description: 'Farmhouse Revival homes in Sonoma County embrace the agricultural setting with reclaimed materials, traditional details, and authentic charm. Our cabinetry honors this tradition with hand-crafted details and vintage-inspired designs.',
    characteristics: ['Reclaimed materials', 'Traditional details', 'Vintage inspiration', 'Agricultural charm']
  },
  {
...
const localInsights = [
  {
    ...
    description: 'Sonoma County residents embrace the wine country lifestyle, with homes designed for entertaining and wine appreciation. We create cabinetry that supports this lifestyle with integrated wine storage and serving solutions.',
    icon: '🍷'
  },
  {
    title: 'Agricultural Heritage',
    description: 'We work with materials that connect your home to Sonoma County\'s agricultural heritage, including reclaimed wood, local stone, and finishes that complement the wine country setting.',
    icon: '🌾'
  },
  {
    title: 'Entertainment Focus',
    description: 'Sonoma County homes are designed for entertaining, with open floor plans and integrated indoor-outdoor living. We create cabinetry that supports this lifestyle with flexible storage and serving solutions.',
    icon: '🍽️'
  },
  {
    title: 'Luxury Wine Country Living',
    description: 'Sonoma County residents expect luxury wine country living with resort-level amenities. We provide the same attention to detail and quality that defines the area\'s luxury wineries and resorts.',
    icon: '🏨'
  }
]
...
const wineCountryConsiderations = [
  {
    ...
    description: 'Sonoma County\'s vineyard environment requires special consideration for views and natural light. We design cabinetry that enhances these views while providing practical storage and functionality.',
...
const localMaterials = [
  {
    name: 'Reclaimed Wood',
    description: 'Reclaimed wood from local sources provides a connection to Sonoma County\'s agricultural history while offering unique character and environmental responsibility. Perfect for wine country aesthetics.',
    benefits: ['Historical connection', 'Unique character', 'Environmental responsibility', 'Wine country aesthetic']
  },
  {
    name: 'Cedar',
    description: 'Aromatic cedar provides natural resistance to moisture and insects, making it perfect for Sonoma County\'s climate conditions. Its pleasant scent and warm color complement the wine country setting.',
  ...
  {
    name: 'Stone Accents',
    description: 'Local stone accents complement our cabinetry designs, creating a seamless connection to Sonoma County\'s natural environment and vineyard setting.',
    benefits: ['Natural connection', 'Local materials', 'Visual harmony', 'Vineyard integration']
  }
]

const wineCommunities = [
  {
    name: 'Healdsburg',
  ...
  {
    name: 'Sebastopol',
    description: 'A premier wine country community with custom homes and farmhouse charm. Our designs enhance the luxury wine country living experience.',
    features: ['Wine country community', 'Custom homes', 'Farmhouse charm', 'Luxury lifestyle']
  },
  {
    name: 'Petaluma',
...
const seasonalConsiderations = [
  {
    ...
    description: 'Harvest season in Sonoma County is all about wine production and entertaining. Our cabinetry designs support this lifestyle with integrated wine storage, serving solutions, and spaces that embrace the harvest atmosphere.',
...
export default function SonomaCountyPage() {
  return (
      ...
      <div className="heading-structure" style="display: none;">
        <h1>Custom Kitchens in sonoma-county | Luxury Cabinetry</h1>
        <h2>Luxury Kitchen Design in sonoma-county</h2><h2>Premium Materials & Craftsmanship</h2><h2>Local Kitchen Design Expertise</h2><h2>Custom Kitchen Services</h2><h2>Why Choose Us for sonoma-county Kitchens</h2><h2>Frequently Asked Questions</h2>
    ...
    <div className="min-h-screen bg-ivory">
      ...
      <section className="relative py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 font-display">Custom Kitchens in sonoma-county | Luxury Cabinetry</h1>
            <p className="text-xl md:text-2xl text-french-gray leading-relaxed mb-8">
              Serving Sonoma County\'s most prestigious wine country estates with custom kitchens and luxury cabinetry that celebrates the natural beauty of California\'s premier wine region.
            </p>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in sonoma-county</h2>
              <div className="prose-luxury text-charcoal/80 mb-8">
                <p>
                  Sonoma County represents the pinnacle of wine country luxury living in California. Our custom cabinetry solutions are designed to complement the area\'s stunning vineyard views while providing the luxury and functionality expected in wine country estates.
                </p>
                <p>
                ...
                <p>
                  Our local knowledge extends to Sonoma County\'s diverse architectural styles, from traditional wine country homes to contemporary vineyard estates. We work closely with each client to ensure our cabinetry complements their home\'s unique character while meeting their specific wine country lifestyle requirements.
                </p>
                <p>
                ...
                <p>
                  Sonoma County\'s agricultural heritage and wine country charm create a unique setting for luxury living. Our designs honor this heritage while providing modern functionality and luxury finishes that meet the highest standards of wine country living.
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="bg-french-gray/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-charcoal/70">Serving Sonoma County</p>
                </div>
                <div className="bg-french-gray/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-charcoal mb-2">65+ Projects</h4>
                  <p className="text-sm text-charcoal/70">Completed in Sonoma County</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-french-gray/10 p-4 rounded-lg">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our recent work in Sonoma County, showcasing how we\'ve transformed kitchens and living spaces throughout the area\'s most prestigious wine country communities.
            </p>
          </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in sonoma-county</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Sonoma County\'s diverse architectural styles require specialized cabinetry solutions. We understand how to work with each style to create harmonious, functional spaces.
            </p>
          </div>
      ...
      <section className="py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 font-display">Luxury Kitchen Design in sonoma-county</h2>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in sonoma-county</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Sonoma County\'s wine country environment requires special design considerations. We create cabinetry solutions that work beautifully in the wine country setting.
            </p>
          </div>
      ...
      <section className="py-24 bg-grain">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in sonoma-county</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              We serve Sonoma County\'s most exclusive wine communities, each with its own unique character and luxury amenities.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {wineCommunities.map((community, index) => (
      ...
      <section className="py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 font-display">Luxury Kitchen Design in sonoma-county</h2>
            <p className="text-xl text-french-gray max-w-3xl mx-auto">
              Sonoma County\'s seasonal nature requires thoughtful design considerations. We create cabinetry solutions that work beautifully throughout all seasons.
            </p>
          </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in sonoma-county</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              We work with materials that are specifically chosen for Sonoma County\'s wine country environment while providing exceptional beauty and durability.
            </p>
          </div>
      ...
      <section className="py-24 bg-grain">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in sonoma-county</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Understanding the unique characteristics of Sonoma County helps us create cabinetry solutions that truly serve our clients\' needs.
            </p>
          </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in sonoma-county</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              We serve all of Sonoma County\'s prestigious neighborhoods, from the exclusive wine communities to the stunning vineyard estates.
            </p>
          </div>
      ...
      <section className="py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 font-display">Luxury Kitchen Design in sonoma-county</h2>
            <p className="text-xl text-french-gray max-w-3xl mx-auto">
              Common questions about our services in Sonoma County and the surrounding wine country communities.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="bg-ivory/10 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-ivory mb-3 font-display">
                What is the typical timeline for a Sonoma County project?
              </h3>
              <p className="text-french-gray leading-relaxed">
                Most Sonoma County projects take 6-8 months from consultation to completion. This includes 2-3 months for design and planning, 3-4 months for fabrication, and 2-3 weeks for installation. We can work around harvest schedules and seasonal considerations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-grain">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-charcoal/80 mb-12 max-w-3xl mx-auto">
            Let\'s discuss how we can create the perfect kitchen or cabinetry solution for your Sonoma County home, combining wine country luxury with vineyard views.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="btn-primary">
              Schedule Sonoma County Consultation
            </Link>
            <Link href="/portfolio" className="btn-ghost">
              View Sonoma County Projects
            </Link>
          </div>
        </div>
      </section>
