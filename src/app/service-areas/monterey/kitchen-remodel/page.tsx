...
export const metadata: Metadata = {
  title: 'Kitchen Remodel Monterey | Custom Kitchen Remodeling | PineWood Cabinets',
  description: 'Custom kitchen remodeling for Monterey luxury homes. Expert kitchen remodelers serving Monterey County with complete renovation services.',
  keywords: [
    'kitchen remodel Monterey',
    'kitchen remodeling Monterey',
    'kitchen renovation Monterey',
  ...
  openGraph: {
    title: 'Kitchen Remodel Monterey | Custom Kitchen Remodeling | PineWood Cabinets',
    description: 'Custom kitchen remodeling for Monterey luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Remodel Monterey",
  "Custom kitchen remodeling for Monterey luxury homes in Monterey County",
  "Kitchen Remodeling",
  ["Monterey, CA", "Carmel, CA", "Carmel-by-the-Sea, CA", "Big Sur, CA", "Pacific Grove, CA"]
)

export default function KitchenRemodelMontereyPage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Kitchen Remodel Monterey"
        subtitle="Custom Kitchen Remodeling"
        description="Serving Monterey's discerning homeowners with complete kitchen remodeling services that transform Monterey County homes into luxury culinary spaces."
        imageSrc="service-areas/monterey-kitchen-remodel-hero.webp"
        imageAlt="Custom kitchen remodel in Monterey home with ocean views and luxury finishes"
      />

      {/* Monterey Kitchen Remodel Overview */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic adobe homes to contemporary architectural gems, Monterey's diverse residential landscape demands kitchen remodel solutions that seamlessly blend coastal sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/monterey-kitchen-remodel-overview.webp"
                alt="Custom kitchen remodel in Monterey home with ocean views and luxury finishes"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Full kitchen transformation from design to completion, tailored to your Monterey home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive renovation services that update your Monterey kitchen while preserving its architectural integrity and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cosmetic updates that give your Monterey kitchen a fresh, modern look without the complexity of a full remodel.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your Monterey kitchen remodel.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your Monterey kitchen remodel.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional construction and installation of your approved Monterey kitchen remodel design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Demolition</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive final walkthrough and project completion for your Monterey kitchen remodel.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with ocean views to evening entertaining that showcases the home's refined character, every remodel decision reflects an understanding of how Monterey residents truly live and enjoy their coastal lifestyle.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/monterey-kitchen-remodel-1.webp"
                alt="Custom kitchen remodel in Monterey with ocean views and luxury finishes"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/monterey-kitchen-remodel-2.webp"
                alt="Traditional kitchen remodel in Monterey with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/monterey-kitchen-remodel-3.webp"
                alt="Contemporary kitchen remodel in Monterey with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, most of our Monterey kitchen remodel clients choose to stay in their homes during the project. We work to minimize disruption by setting up temporary kitchen facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Transform Your Monterey Kitchen with a Complete Remodel?"
        description="Join Monterey's most discerning homeowners who have chosen PineWood Cabinets for their kitchen remodel needs. Schedule a private consultation to discuss how we can bring your vision to life with comprehensive remodeling services."
        primaryCTA={{
