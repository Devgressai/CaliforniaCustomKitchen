...
export const metadata: Metadata = {
  title: 'Kitchen Remodel Santa Cruz | Custom Kitchen Remodeling | PineWood Cabinets',
  description: 'Custom kitchen remodeling for Santa Cruz luxury homes. Expert kitchen remodelers serving Monterey County with complete renovation services.',
  keywords: [
  ...
  openGraph: {
    title: 'Kitchen Remodel Santa Cruz | Custom Kitchen Remodeling | PineWood Cabinets',
    description: 'Custom kitchen remodeling for Santa Cruz luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Remodel Santa Cruz",
  "Custom kitchen remodeling for Santa Cruz luxury homes in Monterey County",
  "Kitchen Remodeling",
  ["Santa Cruz, CA", "Carmel, CA", "Monterey, CA", "Big Sur, CA", "Pacific Grove, CA"]
)

export default function KitchenRemodelSantaCruzPage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Kitchen Remodel Santa Cruz"
        subtitle="Custom Kitchen Remodeling"
        description="Serving Santa Cruz's discerning homeowners with complete kitchen remodeling services that transform Monterey County homes into luxury culinary spaces."
        imageSrc="service-areas/santa-cruz-kitchen-remodel-hero.webp"
        imageAlt="Custom kitchen remodel in Santa Cruz home with coastal views and luxury finishes"
      />

      {/* Santa Cruz Kitchen Remodel Overview */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
                Santa Cruz Kitchen Remodel Excellence
              </h2>
              ...
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic beach cottages to contemporary architectural gems, Santa Cruz's diverse residential landscape demands kitchen remodel solutions that seamlessly blend coastal sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/santa-cruz-kitchen-remodel-overview.webp"
                alt="Custom kitchen remodel in Santa Cruz home with coastal views and luxury finishes"
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Kitchen Remodel Services for Santa Cruz
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive kitchen remodel services are tailored to meet the unique needs of Santa Cruz's diverse architectural styles and coastal lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Full kitchen transformation from design to completion, tailored to your Santa Cruz home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive renovation services that update your Santa Cruz kitchen while preserving its architectural integrity and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cosmetic updates that give your Santa Cruz kitchen a fresh, modern look without the complexity of a full remodel.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven remodel process ensures your Santa Cruz kitchen transformation exceeds expectations and perfectly reflects your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your Santa Cruz kitchen remodel.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your Santa Cruz kitchen remodel.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional construction and installation of your approved Santa Cruz kitchen remodel design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Demolition</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive final walkthrough and project completion for your Santa Cruz kitchen remodel.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Santa Cruz's unique coastal environment creates distinct requirements for kitchen remodels. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with ocean views to evening entertaining that showcases the home's refined character, every remodel decision reflects an understanding of how Santa Cruz residents truly live and enjoy their coastal lifestyle.
              </p>
            </div>
            <div className="space-y-6">
              <div className="bg-ivory/10 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3">Ocean Integration</h3>
                <p className="text-ivory/80">Remodel designs that maximize ocean and coastal views while maintaining functionality and aesthetic appeal.</p>
              </div>
              <div className="bg-ivory/10 p-6 rounded-lg">
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Featured Santa Cruz Kitchen Remodel Projects
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of kitchen remodel projects throughout Santa Cruz's most prestigious coastal neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/santa-cruz-kitchen-remodel-1.webp"
                alt="Custom kitchen remodel in Santa Cruz home with ocean views and luxury finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold text-charcoal mb-2">Ocean Views</h3>
                <p className="text-charcoal/70 mb-4">Kitchen remodel that maximizes ocean and coastal views while maintaining functionality and luxury.</p>
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/santa-cruz-kitchen-remodel-2.webp"
                alt="Traditional kitchen remodel in Santa Cruz with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/santa-cruz-kitchen-remodel-3.webp"
                alt="Contemporary kitchen remodel in Santa Cruz with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Santa Cruz Kitchen Remodel FAQ
            </h2>
            <p className="text-xl text-charcoal/80">
              Common questions about kitchen remodel services in Santa Cruz
            </p>
          </div>
      ...
      <CTASection
        title="Ready to Transform Your Santa Cruz Kitchen with a Complete Remodel?"
        description="Join Santa Cruz's most discerning homeowners who have chosen PineWood Cabinets for their kitchen remodel needs. Schedule a private consultation to discuss how we can bring your vision to life with comprehensive remodeling services."
        primaryCTA={{
