...
export const metadata: Metadata = {
  title: 'Kitchen Cabinets Seaside | Custom Kitchen Cabinets | PineWood Cabinets',
  description: 'Custom kitchen cabinets for Seaside luxury homes. Expert cabinet makers serving Monterey County with bespoke cabinetry solutions.',
  keywords: [
    'kitchen cabinets Seaside',
    'custom kitchen cabinets Seaside',
    'kitchen cabinet makers Seaside',
  ...
  openGraph: {
    title: 'Kitchen Cabinets Seaside | Custom Kitchen Cabinets | PineWood Cabinets',
    description: 'Custom kitchen cabinets for Seaside luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Cabinets Seaside",
  "Custom kitchen cabinets for Seaside luxury homes in Monterey County",
  "Kitchen Cabinets",
  ["Seaside, CA", "Carmel, CA", "Monterey, CA", "Big Sur, CA", "Pacific Grove, CA"]
)

export default function KitchenCabinetsSeasidePage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Kitchen Cabinets Seaside"
        subtitle="Custom Kitchen Cabinets"
        description="Serving Seaside's discerning homeowners with custom kitchen cabinets that transform Monterey County homes into luxury culinary spaces."
        imageSrc="service-areas/seaside-kitchen-cabinets-hero.webp"
        imageAlt="Custom kitchen cabinets in Seaside home with ocean views and luxury finishes"
      />

      {/* Seaside Kitchen Cabinets Overview */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
                Seaside Kitchen Cabinets Excellence
              </h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Seaside represents the sophisticated heart of California's Central Coast—where coastal elegance meets refined luxury. Our Seaside kitchen cabinet clients understand that true elegance lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic cottages to contemporary architectural gems, Seaside's diverse residential landscape demands kitchen cabinet solutions that seamlessly blend coastal sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/seaside-kitchen-cabinets-overview.webp"
                alt="Custom kitchen cabinets in Seaside home with ocean views and luxury finishes"
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Kitchen Cabinet Services for Seaside
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive kitchen cabinet services are tailored to meet the unique needs of Seaside's diverse architectural styles and coastal lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Bespoke kitchen cabinets designed and crafted specifically for your Seaside home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cabinet refacing services that give your Seaside kitchen a fresh, modern look without the complexity of a full replacement.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Professional repair services that restore your Seaside kitchen cabinets to their original beauty and functionality.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Door repair</li>
                <li>• Drawer repair</li>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Professional installation services that ensure your Seaside kitchen cabinets are perfectly positioned and functioning optimally.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Custom design services that create the perfect kitchen cabinet solution for your Seaside home's unique character and your lifestyle.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert restoration services that preserve the original beauty and character of your Seaside kitchen cabinets.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven construction process ensures your Seaside kitchen cabinets exceed expectations and perfectly reflect your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive design and planning for your Seaside kitchen cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Careful selection of premium materials for your Seaside kitchen cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Expert construction of your Seaside kitchen cabinets with attention to detail.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional installation of your Seaside kitchen cabinets with final inspection.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Precise installation</li>
                <li>• Hardware installation</li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Seaside's unique coastal environment creates distinct requirements for kitchen cabinets. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with ocean views to evening entertaining that showcases the home's refined character, every cabinet decision reflects an understanding of how Seaside residents truly live and enjoy their coastal lifestyle.
              </p>
            </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Featured Seaside Kitchen Cabinet Projects
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of kitchen cabinet projects throughout Seaside's most prestigious coastal neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/seaside-kitchen-cabinets-1.webp"
                alt="Custom kitchen cabinets in Seaside home with ocean views and luxury finishes"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/seaside-kitchen-cabinets-2.webp"
                alt="Traditional kitchen cabinets in Seaside with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/seaside-kitchen-cabinets-3.webp"
                alt="Contemporary kitchen cabinets in Seaside with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Seaside Kitchen Cabinets FAQ
            </h2>
            <p className="text-xl text-charcoal/80">
              Common questions about kitchen cabinet services in Seaside
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Custom kitchen cabinets in Seaside typically take 8-12 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for material selection and ordering, 4-6 weeks for construction, and 1-2 weeks for installation and finishing. The timeline may vary depending on the complexity of the project and any custom requirements.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, we can match existing kitchen cabinets in Seaside, whether you're looking to add new cabinets to complement existing ones or replace damaged cabinets while maintaining the overall design consistency. We'll carefully match the wood species, finish, and hardware to ensure a seamless integration with your existing kitchen.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Transform Your Seaside Kitchen with Custom Cabinets?"
        description="Join Seaside's most discerning homeowners who have chosen PineWood Cabinets for their kitchen cabinet needs. Schedule a private consultation to discuss how we can bring your vision to life with bespoke design and craftsmanship."
        primaryCTA={{
