...
export const metadata: Metadata = {
  title: 'Kitchen Remodel Seaside | Custom Kitchen Remodeling | PineWood Cabinets',
  description: 'Custom kitchen remodeling for Seaside luxury homes. Expert kitchen remodelers serving Monterey County with complete renovation services.',
  keywords: [
  ...
  openGraph: {
    title: 'Kitchen Remodel Seaside | Custom Kitchen Remodeling | PineWood Cabinets',
    description: 'Custom kitchen remodeling for Seaside luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Remodel Seaside",
  "Custom kitchen remodeling for Seaside luxury homes in Monterey County",
  "Kitchen Remodeling",
  ["Seaside, CA", "Carmel, CA", "Monterey, CA", "Big Sur, CA", "Pacific Grove, CA"]
)

export default function KitchenRemodelSeasidePage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Kitchen Remodel Seaside"
        subtitle="Custom Kitchen Remodeling"
        description="Serving Seaside's discerning homeowners with complete kitchen remodeling services that transform Monterey County homes into luxury culinary spaces."
        imageSrc="service-areas/seaside-kitchen-remodel-hero.webp"
        imageAlt="Custom kitchen remodel in Seaside home with ocean views and luxury finishes"
      />

      {/* Seaside Kitchen Remodel Overview */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic cottages to contemporary architectural gems, Seaside's diverse residential landscape demands kitchen remodel solutions that seamlessly blend coastal sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/seaside-kitchen-remodel-overview.webp"
                alt="Custom kitchen remodel in Seaside home with ocean views and luxury finishes"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Full kitchen transformation from design to completion, tailored to your Seaside home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive renovation services that update your Seaside kitchen while preserving its architectural integrity and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cosmetic updates that give your Seaside kitchen a fresh, modern look without the complexity of a full remodel.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Strategic expansion of your Seaside kitchen space to improve functionality and accommodate your growing needs.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Modern updates that bring your Seaside kitchen up to current standards while maintaining its unique character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert restoration of historic and vintage Seaside kitchens to preserve their original beauty and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your Seaside kitchen remodel.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your Seaside kitchen remodel.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional construction and installation of your approved Seaside kitchen remodel design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Demolition</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive final walkthrough and project completion for your Seaside kitchen remodel.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with ocean views to evening entertaining that showcases the home's refined character, every remodel decision reflects an understanding of how Seaside residents truly live and enjoy their coastal lifestyle.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/seaside-kitchen-remodel-1.webp"
                alt="Custom kitchen remodel in Seaside home with ocean views and luxury finishes"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/seaside-kitchen-remodel-2.webp"
                alt="Traditional kitchen remodel in Seaside with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/seaside-kitchen-remodel-3.webp"
                alt="Contemporary kitchen remodel in Seaside with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A complete kitchen remodel in Seaside typically takes 8-12 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for demolition and preparation, 4-6 weeks for construction and installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the scope of work and any unexpected issues that arise.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, most of our Seaside kitchen remodel clients choose to stay in their homes during the project. We work to minimize disruption by setting up temporary kitchen facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Transform Your Seaside Kitchen with a Complete Remodel?"
        description="Join Seaside's most discerning homeowners who have chosen PineWood Cabinets for their kitchen remodel needs. Schedule a private consultation to discuss how we can bring your vision to life with comprehensive remodeling services."
        primaryCTA={{
