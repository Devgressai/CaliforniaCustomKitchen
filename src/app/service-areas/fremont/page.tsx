...
export const metadata: Metadata = {
  title: 'Custom Kitchens Fremont | Luxury Cabinetry East Bay | PineWood Cabinets',
  description: 'Museum-grade custom kitchens and bespoke cabinetry for Fremont\'s most prestigious homes. Serving East Bay\'s luxury market with uncompromising craftsmanship since 2006.',
  keywords: [
    'custom kitchens Fremont',
    'luxury cabinetry East Bay',
    'bespoke cabinetry Fremont',
    'custom kitchen cabinets Fremont',
    'architectural millwork East Bay',
    'luxury kitchen design Fremont',
    'custom cabinets Fremont',
    'high-end kitchen renovation',
    'premium cabinetry Fremont',
    'custom millwork East Bay',
    'kitchen design consultation Fremont',
    'luxury home renovation East Bay',
    'custom storage solutions Fremont',
    'wine cellar design Fremont',
    'kitchen remodeling Fremont'
  ],
  openGraph: {
    title: 'Custom Kitchens Fremont | Luxury Cabinetry East Bay',
    description: 'Museum-grade custom kitchens and bespoke cabinetry for Fremont\'s most prestigious homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Custom Kitchens Fremont",
  "Museum-grade custom kitchens and bespoke cabinetry for Fremont's most prestigious homes in East Bay",
  "Custom Kitchens",
  ["Fremont, CA", "East Bay, CA", "Union City, CA", "Newark, CA", "Hayward, CA"]
)
...
export default function FremontPage() {
  return (
    <>
      ...
      <HeroQuiet
        title="Custom Kitchens Fremont"
        subtitle="Museum-Grade Cabinetry for East Bay Luxury"
        description="Serving Fremont's discerning homeowners with uncompromising craftsmanship and luxury kitchen design since 2006."
        imageSrc="service-areas/fremont-hero.webp"
        imageAlt="Luxury custom kitchen in Fremont home with premium cabinetry and East Bay views"
      />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in fremont</h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Fremont represents the sophisticated heart of East Bay living—where suburban tranquility meets refined luxury. Our Fremont clients understand that true elegance lies in creating spaces that honor both the neighborhood's charming character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From traditional family homes to contemporary architectural gems, Fremont's diverse residential landscape demands cabinetry solutions that seamlessly blend suburban comfort with luxury design and uncompromising quality.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-ivory p-6 rounded-lg">
                  <h3 className="font-semibold text-charcoal mb-2">Population</h3>
                  <p className="text-2xl font-bold text-brass">230,000+</p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/fremont-overview.webp"
                alt="Fremont neighborhood landscape with luxury homes and East Bay views"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our deep understanding of Fremont's unique East Bay environment enables us to deliver cabinetry solutions that perfectly complement both the neighborhood's character and sophisticated living standards.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Fremont's East Bay setting requires cabinetry that works with the natural environment and maximizes views while maintaining functionality.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Fremont's suburban setting requires cabinetry that balances family functionality with sophisticated design and luxury materials.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Fremont's social lifestyle demands kitchens that can host both intimate family meals and larger social gatherings.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in fremont</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              From the historic downtown to the exclusive hillside communities, we serve all of Fremont's most prestigious neighborhoods.
            </p>
          </div>
      ...
      <section className="py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 font-display">Luxury Kitchen Design in fremont</h2>
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Fremont's unique East Bay environment creates distinct requirements for luxury kitchen design. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with East Bay views to evening entertaining that showcases the home's refined character, every design decision reflects an understanding of how Fremont residents truly live and enjoy their East Bay lifestyle.
              </p>
            </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in fremont</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of custom kitchens and cabinetry projects throughout Fremont's most prestigious East Bay neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/fremont-east-bay-kitchen.webp"
                alt="East Bay kitchen in Fremont with custom cabinetry and valley views"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/fremont-traditional-kitchen.webp"
                alt="Traditional kitchen in Fremont with classic cabinetry and sophisticated design"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/fremont-contemporary-kitchen.webp"
                alt="Contemporary kitchen in Fremont with modern cabinetry and clean design"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in fremont</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our Fremont kitchens are designed to support the unique East Bay lifestyle and values of this special community.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80">
              Common questions about custom kitchen design in Fremont
            </p>
          </div>

          <div className="space-y-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              <h3 className="text-xl font-semibold text-charcoal mb-4">How do you handle Fremont's East Bay construction challenges?</h3>
              <p className="text-charcoal/70 leading-relaxed">
                Fremont's East Bay locations often present unique structural and access challenges. We work closely with local contractors and engineers to ensure our cabinetry installations are properly supported and accessible. This includes custom mounting systems, reinforced wall attachments, and careful consideration of seismic requirements. Our project management approach includes detailed site analysis and coordination with all trades to ensure smooth installation.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Create Your Fremont Dream Kitchen?"
        description="Join Fremont's most discerning homeowners who have chosen PineWood Cabinets for their custom cabinetry needs. Schedule a private consultation to discuss how we can bring your vision to life with uncompromising craftsmanship."
        primaryCTA={{
