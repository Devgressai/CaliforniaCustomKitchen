...
export const metadata: Metadata = {
  ...
  description: 'Custom kitchens and luxury cabinetry for Lake Tahoe\'s most prestigious lakefront estates. AV\'s Cabinets brings European craftsmanship to California\'s premier mountain resort community.',
  keywords: 'custom kitchens Lake Tahoe, luxury cabinetry Lake Tahoe, lakefront estate kitchens, mountain home cabinetry, luxury kitchens California',
  openGraph: {
    title: 'Custom Kitchens Lake Tahoe | Luxury Cabinetry | AV\'s Cabinets California',
    description: 'Custom kitchens and luxury cabinetry for Lake Tahoe\'s most prestigious lakefront estates.',
    type: 'website',
  },
}
...
const localArchitecture = [
  {
    ...
    description: 'Lake Tahoe\'s mountain contemporary homes feature clean lines, natural materials, and expansive windows that frame the stunning lake views. Our cabinetry complements these elements with minimalist designs and premium materials.',
    characteristics: ['Clean lines', 'Natural materials', 'Expansive windows', 'Minimalist design']
  },
  {
    style: 'Rustic Lodge',
    description: 'Traditional rustic lodge homes embrace the mountain setting with natural wood, stone, and cozy details. Our cabinetry honors this tradition with reclaimed materials and hand-crafted details.',
    characteristics: ['Reclaimed materials', 'Hand-crafted details', 'Natural finishes', 'Cozy atmosphere']
  },
  {
    style: 'Lakefront Modern',
    description: 'Modern lakefront homes maximize views and natural light while maintaining luxury finishes. Our cabinetry integrates seamlessly with these spaces, offering clean lines and premium materials.',
...
const localInsights = [
  {
    ...
    description: 'Lake Tahoe residents value the connection to nature and water. We design cabinetry that enhances this connection while providing the luxury and functionality expected in lakefront estates.',
    icon: '🏔️'
  },
  {
    title: 'Entertainment Focus',
    description: 'Many Lake Tahoe homes are designed for entertaining, with open floor plans and integrated indoor-outdoor living. We create cabinetry that supports this lifestyle with flexible storage and serving solutions.',
    icon: '🍽️'
  },
  {
    title: 'Seasonal Living',
    description: 'Lake Tahoe\'s seasonal nature requires flexible design solutions. We create cabinetry that works year-round, from summer entertaining to winter coziness.',
    icon: '❄️'
  },
  {
    title: 'Luxury Resort Living',
    description: 'Lake Tahoe residents expect resort-level luxury and service. We provide the same attention to detail and quality that defines the area\'s luxury resorts.',
    icon: '🏨'
  }
]
...
const seasonalConsiderations = [
  {
    season: 'Summer',
    description: 'Summer in Lake Tahoe is all about outdoor living and entertaining. Our cabinetry designs support this lifestyle with integrated outdoor kitchen connections and flexible storage for seasonal items.',
    features: ['Outdoor kitchen integration', 'Seasonal storage', 'Entertainment support', 'Flexible design']
  },
  {
    season: 'Winter',
    ...
    features: ['Cozy design elements', 'Winter gear storage', 'Warm materials', 'Indoor focus']
  },
  {
    season: 'Year-Round',
...
const localMaterials = [
  {
    name: 'Reclaimed Wood',
    description: 'Reclaimed wood from local sources provides a connection to Lake Tahoe\'s history while offering unique character and environmental responsibility.',
    benefits: ['Historical connection', 'Unique character', 'Environmental responsibility', 'Local sourcing']
  },
  {
    name: 'Cedar',
    description: 'Aromatic cedar provides natural resistance to moisture and insects, making it perfect for Lake Tahoe\'s variable climate conditions.',
  ...
  {
    name: 'Stone Accents',
    description: 'Local stone accents complement our cabinetry designs, creating a seamless connection to Lake Tahoe\'s natural environment.',
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <span className="bg-deep-green/20 text-ivory px-4 py-2 rounded-full">Lakefront Estates</span>
              <span className="bg-deep-green/20 text-ivory px-4 py-2 rounded-full">Mountain Luxury</span>
              <span className="bg-deep-green/20 text-ivory px-4 py-2 rounded-full">Resort Living</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="prose-luxury text-charcoal/80 mb-8">
                ...
                <p>
                  Our local knowledge extends to Lake Tahoe\'s diverse architectural styles, from rustic mountain lodges to contemporary lakefront homes. We work closely with each client to ensure our cabinetry complements their home\'s unique character while meeting their specific lifestyle requirements.
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="bg-french-gray/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-charcoal/70">Serving Lake Tahoe</p>
                </div>
                <div className="bg-french-gray/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-charcoal mb-2">40+ Projects</h4>
                  <p className="text-sm text-charcoal/70">Completed in Lake Tahoe</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-french-gray/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-charcoal mb-2">Mountain Materials</h4>
                  <p className="text-sm text-charcoal/70">Climate-appropriate materials</p>
                </div>
                <div className="bg-french-gray/10 p-4 rounded-lg">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-ivory/10 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-ivory mb-3 font-display">
                How do you handle the variable climate conditions in Lake Tahoe?
              </h3>
              <p className="text-french-gray leading-relaxed">
                We use materials and finishes specifically chosen for Lake Tahoe\'s climate conditions. This includes moisture-resistant materials, appropriate sealants, and finishes that can handle temperature fluctuations and humidity changes.
              </p>
            </div>

            <div className="bg-ivory/10 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-ivory mb-3 font-display">
                Can you work with lakefront properties and their unique requirements?
              </h3>
              <p className="text-french-gray leading-relaxed">
                Absolutely. We have extensive experience working with lakefront properties, including considerations for views, natural light, and the integration of indoor-outdoor living spaces that are essential to the Lake Tahoe lifestyle.
              </p>
            </div>
            ...
            <div className="bg-ivory/10 p-6 rounded-lg">
              ...
              <p className="text-french-gray leading-relaxed">
                Yes, we design cabinetry solutions that work beautifully throughout all seasons. This includes flexible storage for seasonal items, materials that perform well in variable conditions, and designs that enhance both summer entertaining and winter coziness.
              </p>
            </div>

            <div className="bg-ivory/10 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-ivory mb-3 font-display">
                What is the typical timeline for a Lake Tahoe project?
              </h3>
              <p className="text-french-gray leading-relaxed">
                Most Lake Tahoe projects take 6-8 months from consultation to completion. This includes 2-3 months for design and planning, 3-4 months for fabrication, and 2-3 weeks for installation. We can work around seasonal considerations and vacation schedules.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-grain">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="btn-primary">
              Schedule Lake Tahoe Consultation
            </Link>
            <Link href="/portfolio" className="btn-ghost">
              View Lake Tahoe Projects
            </Link>
          </div>
        </div>
      </section>
