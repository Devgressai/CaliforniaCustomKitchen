...
export const metadata: Metadata = {
  title: 'Custom Kitchen Builder in Meeks Bay | Luxury Cabinetry | AV\'s Cabinets',
  description: 'Custom kitchen builder in Meeks Bay specializing in luxury cabinetry for Lake Tahoe\'s most pristine west shore communities. European craftsmanship meets untouched mountain living.',
  keywords: 'custom kitchen builder Meeks Bay, luxury cabinetry Lake Tahoe, custom kitchens Meeks Bay, kitchen renovation Meeks Bay, bespoke cabinetry Lake Tahoe',
  openGraph: {
    title: 'Custom Kitchen Builder in Meeks Bay | Luxury Cabinetry | AV\'s Cabinets',
...
const localProjects = [
  {
    title: 'Meeks Bay Wilderness Estate Kitchen',
    location: 'Meeks Bay, CA',
    description: 'A magnificent wilderness estate kitchen renovation featuring custom cherry cabinetry and panoramic lake views. Designed to maximize the pristine west shore setting while providing luxury functionality.',
    imageSrc: '/images/portfolio/meeks-bay-wilderness-kitchen.webp',
    imageAlt: 'Custom wilderness estate kitchen with panoramic Lake Tahoe views in Meeks Bay',
    year: '2024'
  },
  {
    title: 'Mountain Retreat Meeks Bay Kitchen',
    location: 'Meeks Bay, CA',
    description: 'A sophisticated mountain retreat kitchen with handcrafted details and premium materials. Perfect for the exclusive Meeks Bay lifestyle with integrated outdoor living spaces.',
    imageSrc: '/images/portfolio/meeks-bay-retreat-kitchen.webp',
    imageAlt: 'Mountain retreat kitchen in Meeks Bay with sophisticated design',
    year: '2024'
  },
  {
    title: 'Traditional Meeks Bay Cabin Kitchen',
    location: 'Meeks Bay, CA',
    description: 'A classic traditional cabin kitchen renovation with handcrafted details and natural finishes. Designed for elegant family gatherings and mountain living in Meeks Bay.',
    imageSrc: '/images/portfolio/meeks-bay-traditional-kitchen.webp',
    imageAlt: 'Traditional cabin kitchen in Meeks Bay with handcrafted details',
    year: '2023'
  }
]
...
const localArchitecture = [
  {
    style: 'Wilderness Estate',
    description: 'Meeks Bay\'s wilderness estates feature grand proportions, natural materials, and expansive lake views. Our cabinetry complements these elements with sophisticated designs and premium materials that enhance the pristine setting.',
    characteristics: ['Grand proportions', 'Natural materials', 'Lake views', 'Sophisticated design']
  },
  {
    style: 'Mountain Retreat',
    description: 'Mountain retreat homes in Meeks Bay embrace rustic elegance with natural textures and premium finishes. Our cabinetry honors this aesthetic with hand-crafted details and authentic materials that reflect the wilderness environment.',
...
const localInsights = [
  {
    title: 'Wilderness Luxury Living',
    description: 'Meeks Bay residents value the pristine wilderness environment and exclusive outdoor recreation. We design cabinetry that supports this lifestyle while providing the luxury and functionality expected in wilderness estates.',
    icon: '🏔️'
  },
  {
    title: 'Exclusive Entertaining',
    description: 'Many Meeks Bay homes are designed for exclusive entertaining, with grand spaces and integrated indoor-outdoor living. We create cabinetry that supports this lifestyle with elegant storage and serving solutions.',
    icon: '🍽️'
  },
  {
    title: 'Wilderness Luxury',
    description: 'Meeks Bay residents expect the finest materials and finishes. We work exclusively with premium hardwoods, custom hardware, and luxury finishes that meet the highest standards of wilderness luxury.',
    icon: '💎'
  },
  {
    title: 'Natural Harmony',
    description: 'The wilderness environment requires special consideration for views and natural light. We use materials and finishes that complement the natural setting while maintaining luxury aesthetics.',
    icon: '🌲'
  }
]
...
const meeksBayConsiderations = [
  {
    title: 'Wilderness Views',
    description: 'Maximizing wilderness and lake views while maintaining privacy and functionality requires careful planning of cabinet placement and window treatments.',
  ...
  },
  {
    ...
    description: 'Meeks Bay\'s pristine wilderness location requires special consideration for environmental impact and material delivery logistics.',
    details: ['Environmental protection', 'Minimal impact delivery', 'Coordinated installation', 'Wilderness preservation']
  },
  {
    title: 'Exclusive Entertaining',
    description: 'Many Meeks Bay homes feature grand entertaining areas that require cabinetry designed for both functionality and aesthetic appeal.',
    details: ['Wine storage solutions', 'Serving areas', 'Integrated appliances', 'Flexible storage']
  },
  {
    title: 'Wilderness Integration',
    description: 'Seamless wilderness living requires cabinetry that complements both interior and exterior design elements.',
    details: ['Natural materials', 'Consistent design language', 'Wilderness-specific hardware', 'Natural aesthetics']
  }
]
...
const localMaterials = [
  {
    name: 'Cherry',
    description: 'Rich, warm cherry is perfect for Meeks Bay\'s sophisticated wilderness aesthetic, providing both beauty and durability.',
    characteristics: ['Rich color tones', 'Warm grain patterns', 'Excellent durability', 'Sophisticated appeal']
  },
  {
    name: 'Walnut',
    description: 'Walnut offers a classic look that ages beautifully and complements the traditional architecture of Meeks Bay.',
...
const faqs = [
  {
    question: 'How long does a custom kitchen project take in Meeks Bay?',
    answer: 'Custom kitchen projects in Meeks Bay typically take 14-18 weeks from design approval to completion. This extended timeline accounts for the unique challenges of wilderness construction, including weather considerations, environmental protection requirements, and the need for materials that can withstand Tahoe\'s climate while maintaining the pristine environment. We work closely with local contractors and suppliers to ensure efficient project delivery while maintaining our high standards of craftsmanship.'
  },
  {
    question: 'What are the most popular kitchen styles in Meeks Bay?',
    answer: 'Meeks Bay homeowners favor wilderness estate, mountain retreat, and traditional cabin styles. Wilderness estate emphasizes grand proportions and natural materials to complement the stunning lake views. Mountain retreat combines rustic elegance with sophisticated design, while traditional cabin style honors the area\'s heritage with warm wood tones and handcrafted details. Each style is carefully adapted to maximize the connection between indoor and outdoor living spaces while maintaining the exclusive character of the area.'
  },
  {
    question: 'How do you handle the unique challenges of wilderness construction?',
    answer: 'Wilderness construction in Meeks Bay requires special consideration for environmental protection, access logistics, and maintaining the pristine environment. We design cabinetry with strategic heights to maximize lake views while maintaining functionality. We use materials and finishes that can withstand temperature fluctuations and humidity changes, and we work with specialized delivery methods that minimize environmental impact. Every project includes careful planning for the unique logistics of wilderness access and construction.'
  },
  {
    question: 'What materials work best for Meeks Bay\'s wilderness environment?',
    answer: 'Meeks Bay\'s pristine wilderness location requires materials that can withstand temperature fluctuations and humidity changes while maintaining the pristine environment. We recommend stable wood species like cherry, walnut, and maple, which are less prone to expansion and contraction. All cabinetry is properly sealed and finished to protect against moisture, and we use hardware specifically designed for wilderness environments. We also consider the impact of UV exposure on finishes in homes with extensive natural light.'
  },
  {
    question: 'Do you work with local contractors and suppliers in Meeks Bay?',
    answer: 'Yes, we have established relationships with local contractors, suppliers, and tradespeople throughout the Meeks Bay area. These partnerships ensure efficient project delivery and access to materials that are well-suited to the local climate and building requirements. Our local network includes specialized craftspeople who understand the unique challenges of wilderness construction and can provide the expertise needed for complex projects while maintaining the pristine environment.'
  },
  {
    question: 'How do you approach kitchen design for exclusive entertaining in Meeks Bay?',
    answer: 'Exclusive entertaining in Meeks Bay requires kitchens designed for both functionality and social interaction. We create grand floor plans that flow seamlessly into living and outdoor spaces, with cabinetry that supports large-scale entertaining. This includes wine storage solutions, integrated serving areas, and flexible storage for seasonal use. We also consider the acoustics and sight lines that make entertaining enjoyable, ensuring the kitchen becomes the heart of the home for both intimate gatherings and large parties while maintaining the exclusive character of the area.'
  }
]

export default function MeeksBayPage() {
  return (
    <main className="min-h-screen">
      ...
      <nav className="bg-french-gray/10 py-4">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className="text-charcoal/60">/</li>
            <li className="text-charcoal">Meeks Bay</li>
          </ol>
        </div>
      </nav>
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/portfolio/gallery-luxury-custom-kitchen-30-sacramento-california.webp"
            alt="Custom kitchen builder in Meeks Bay with stunning wilderness views"
            fill
            priority={true}
            quality={95}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-charcoal/70 leading-relaxed mb-8">
                Our clients in Meeks Bay are discerning homeowners who demand nothing less than perfection. They seek kitchen spaces that not only provide exceptional functionality but also serve as the heart of their sophisticated entertainment and family life. With panoramic wilderness and lake views as the backdrop, every kitchen we create must complement this extraordinary pristine setting.
              </p>
              <p className="text-lg text-charcoal/70 leading-relaxed">
                We specialize in creating kitchens that seamlessly integrate with the wilderness environment while providing the luxury and sophistication expected in Meeks Bay's most exclusive homes. Our approach combines European craftsmanship with an understanding of wilderness luxury living, ensuring every project exceeds expectations.
              </p>
            </div>
            <div className="relative">
              <Image
                src="/images/portfolio/gallery-luxury-custom-kitchen-31-sacramento-california.webp"
                alt="Wilderness estate kitchen design in Meeks Bay"
                width={600}
                height={400}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-display text-2xl font-semibold text-charcoal mb-4">Wilderness Integration</h3>
              <p className="text-charcoal/70 leading-relaxed">
                We design kitchens that feel naturally integrated with the wilderness environment, using materials and finishes that complement the pristine setting.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-deep-green rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <h3 className="font-display text-2xl font-semibold text-charcoal mb-4">Pristine Lakefront Living</h3>
              <p className="text-charcoal/70 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="font-display text-2xl font-semibold text-charcoal mb-4">Wilderness Craftsmanship</h3>
              <p className="text-charcoal/70 leading-relaxed">
      ...
      <section className="py-24 bg-french-gray/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {meeksBayConsiderations.map((consideration, index) => (
              <div key={index} className="bg-white rounded-lg p-8 shadow-lg">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                We begin with a comprehensive consultation to understand your vision, lifestyle, and the unique characteristics of your Meeks Bay property.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-deep-green rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Our design team creates detailed plans that maximize your wilderness and lake views while ensuring optimal functionality for your lifestyle.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-deep-green rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Our experienced installation team ensures perfect fit and finish, working around your schedule and the unique logistics of wilderness access.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {neighborhoods.filter(n => n !== 'Meeks Bay').map((neighborhood, index) => (
              <Link
                key={index}
