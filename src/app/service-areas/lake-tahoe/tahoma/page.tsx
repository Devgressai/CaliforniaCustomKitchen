...
export const metadata: Metadata = {
  title: 'Custom Kitchen Builder in Tahoma | Luxury Cabinetry | AV\'s Cabinets',
  description: 'Custom kitchen builder in Tahoma specializing in luxury cabinetry for Lake Tahoe\'s most exclusive west shore communities. European craftsmanship meets pristine mountain living.',
  keywords: 'custom kitchen builder Tahoma, luxury cabinetry Lake Tahoe, custom kitchens Tahoma, kitchen renovation Tahoma, bespoke cabinetry Lake Tahoe',
  openGraph: {
    title: 'Custom Kitchen Builder in Tahoma | Luxury Cabinetry | AV\'s Cabinets',
...
const localProjects = [
  {
    title: 'Tahoma West Shore Estate Kitchen',
    location: 'Tahoma, CA',
    ...
    imageSrc: '/images/portfolio/tahoma-west-shore-kitchen.webp',
    imageAlt: 'Custom west shore estate kitchen with panoramic Lake Tahoe views in Tahoma',
    year: '2024'
  },
  {
    title: 'Mountain Contemporary Tahoma Kitchen',
    location: 'Tahoma, CA',
    description: 'A sophisticated mountain contemporary kitchen with clean lines and premium materials. Perfect for the luxury Tahoma lifestyle with integrated outdoor living spaces.',
    imageSrc: '/images/portfolio/tahoma-contemporary-kitchen.webp',
    imageAlt: 'Mountain contemporary kitchen in Tahoma with sophisticated design',
    year: '2024'
  },
  {
    title: 'Traditional Tahoma Cabin Kitchen',
    location: 'Tahoma, CA',
    description: 'A classic traditional cabin kitchen renovation with handcrafted details and natural finishes. Designed for elegant family gatherings and mountain living in Tahoma.',
    imageSrc: '/images/portfolio/tahoma-traditional-kitchen.webp',
    imageAlt: 'Traditional cabin kitchen in Tahoma with handcrafted details',
    year: '2023'
  }
]
...
const localArchitecture = [
  {
    ...
    description: 'Tahoma\'s west shore estates feature grand proportions, natural materials, and expansive lake views. Our cabinetry complements these elements with sophisticated designs and premium materials that enhance the west shore setting.',
    characteristics: ['Grand proportions', 'Natural materials', 'Lake views', 'Sophisticated design']
  },
  {
    style: 'Mountain Contemporary',
    description: 'Mountain contemporary homes in Tahoma embrace clean lines with natural textures and premium finishes. Our cabinetry honors this aesthetic with modern designs and authentic materials that reflect the mountain environment.',
...
const localInsights = [
  {
    ...
    description: 'Tahoma residents value the exclusive west shore lifestyle and outdoor recreation. We design cabinetry that supports this lifestyle while providing the luxury and functionality expected in west shore estates.',
    icon: '🏔️'
  },
  {
    title: 'Sophisticated Entertaining',
    description: 'Many Tahoma homes are designed for sophisticated entertaining, with grand spaces and integrated indoor-outdoor living. We create cabinetry that supports this lifestyle with elegant storage and serving solutions.',
    icon: '🍽️'
  },
  {
    title: 'Exclusive Luxury',
    description: 'Tahoma residents expect the finest materials and finishes. We work exclusively with premium hardwoods, custom hardware, and luxury finishes that meet the highest standards of west shore luxury.',
    icon: '💎'
  },
  {
...
const tahomaConsiderations = [
  ...
  },
  {
    ...
    description: 'Tahoma\'s exclusive west shore location requires special consideration for material delivery and installation logistics.',
  ...
  },
  {
    ...
    description: 'Many Tahoma homes feature grand entertaining areas that require cabinetry designed for both functionality and aesthetic appeal.',
...
const localMaterials = [
  {
    name: 'Walnut',
    description: 'Rich, warm walnut is perfect for Tahoma\'s sophisticated west shore aesthetic, providing both beauty and durability.',
    characteristics: ['Rich grain patterns', 'Warm color tones', 'Excellent durability', 'Sophisticated appeal']
  },
  {
    name: 'Cherry',
    description: 'Cherry wood offers a classic look that ages beautifully and complements the traditional architecture of Tahoma.',
    ...
    <main className="min-h-screen">
      ...
      <nav className="bg-french-gray/10 py-4">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className="text-charcoal/60">/</li>
            <li className="text-charcoal">Tahoma</li>
          </ol>
        </div>
      </nav>
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/portfolio/gallery-luxury-custom-kitchen-28-sacramento-california.webp"
            alt="Custom kitchen builder in Tahoma with stunning west shore views"
            fill
            priority={true}
            quality={95}
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold text-ivory mb-6 text-balance">Custom Kitchens in tahoma | Luxury Cabinetry</h1>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Every kitchen we create in Tahoma is designed to honor the west shore beauty of Lake Tahoe while providing the luxury and functionality our clients demand.
            </p>
          </div>
      ...
      <section className="py-24 bg-french-gray/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-charcoal mb-6">Luxury Kitchen Design in tahoma</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              We understand the diverse architectural landscape of Tahoma and design cabinetry that complements each unique style.
            </p>
          </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-charcoal mb-6">Luxury Kitchen Design in tahoma</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Discover our latest custom kitchen projects in Tahoma's most exclusive neighborhoods.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-charcoal mb-6">Luxury Kitchen Design in tahoma</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our deep understanding of Tahoma's unique lifestyle informs every design decision we make.
            </p>
          </div>
      ...
      <section className="py-24 bg-french-gray/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-charcoal mb-6">Luxury Kitchen Design in tahoma</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Every project in Tahoma requires special attention to the unique challenges and opportunities of this exclusive location.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {tahomaConsiderations.map((consideration, index) => (
              <div key={index} className="bg-white rounded-lg p-8 shadow-lg">
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-charcoal mb-6">Luxury Kitchen Design in tahoma</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              We carefully select materials that complement Tahoma's west shore environment while providing lasting beauty and durability.
            </p>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-charcoal mb-6">Luxury Kitchen Design in tahoma</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              We've refined our process specifically for Tahoma's unique requirements and our clients' high expectations.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                We begin with a comprehensive consultation to understand your vision, lifestyle, and the unique characteristics of your Tahoma property.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-deep-green rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80">
              Common questions about custom kitchen projects in Tahoma.
            </p>
          </div>
      ...
      <section className="py-24 bg-deep-green">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="font-display text-4xl md:text-5xl font-bold text-ivory mb-6">Luxury Kitchen Design in tahoma</h2>
      ...
      <section className="py-16 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl font-bold text-charcoal mb-4">Luxury Kitchen Design in tahoma</h2>
            <p className="text-charcoal/80">
              We provide custom kitchen services throughout the Lake Tahoe region.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {neighborhoods.filter(n => n !== 'Tahoma').map((neighborhood, index) => (
              <Link
                key={index}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "PineWood Cabinets - Custom Kitchen Builder in Tahoma",
            "description": "Custom kitchen builder in Tahoma specializing in luxury cabinetry for Lake Tahoe's most exclusive west shore communities.",
