...
export const metadata: Metadata = {
  title: 'Kitchen Cabinets San Ramon | Custom Kitchen Cabinets | PineWood Cabinets',
  description: 'Custom kitchen cabinets for San Ramon luxury homes. Expert cabinet makers serving East Bay with bespoke cabinetry and storage solutions.',
  keywords: [
    'kitchen cabinets San Ramon',
    'custom kitchen cabinets San Ramon',
    'kitchen cabinet makers San Ramon',
  ...
  openGraph: {
    title: 'Kitchen Cabinets San Ramon | Custom Kitchen Cabinets | PineWood Cabinets',
    description: 'Custom kitchen cabinets for San Ramon luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Cabinets San Ramon",
  "Custom kitchen cabinets for San Ramon luxury homes in East Bay",
  "Kitchen Cabinets",
  ["San Ramon, CA", "East Bay, CA", "Dublin, CA", "Pleasanton, CA", "Livermore, CA"]
)

export default function KitchenCabinetsSanRamonPage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Kitchen Cabinets San Ramon"
        subtitle="Custom Kitchen Cabinets"
        description="Serving San Ramon's discerning homeowners with bespoke kitchen cabinets that transform East Bay homes into luxury culinary spaces."
        imageSrc="service-areas/san-ramon-kitchen-cabinets-hero.webp"
        imageAlt="Custom kitchen cabinets in San Ramon home with East Bay views and luxury finishes"
      />

      {/* San Ramon Kitchen Cabinets Overview */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From traditional estates to contemporary architectural gems, San Ramon's diverse residential landscape demands kitchen cabinet solutions that seamlessly blend suburban sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/san-ramon-kitchen-cabinets-overview.webp"
                alt="Custom kitchen cabinets in San Ramon home with East Bay views and luxury finishes"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Bespoke kitchen cabinets designed and crafted specifically for your San Ramon home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Transform your existing San Ramon kitchen cabinets with professional refacing services that update the look while preserving the structure.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert restoration of vintage and historic San Ramon kitchen cabinets to preserve their original beauty and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Custom organization solutions that maximize the functionality and efficiency of your San Ramon kitchen cabinets.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Premium hardware selection and installation to complement your San Ramon kitchen cabinets and enhance their functionality.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Ongoing maintenance and care services to keep your San Ramon kitchen cabinets looking and functioning at their best.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your San Ramon kitchen cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your San Ramon kitchen cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Hand-crafted construction of your approved San Ramon kitchen cabinet design in our workshop.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional installation and final walkthrough for your San Ramon kitchen cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with East Bay views to evening entertaining that showcases the home's refined character, every cabinet decision reflects an understanding of how San Ramon residents truly live and enjoy their suburban lifestyle.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/san-ramon-kitchen-cabinets-1.webp"
                alt="Custom kitchen cabinets in San Ramon with East Bay views and luxury finishes"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/san-ramon-kitchen-cabinets-2.webp"
                alt="Traditional kitchen cabinets in San Ramon with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/san-ramon-kitchen-cabinets-3.webp"
                alt="Contemporary kitchen cabinets in San Ramon with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Custom kitchen cabinet installation in San Ramon typically takes 3-5 days for a complete kitchen. This includes 1 day for site preparation and measurements, 2-3 days for cabinet installation and alignment, and 1 day for hardware installation and final adjustments. The timeline may vary depending on the complexity of the design and any custom features.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                We use only the finest materials for our San Ramon kitchen cabinets, including solid hardwoods like oak, maple, cherry, and walnut, as well as premium plywood and MDF for painted finishes. All materials are sourced from sustainable suppliers and finished with high-quality stains, paints, and protective coatings for durability and beauty.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, we can match existing kitchen cabinets in your San Ramon home. We'll analyze the current cabinets' style, color, and finish, then create new cabinets that seamlessly blend with the existing ones. This is perfect for kitchen expansions or when you want to add new cabinets while keeping the existing ones.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, we offer comprehensive cabinet refacing services for San Ramon homes. This includes replacing doors and drawer fronts, updating hardware, refinishing the cabinet boxes, and adding new organizational features. Refacing is a cost-effective way to give your kitchen a fresh look without the expense of completely new cabinets.
              </p>
            </div>
          </div>
        </div>
      ...
      <CTASection
        title="Ready to Transform Your San Ramon Kitchen with Custom Cabinets?"
        description="Join San Ramon's most discerning homeowners who have chosen PineWood Cabinets for their kitchen cabinet needs. Schedule a private consultation to discuss how we can bring your vision to life with bespoke cabinetry."
        primaryCTA={{
