...
export const metadata: Metadata = {
  title: 'Custom Kitchen San Ramon | Custom Kitchen Design | PineWood Cabinets',
  description: 'Custom kitchen design and installation for San Ramon luxury homes. Expert kitchen designers serving East Bay with bespoke cabinetry and luxury finishes.',
  keywords: [
  ...
  openGraph: {
    title: 'Custom Kitchen San Ramon | Custom Kitchen Design | PineWood Cabinets',
    description: 'Custom kitchen design and installation for San Ramon luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Custom Kitchen San Ramon",
  "Custom kitchen design and installation for San Ramon luxury homes in East Bay",
  "Custom Kitchen",
  ["San Ramon, CA", "East Bay, CA", "Dublin, CA", "Pleasanton, CA", "Livermore, CA"]
)

export default function CustomKitchenSanRamonPage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Custom Kitchen San Ramon"
        subtitle="Custom Kitchen Design"
        description="Serving San Ramon's discerning homeowners with bespoke kitchen design and installation that transforms East Bay homes into luxury culinary spaces."
        imageSrc="service-areas/san-ramon-custom-kitchen-hero.webp"
        imageAlt="Custom kitchen design in San Ramon home with East Bay views and luxury finishes"
      />

      {/* San Ramon Custom Kitchen Overview */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
                San Ramon Custom Kitchen Excellence
              </h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                San Ramon represents the sophisticated heart of East Bay living—where suburban elegance meets refined luxury. Our San Ramon custom kitchen clients understand that true elegance lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From traditional estates to contemporary architectural gems, San Ramon's diverse residential landscape demands custom kitchen solutions that seamlessly blend suburban sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/san-ramon-custom-kitchen-overview.webp"
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Custom Kitchen Services for San Ramon
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive custom kitchen services are tailored to meet the unique needs of San Ramon's diverse architectural styles and East Bay lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Hand-crafted custom cabinetry designed and built specifically for your San Ramon kitchen space and requirements.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Complete kitchen renovation services that transform your San Ramon kitchen while preserving its architectural integrity.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven design process ensures your San Ramon custom kitchen exceeds expectations and perfectly reflects your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your San Ramon custom kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your San Ramon custom kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
                <li>• Material selection</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Hand-crafted construction of your approved San Ramon custom kitchen design in our workshop.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional installation and final walkthrough for your San Ramon custom kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                San Ramon's unique East Bay environment creates distinct requirements for custom kitchens. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Featured San Ramon Custom Kitchen Projects
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of custom kitchen projects throughout San Ramon's most prestigious East Bay neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/san-ramon-custom-kitchen-1.webp"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/san-ramon-custom-kitchen-2.webp"
                alt="Traditional custom kitchen in San Ramon with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/san-ramon-custom-kitchen-3.webp"
                alt="Contemporary custom kitchen in San Ramon with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              San Ramon Custom Kitchen FAQ
            </h2>
            <p className="text-xl text-charcoal/80">
              Common questions about custom kitchen services in San Ramon
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A complete custom kitchen project in San Ramon typically takes 10-16 weeks from start to finish. This includes 2-3 weeks for design and planning, 6-10 weeks for fabrication in our workshop, and 2-3 weeks for installation and finishing. The timeline may vary depending on the complexity of the design and any custom features.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A truly custom kitchen is designed and built specifically for your San Ramon home's unique space, architectural style, and your personal lifestyle needs. This includes custom measurements, personalized storage solutions, unique design elements, premium materials, and hand-crafted construction that cannot be replicated in standard kitchen designs.
              </p>
            </div>
      ...
      <CTASection
        ...
        description="Join San Ramon's most discerning homeowners who have chosen PineWood Cabinets for their custom kitchen needs. Schedule a private consultation to discuss how we can bring your vision to life with bespoke design and craftsmanship."
        primaryCTA={{
