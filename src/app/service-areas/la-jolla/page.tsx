...
export const metadata: Metadata = {
  title: 'Custom Kitchens La Jolla | Luxury Cabinetry | AV\'s Cabinets California',
  description: 'Custom kitchens and luxury cabinetry for La Jolla\'s most prestigious coastal estates. AV\'s Cabinets brings European craftsmanship to California\'s premier beachfront community.',
  keywords: 'custom kitchens La Jolla, luxury cabinetry La Jolla, beachfront estate kitchens, coastal home cabinetry, luxury kitchens California',
  openGraph: {
    title: 'Custom Kitchens La Jolla | Luxury Cabinetry | AV\'s Cabinets California',
    description: 'Custom kitchens and luxury cabinetry for La Jolla\'s most prestigious coastal estates.',
    type: 'website',
  },
}
...
const localArchitecture = [
  {
    ...
    description: 'La Jolla\'s contemporary coastal homes feature clean lines, natural materials, and expansive windows that frame the stunning ocean views. Our cabinetry complements these elements with minimalist designs and premium materials.',
    characteristics: ['Clean lines', 'Natural materials', 'Ocean views', 'Minimalist design']
  },
  {
    style: 'Traditional Coastal',
    description: 'Traditional coastal homes embrace the beachfront setting with classic details, natural materials, and timeless charm. Our cabinetry honors this tradition with hand-crafted details and authentic materials.',
    characteristics: ['Classic details', 'Natural materials', 'Timeless charm', 'Hand-crafted elements']
  },
  {
    style: 'Mediterranean Revival',
    description: 'Mediterranean Revival homes in La Jolla feature warm materials and elegant details. Our cabinetry enhances these spaces with sophisticated designs and premium materials.',
...
const localInsights = [
  {
    ...
    description: 'La Jolla residents value the connection to the ocean and outdoor living. We design cabinetry that enhances this connection while providing the luxury and functionality expected in coastal estates.',
    icon: '🌊'
  },
  {
    title: 'Entertainment Focus',
    description: 'Many La Jolla homes are designed for entertaining, with open floor plans and integrated indoor-outdoor living. We create cabinetry that supports this lifestyle with flexible storage and serving solutions.',
    icon: '🍽️'
  },
  {
    title: 'Luxury Living',
    description: 'La Jolla residents expect the finest materials and finishes. We work exclusively with premium hardwoods, custom hardware, and luxury finishes that meet the highest standards.',
    icon: '💎'
  },
  {
...
const coastalConsiderations = [
  {
    aspect: 'Ocean Views',
    description: 'La Jolla\'s ocean views require special consideration for maximizing natural light and scenery. We design cabinetry that enhances these views while providing practical storage and functionality.',
  ...
  },
  {
    ...
    description: 'La Jolla residents expect the highest standards of luxury and quality. We provide cabinetry solutions that meet these expectations with premium materials and finishes.',
...
const localMaterials = [
  {
    name: 'Teak',
    description: 'Natural oils in teak provide excellent weather resistance, making it perfect for La Jolla\'s coastal environment. Its golden color and tight grain create a sophisticated appearance.',
...
const luxuryCommunities = [
  {
    name: 'La Jolla Cove',
    description: 'An exclusive waterfront community with stunning ocean views and luxury amenities. Our cabinetry designs complement the luxury coastal lifestyle.',
    features: ['Waterfront community', 'Ocean views', 'Luxury amenities', 'Exclusive access']
  },
  {
    name: 'Torrey Pines',
    description: 'A premier hillside community with custom homes and golf course amenities. Our designs enhance the luxury living experience.',
    features: ['Hillside community', 'Custom homes', 'Golf amenities', 'Luxury lifestyle']
  },
  {
    name: 'Bird Rock',
...
const seasonalConsiderations = [
  {
    season: 'Summer',
    description: 'Summer in La Jolla is all about outdoor living and entertaining. Our cabinetry designs support this lifestyle with integrated outdoor kitchen connections and flexible storage for seasonal items.',
...
const coastalFeatures = [
  ...
  },
  {
    ...
    description: 'Premium materials and finishes that meet the highest standards of luxury living expected in La Jolla.',
...
export default function LaJollaPage() {
  return (
      ...
      <div className="heading-structure" style="display: none;">
        <h1>Custom Kitchens in la-jolla | Luxury Cabinetry</h1>
        <h2>Luxury Kitchen Design in la-jolla</h2><h2>Premium Materials & Craftsmanship</h2><h2>Local Kitchen Design Expertise</h2><h2>Custom Kitchen Services</h2><h2>Why Choose Us for la-jolla Kitchens</h2><h2>Frequently Asked Questions</h2>
    ...
    <div className="min-h-screen bg-ivory">
      ...
      <section className="relative py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 font-display">Custom Kitchens in la-jolla | Luxury Cabinetry</h1>
            <p className="text-xl md:text-2xl text-french-gray leading-relaxed mb-8">
              Serving La Jolla\'s most prestigious coastal estates with custom kitchens and luxury cabinetry that celebrates the natural beauty of California\'s premier beachfront community.
            </p>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in la-jolla</h2>
              <div className="prose-luxury text-charcoal/80 mb-8">
                <p>
                  La Jolla represents the pinnacle of coastal luxury living in Southern California. Our custom cabinetry solutions are designed to complement the area\'s stunning natural beauty while providing the luxury and functionality expected in beachfront estates.
                </p>
                <p>
                  We understand the unique characteristics of La Jolla living, from the emphasis on indoor-outdoor living to the integration of natural materials and finishes. Our designs incorporate materials and finishes that celebrate the coastal aesthetic while providing practical solutions for luxury living.
                </p>
                <p>
                  Our local knowledge extends to La Jolla\'s diverse architectural styles, from contemporary coastal homes to traditional Mediterranean estates. We work closely with each client to ensure our cabinetry complements their home\'s unique character while meeting their specific lifestyle requirements.
                </p>
                <p>
                  The La Jolla lifestyle emphasizes quality, natural beauty, and attention to detail. Our cabinetry reflects these values through hand-crafted details, premium materials, and designs that enhance the coastal living experience. We understand that La Jolla homes are not just places to live, but spaces for entertaining, relaxation, and creating lasting memories.
                </p>
                <p>
                  La Jolla\'s natural setting and luxury amenities create a unique environment for high-end living. Our designs honor this setting while providing modern functionality and luxury finishes that meet the highest standards of coastal living.
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="bg-french-gray/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-charcoal mb-2">16+ Years</h4>
                  <p className="text-sm text-charcoal/70">Serving La Jolla</p>
                </div>
                <div className="bg-french-gray/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-charcoal mb-2">70+ Projects</h4>
                  <p className="text-sm text-charcoal/70">Completed in La Jolla</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-french-gray/10 p-4 rounded-lg">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our recent work in La Jolla, showcasing how we\'ve transformed kitchens and living spaces throughout the area\'s most prestigious communities.
            </p>
          </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in la-jolla</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              La Jolla\'s diverse architectural styles require specialized cabinetry solutions. We understand how to work with each style to create harmonious, functional spaces.
            </p>
          </div>
      ...
      <section className="py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 font-display">Luxury Kitchen Design in la-jolla</h2>
            <p className="text-xl text-french-gray max-w-3xl mx-auto">
              Specialized features designed for the La Jolla lifestyle, from ocean view integration to luxury entertainment spaces.
            </p>
          </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in la-jolla</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              La Jolla\'s coastal environment requires special design considerations. We create cabinetry solutions that work beautifully in the coastal setting.
            </p>
          </div>
      ...
      <section className="py-24 bg-grain">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in la-jolla</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              We serve La Jolla\'s most exclusive luxury communities, each with its own unique character and luxury amenities.
            </p>
          </div>
      ...
      <section className="py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 font-display">Luxury Kitchen Design in la-jolla</h2>
            <p className="text-xl text-french-gray max-w-3xl mx-auto">
              La Jolla\'s seasonal nature requires thoughtful design considerations. We create cabinetry solutions that work beautifully throughout all seasons.
            </p>
          </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in la-jolla</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              We work with materials that are specifically chosen for La Jolla\'s coastal environment while providing exceptional beauty and durability.
            </p>
          </div>
      ...
      <section className="py-24 bg-grain">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in la-jolla</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Understanding the unique characteristics of La Jolla helps us create cabinetry solutions that truly serve our clients\' needs.
            </p>
          </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in la-jolla</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              We serve all of La Jolla\'s prestigious neighborhoods, from the exclusive beachfront communities to the stunning hillside estates.
            </p>
          </div>
      ...
      <section className="py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 font-display">Luxury Kitchen Design in la-jolla</h2>
            <p className="text-xl text-french-gray max-w-3xl mx-auto">
              Common questions about our services in La Jolla and the surrounding coastal communities.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-ivory/10 p-6 rounded-lg">
              ...
              <p className="text-french-gray leading-relaxed">
                We design cabinetry that enhances ocean views and maximizes natural light. This includes strategic placement, materials that complement the coastal setting, and designs that don\'t obstruct the views that make La Jolla special.
              </p>
            </div>

            <div className="bg-ivory/10 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-ivory mb-3 font-display">
                Can you work with beachfront properties and their unique requirements?
              </h3>
              <p className="text-french-gray leading-relaxed">
                Absolutely. We have extensive experience working with beachfront properties, including considerations for salt air, humidity, and the integration of indoor-outdoor living spaces that are essential to the La Jolla lifestyle.
              </p>
            </div>
            ...
            <div className="bg-ivory/10 p-6 rounded-lg">
              ...
              <p className="text-french-gray leading-relaxed">
                Yes, we work exclusively with premium materials and luxury finishes that meet the highest standards expected in La Jolla. This includes custom hardware, premium hardwoods, and finishes that enhance the luxury living experience.
              </p>
            </div>

            <div className="bg-ivory/10 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-ivory mb-3 font-display">
                What is the typical timeline for a La Jolla project?
              </h3>
              <p className="text-french-gray leading-relaxed">
                Most La Jolla projects take 6-8 months from consultation to completion. This includes 2-3 months for design and planning, 3-4 months for fabrication, and 2-3 weeks for installation. We can work around vacation schedules and seasonal considerations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-grain">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-charcoal/80 mb-12 max-w-3xl mx-auto">
            Let\'s discuss how we can create the perfect kitchen or cabinetry solution for your La Jolla home, combining coastal luxury with ocean views.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="btn-primary">
              Schedule La Jolla Consultation
            </Link>
            <Link href="/portfolio" className="btn-ghost">
              View La Jolla Projects
            </Link>
          </div>
        </div>
      </section>
