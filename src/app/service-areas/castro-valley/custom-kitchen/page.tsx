...
export const metadata: Metadata = {
  title: 'Custom Kitchen Castro Valley | Bespoke Kitchen Design | PineWood Cabinets',
  description: 'Custom kitchen design and construction for Castro Valley luxury homes. Expert kitchen craftsmen serving East Bay with bespoke solutions.',
  keywords: [
    'custom kitchen Castro Valley',
    'bespoke kitchen Castro Valley',
  ...
  openGraph: {
    title: 'Custom Kitchen Castro Valley | Bespoke Kitchen Design | PineWood Cabinets',
    description: 'Custom kitchen design and construction for Castro Valley luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Custom Kitchen Castro Valley",
  "Custom kitchen design and construction for Castro Valley luxury homes in East Bay",
  "Custom Kitchen",
  ["Castro Valley, CA", "East Bay, CA", "Hayward, CA", "San Leandro, CA", "Union City, CA"]
)

export default function CustomKitchenCastroValleyPage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Custom Kitchen Castro Valley"
        subtitle="Bespoke Kitchen Design"
        description="Serving Castro Valley's discerning homeowners with custom kitchen design and construction that transforms East Bay homes into luxury culinary spaces."
        imageSrc="service-areas/castro-valley-custom-kitchen-hero.webp"
        imageAlt="Custom kitchen in Castro Valley home with East Bay views and luxury finishes"
      />

      {/* Castro Valley Custom Kitchen Overview */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From traditional estates to contemporary architectural gems, Castro Valley's diverse residential landscape demands custom kitchen solutions that seamlessly blend suburban sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/castro-valley-custom-kitchen-overview.webp"
                alt="Custom kitchen in Castro Valley home with East Bay views and luxury finishes"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Full custom kitchen design and construction from concept to completion, tailored specifically for your Castro Valley home's unique character.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Professional custom kitchen design services that create unique, functional spaces tailored to your Castro Valley lifestyle and preferences.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Bespoke cabinetry designed and crafted specifically for your Castro Valley kitchen, ensuring perfect fit and exceptional quality.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Custom countertop design and installation using premium materials that complement your Castro Valley kitchen's aesthetic and functionality.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Material selection</li>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Custom storage solutions designed to maximize your Castro Valley kitchen's functionality and organization while maintaining aesthetic appeal.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Custom lighting design and installation that enhances your Castro Valley kitchen's functionality, ambiance, and aesthetic appeal.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Task lighting</li>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your Castro Valley custom kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your Castro Valley custom kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
                <li>• Material selection</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Handcrafted construction of your custom Castro Valley kitchen components with attention to detail.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Custom fabrication</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional installation and finishing of your custom Castro Valley kitchen with final walkthrough.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Precise installation</li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with East Bay views to evening entertaining that showcases the home's refined character, every custom kitchen decision reflects an understanding of how Castro Valley residents truly live and enjoy their sophisticated lifestyle.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/castro-valley-custom-kitchen-1.webp"
                alt="Custom kitchen in Castro Valley with East Bay views and luxury finishes"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/castro-valley-custom-kitchen-2.webp"
                alt="Traditional custom kitchen in Castro Valley with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/castro-valley-custom-kitchen-3.webp"
                alt="Contemporary custom kitchen in Castro Valley with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A complete custom kitchen project in Castro Valley typically takes 12-16 weeks from start to finish. This includes 2-3 weeks for design and planning, 8-10 weeks for custom construction and fabrication, 2-3 weeks for installation and finishing, and 1-2 weeks for final adjustments and cleanup. The timeline may vary depending on the complexity of your project and any custom features.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Custom kitchens are built specifically for your Castro Valley home with exact measurements, unique design features, and premium materials. Semi-custom kitchens use pre-made components with limited customization options. Custom kitchens offer superior fit, quality, and design flexibility, making them the preferred choice for luxury Castro Valley homes.
              </p>
            </div>
      ...
      <CTASection
        ...
        description="Join Castro Valley's most discerning homeowners who have chosen PineWood Cabinets for their custom kitchen needs. Schedule a private consultation to discuss how we can bring your vision to life with bespoke design and construction solutions."
        primaryCTA={{
