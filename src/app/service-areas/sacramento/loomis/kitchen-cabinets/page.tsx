...
export const metadata: Metadata = {
  title: 'Kitchen Cabinets Loomis | Kitchen Cabinets | PineWood Cabinets',
  description: 'Custom kitchen cabinets and cabinetry for Loomis luxury homes. Expert craftsmen serving Sacramento Area with luxury kitchen solutions.',
  keywords: [
    'kitchen-cabinets loomis',
    'kitchen-cabinets loomis',
    'luxury kitchen-cabinets loomis',
    'custom kitchen-cabinets loomis',
    'kitchen-cabinets sacramento area',
    'kitchen-cabinets California'
  ],
  openGraph: {
    title: 'Kitchen Cabinets Loomis | Kitchen Cabinets | PineWood Cabinets',
    description: 'Custom kitchen cabinets and cabinetry for Loomis luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Cabinets Loomis",
  "Custom kitchen cabinets and cabinetry for Loomis luxury homes for Loomis luxury homes in Sacramento Area",
  "Kitchen Cabinets",
  ["Loomis, CA", "Sacramento Area, CA", "California"]
)

export default function KitchenCabinetsLoomisPage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Kitchen Cabinets Loomis"
        subtitle="Kitchen Cabinets"
        description="Serving Loomis's most discerning homeowners with Custom kitchen cabinets and cabinetry that transform Sacramento Area homes into luxury culinary spaces."
        imageSrc="service-areas/loomis-kitchen-cabinets-hero.webp"
        imageAlt="Kitchen Cabinets in Loomis home with luxury finishes and Sacramento Area views"
      />

      {/* Loomis Kitchen Cabinets Overview */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
                Loomis Kitchen Cabinets Excellence
              </h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Loomis represents the pinnacle of Sacramento Area luxury—where sophistication meets refined elegance. Our Loomis kitchen-cabinets clients understand that true luxury lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic estates to contemporary architectural gems, Loomis's diverse residential landscape demands kitchen-cabinets solutions that seamlessly blend Sacramento Area sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/loomis-kitchen-cabinets-overview.webp"
                alt="Kitchen Cabinets in Loomis home with luxury finishes and Sacramento Area views"
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Kitchen Cabinets Services for Loomis
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive kitchen-cabinets services are tailored to meet the unique needs of Loomis's diverse architectural styles and Sacramento Area lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Full kitchen-cabinets from concept to completion, tailored to your Loomis home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive renovation services that update your Loomis kitchen-cabinets while preserving its architectural integrity and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cosmetic updates that give your Loomis kitchen-cabinets a fresh, modern look without the complexity of a full renovation.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Strategic expansion of your Loomis kitchen-cabinets space to improve functionality and accommodate your growing needs.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Modern updates that bring your Loomis kitchen-cabinets up to current standards while maintaining its unique character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert restoration of historic and vintage Loomis kitchen-cabinets to preserve their original beauty and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven process ensures your Loomis kitchen-cabinets exceeds expectations and perfectly reflects your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your Loomis kitchen-cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your Loomis kitchen-cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
                <li>• Material selection</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional construction and installation of your approved Loomis kitchen-cabinets design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Demolition</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive final walkthrough and project completion for your Loomis kitchen-cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Loomis's unique Sacramento Area environment creates distinct requirements for kitchen-cabinets. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Featured Loomis Kitchen Cabinets Projects
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of kitchen-cabinets projects throughout Loomis's most prestigious Sacramento Area neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/loomis-kitchen-cabinets-1.webp"
                alt="Kitchen Cabinets in Loomis home with Sacramento Area views and luxury finishes"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/loomis-kitchen-cabinets-2.webp"
                alt="Traditional kitchen-cabinets in Loomis with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/loomis-kitchen-cabinets-3.webp"
                alt="Contemporary kitchen-cabinets in Loomis with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Loomis Kitchen Cabinets FAQ
            </h2>
            <p className="text-xl text-charcoal/80">
              Common questions about kitchen-cabinets services in Loomis
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A complete kitchen-cabinets in Loomis typically takes 8-12 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for demolition and preparation, 4-6 weeks for construction and installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the scope of work and any unexpected issues that arise.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Create Your Dream Kitchen Cabinets in Loomis?"
        description="Join Loomis's most discerning homeowners who have chosen PineWood Cabinets for their kitchen-cabinets needs. Schedule a private consultation to discuss how we can bring your vision to life with comprehensive kitchen-cabinets services."
        primaryCTA={{
