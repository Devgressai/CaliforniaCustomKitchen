...
export const metadata: Metadata = {
  title: 'Custom Kitchen Woodside | Custom Kitchen | PineWood Cabinets',
  description: 'Custom kitchen design and cabinetry for Woodside luxury homes. Expert craftsmen serving Silicon Valley with luxury kitchen solutions.',
  keywords: [
    'custom-kitchen woodside',
    'custom-kitchen woodside',
    'luxury custom-kitchen woodside',
    'custom custom-kitchen woodside',
    'custom-kitchen silicon valley',
    'custom-kitchen California'
  ],
  openGraph: {
    title: 'Custom Kitchen Woodside | Custom Kitchen | PineWood Cabinets',
    description: 'Custom kitchen design and cabinetry for Woodside luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Custom Kitchen Woodside",
  "Custom kitchen design and cabinetry for Woodside luxury homes for Woodside luxury homes in Silicon Valley",
  "Custom Kitchen",
  ["Woodside, CA", "Silicon Valley, CA", "California"]
)

export default function CustomKitchenWoodsidePage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Custom Kitchen Woodside"
        subtitle="Custom Kitchen"
        description="Serving Woodside's most discerning homeowners with Custom kitchen design and cabinetry that transform Silicon Valley homes into luxury culinary spaces."
        imageSrc="service-areas/woodside-custom-kitchen-hero.webp"
        imageAlt="Custom Kitchen in Woodside home with luxury finishes and Silicon Valley views"
      />

      {/* Woodside Custom Kitchen Overview */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
                Woodside Custom Kitchen Excellence
              </h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Woodside represents the pinnacle of Silicon Valley luxury—where sophistication meets refined elegance. Our Woodside custom-kitchen clients understand that true luxury lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic estates to contemporary architectural gems, Woodside's diverse residential landscape demands custom-kitchen solutions that seamlessly blend Silicon Valley sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/woodside-custom-kitchen-overview.webp"
                alt="Custom Kitchen in Woodside home with luxury finishes and Silicon Valley views"
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Custom Kitchen Services for Woodside
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive custom-kitchen services are tailored to meet the unique needs of Woodside's diverse architectural styles and Silicon Valley lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Full custom-kitchen from concept to completion, tailored to your Woodside home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive renovation services that update your Woodside custom-kitchen while preserving its architectural integrity and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cosmetic updates that give your Woodside custom-kitchen a fresh, modern look without the complexity of a full renovation.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Strategic expansion of your Woodside custom-kitchen space to improve functionality and accommodate your growing needs.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Modern updates that bring your Woodside custom-kitchen up to current standards while maintaining its unique character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert restoration of historic and vintage Woodside custom-kitchen to preserve their original beauty and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven process ensures your Woodside custom-kitchen exceeds expectations and perfectly reflects your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your Woodside custom-kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your Woodside custom-kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
                <li>• Material selection</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional construction and installation of your approved Woodside custom-kitchen design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Demolition</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive final walkthrough and project completion for your Woodside custom-kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Woodside's unique Silicon Valley environment creates distinct requirements for custom-kitchen. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Featured Woodside Custom Kitchen Projects
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of custom-kitchen projects throughout Woodside's most prestigious Silicon Valley neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/woodside-custom-kitchen-1.webp"
                alt="Custom Kitchen in Woodside home with Silicon Valley views and luxury finishes"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/woodside-custom-kitchen-2.webp"
                alt="Traditional custom-kitchen in Woodside with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/woodside-custom-kitchen-3.webp"
                alt="Contemporary custom-kitchen in Woodside with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Woodside Custom Kitchen FAQ
            </h2>
            <p className="text-xl text-charcoal/80">
              Common questions about custom-kitchen services in Woodside
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, most of our Woodside custom-kitchen clients choose to stay in their homes during the project. We work to minimize disruption by setting up temporary facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Create Your Dream Custom Kitchen in Woodside?"
        description="Join Woodside's most discerning homeowners who have chosen PineWood Cabinets for their custom-kitchen needs. Schedule a private consultation to discuss how we can bring your vision to life with comprehensive custom-kitchen services."
        primaryCTA={{
