...
export const metadata: Metadata = {
  title: 'Kitchen Cabinets Berkeley | Custom Cabinet Design | PineWood Cabinets',
  description: 'Custom kitchen cabinets for Berkeley luxury homes. Expert cabinet makers serving East Bay with bespoke cabinetry solutions.',
  keywords: [
    'kitchen cabinets Berkeley',
    'custom kitchen cabinets Berkeley',
    'cabinet design Berkeley',
  ...
  openGraph: {
    title: 'Kitchen Cabinets Berkeley | Custom Cabinet Design | PineWood Cabinets',
    description: 'Custom kitchen cabinets for Berkeley luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Cabinets Berkeley",
  "Custom kitchen cabinets for Berkeley luxury homes in East Bay",
  "Kitchen Cabinets",
  ["Berkeley, CA", "East Bay, CA", "Oakland, CA", "Alameda, CA", "San Leandro, CA"]
)

export default function KitchenCabinetsBerkeleyPage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Kitchen Cabinets Berkeley"
        subtitle="Custom Cabinet Design"
        description="Serving Berkeley's discerning homeowners with custom kitchen cabinets that transform East Bay homes into luxury culinary spaces."
        imageSrc="service-areas/berkeley-kitchen-cabinets-hero.webp"
        imageAlt="Custom kitchen cabinets in Berkeley home with East Bay views and luxury finishes"
      />

      {/* Berkeley Kitchen Cabinets Overview */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic hillside homes to contemporary architectural gems, Berkeley's diverse residential landscape demands kitchen cabinet solutions that seamlessly blend intellectual sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/berkeley-kitchen-cabinets-overview.webp"
                alt="Custom kitchen cabinets in Berkeley home with East Bay views and luxury finishes"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Bespoke kitchen cabinets designed and crafted specifically for your Berkeley home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Transform your existing Berkeley kitchen cabinets with new doors, drawer fronts, and hardware while keeping the existing structure.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert restoration of vintage and historic Berkeley kitchen cabinets to preserve their original beauty and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Professional cabinet design services that maximize your Berkeley kitchen's functionality and aesthetic appeal.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Professional installation of your custom Berkeley kitchen cabinets with precision and attention to detail.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Ongoing maintenance and care services to keep your Berkeley kitchen cabinets looking and functioning perfectly.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Custom finishes including stains, paints, and glazes to match your Berkeley home's aesthetic.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Custom Stains</li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with East Bay views to evening entertaining that showcases the home's refined character, every cabinet decision reflects an understanding of how Berkeley residents truly live and enjoy their intellectual lifestyle.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/berkeley-kitchen-cabinets-1.webp"
                alt="Custom kitchen cabinets in Berkeley with East Bay views and luxury finishes"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/berkeley-kitchen-cabinets-2.webp"
                alt="Traditional kitchen cabinets in Berkeley with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/berkeley-kitchen-cabinets-3.webp"
                alt="Contemporary kitchen cabinets in Berkeley with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Custom kitchen cabinet installation in Berkeley typically takes 2-4 weeks from start to finish. This includes 1-2 weeks for precise measurements and preparation, 1-2 weeks for cabinet installation and hardware mounting, and 1 week for final adjustments and finishing. The timeline may vary depending on the complexity of your project and any custom features.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Custom cabinets are built specifically for your Berkeley kitchen with exact measurements, unique design features, and premium materials. Semi-custom cabinets are pre-made in standard sizes with limited customization options. Custom cabinets offer superior fit, quality, and design flexibility, making them the preferred choice for luxury Berkeley homes.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, we can match your existing Berkeley kitchen cabinets through careful color matching, wood species identification, and finish replication. We can also create complementary cabinets that work harmoniously with your existing design while providing the functionality and quality you need.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Transform Your Berkeley Kitchen with Custom Cabinets?"
        description="Join Berkeley's most discerning homeowners who have chosen PineWood Cabinets for their kitchen cabinet needs. Schedule a private consultation to discuss how we can bring your vision to life with bespoke cabinetry solutions."
        primaryCTA={{
