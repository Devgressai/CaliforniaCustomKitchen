...
export const metadata: Metadata = {
  title: 'Kitchen Cabinets Danville | Custom Cabinet Design | PineWood Cabinets',
  description: 'Custom kitchen cabinets for Danville luxury homes. Expert cabinet makers serving East Bay with bespoke cabinetry solutions.',
  keywords: [
    'kitchen cabinets Danville',
    'custom kitchen cabinets Danville',
    'cabinet design Danville',
    'kitchen cabinets East Bay',
    'kitchen cabinets Alamo',
    'kitchen cabinets Walnut Creek',
  ...
  openGraph: {
    title: 'Kitchen Cabinets Danville | Custom Cabinet Design | PineWood Cabinets',
    description: 'Custom kitchen cabinets for Danville luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Cabinets Danville",
  "Custom kitchen cabinets for Danville luxury homes in East Bay",
  "Kitchen Cabinets",
  ["Danville, CA", "East Bay, CA", "Alamo, CA", "Walnut Creek, CA", "San Ramon, CA"]
)

export default function KitchenCabinetsDanvillePage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Kitchen Cabinets Danville"
        subtitle="Custom Cabinet Design"
        description="Serving Danville's discerning homeowners with custom kitchen cabinets that transform East Bay homes into luxury culinary spaces."
        imageSrc="service-areas/danville-kitchen-cabinets-hero.webp"
        imageAlt="Custom kitchen cabinets in Danville home with East Bay views and luxury finishes"
      />

      {/* Danville Kitchen Cabinets Overview */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
                Danville Kitchen Cabinet Excellence
              </h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Danville represents the sophisticated heart of East Bay living—where suburban elegance meets refined luxury. Our Danville kitchen cabinet clients understand that true elegance lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From traditional estates to contemporary architectural gems, Danville's diverse residential landscape demands kitchen cabinet solutions that seamlessly blend suburban sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/danville-kitchen-cabinets-overview.webp"
                alt="Custom kitchen cabinets in Danville home with East Bay views and luxury finishes"
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Kitchen Cabinet Services for Danville
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive kitchen cabinet services are tailored to meet the unique needs of Danville's diverse architectural styles and East Bay lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Bespoke kitchen cabinets designed and crafted specifically for your Danville home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Transform your existing Danville kitchen cabinets with new doors, drawer fronts, and hardware while keeping the existing structure.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert restoration of vintage and historic Danville kitchen cabinets to preserve their original beauty and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Professional cabinet design services that maximize your Danville kitchen's functionality and aesthetic appeal.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Professional installation of your custom Danville kitchen cabinets with precision and attention to detail.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Ongoing maintenance and care services to keep your Danville kitchen cabinets looking and functioning perfectly.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              We use only the finest materials for your Danville kitchen cabinets, ensuring beauty, durability, and lasting value.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Custom finishes including stains, paints, and glazes to match your Danville home's aesthetic.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Custom Stains</li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Danville's unique East Bay environment creates distinct requirements for kitchen cabinets. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with East Bay views to evening entertaining that showcases the home's refined character, every cabinet decision reflects an understanding of how Danville residents truly live and enjoy their sophisticated lifestyle.
              </p>
            </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Featured Danville Kitchen Cabinet Projects
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of kitchen cabinet projects throughout Danville's most prestigious East Bay neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/danville-kitchen-cabinets-1.webp"
                alt="Custom kitchen cabinets in Danville with East Bay views and luxury finishes"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/danville-kitchen-cabinets-2.webp"
                alt="Traditional kitchen cabinets in Danville with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/danville-kitchen-cabinets-3.webp"
                alt="Contemporary kitchen cabinets in Danville with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Danville Kitchen Cabinet FAQ
            </h2>
            <p className="text-xl text-charcoal/80">
              Common questions about kitchen cabinet services in Danville
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Custom kitchen cabinet installation in Danville typically takes 2-4 weeks from start to finish. This includes 1-2 weeks for precise measurements and preparation, 1-2 weeks for cabinet installation and hardware mounting, and 1 week for final adjustments and finishing. The timeline may vary depending on the complexity of your project and any custom features.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Custom cabinets are built specifically for your Danville home with exact measurements, unique design features, and premium materials. Semi-custom cabinets are pre-made in standard sizes with limited customization options. Custom cabinets offer superior fit, quality, and design flexibility, making them the preferred choice for luxury Danville homes.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, we can match your existing Danville kitchen cabinets through careful color matching, wood species identification, and finish replication. We can also create complementary cabinets that work harmoniously with your existing design while providing the functionality and quality you need.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Transform Your Danville Kitchen with Custom Cabinets?"
        description="Join Danville's most discerning homeowners who have chosen PineWood Cabinets for their kitchen cabinet needs. Schedule a private consultation to discuss how we can bring your vision to life with bespoke cabinetry solutions."
        primaryCTA={{
