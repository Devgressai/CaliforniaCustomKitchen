...
export const metadata: Metadata = {
  title: 'Kitchen Remodel Salinas | Custom Kitchen Remodeling | PineWood Cabinets',
  description: 'Custom kitchen remodeling for Salinas luxury homes. Expert kitchen remodelers serving Monterey County with complete renovation services.',
  keywords: [
    'kitchen remodel Salinas',
    'kitchen remodeling Salinas',
  ...
  openGraph: {
    title: 'Kitchen Remodel Salinas | Custom Kitchen Remodeling | PineWood Cabinets',
    description: 'Custom kitchen remodeling for Salinas luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Remodel Salinas",
  "Custom kitchen remodeling for Salinas luxury homes in Monterey County",
  "Kitchen Remodeling",
  ["Salinas, CA", "Carmel, CA", "Monterey, CA", "Big Sur, CA", "Pacific Grove, CA"]
)

export default function KitchenRemodelSalinasPage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Kitchen Remodel Salinas"
        subtitle="Custom Kitchen Remodeling"
        description="Serving Salinas' discerning homeowners with complete kitchen remodeling services that transform Monterey County homes into luxury culinary spaces."
        imageSrc="service-areas/salinas-kitchen-remodel-hero.webp"
        imageAlt="Custom kitchen remodel in Salinas home with valley views and luxury finishes"
      />

      {/* Salinas Kitchen Remodel Overview */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
                Salinas Kitchen Remodel Excellence
              </h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Salinas represents the sophisticated heart of California's Central Coast—where agricultural elegance meets refined luxury. Our Salinas kitchen remodel clients understand that true elegance lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic farmhouses to contemporary architectural gems, Salinas' diverse residential landscape demands kitchen remodel solutions that seamlessly blend agricultural sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/salinas-kitchen-remodel-overview.webp"
                alt="Custom kitchen remodel in Salinas home with valley views and luxury finishes"
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Kitchen Remodel Services for Salinas
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive kitchen remodel services are tailored to meet the unique needs of Salinas' diverse architectural styles and agricultural lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Full kitchen transformation from design to completion, tailored to your Salinas home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive renovation services that update your Salinas kitchen while preserving its architectural integrity and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cosmetic updates that give your Salinas kitchen a fresh, modern look without the complexity of a full remodel.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven remodel process ensures your Salinas kitchen transformation exceeds expectations and perfectly reflects your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your Salinas kitchen remodel.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your Salinas kitchen remodel.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional construction and installation of your approved Salinas kitchen remodel design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Demolition</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive final walkthrough and project completion for your Salinas kitchen remodel.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Salinas' unique agricultural environment creates distinct requirements for kitchen remodels. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with valley views to evening entertaining that showcases the home's refined character, every remodel decision reflects an understanding of how Salinas residents truly live and enjoy their agricultural lifestyle.
              </p>
            </div>
            <div className="space-y-6">
              <div className="bg-ivory/10 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3">Valley Integration</h3>
                <p className="text-ivory/80">Remodel designs that maximize valley and agricultural views while maintaining functionality and aesthetic appeal.</p>
              </div>
              <div className="bg-ivory/10 p-6 rounded-lg">
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Featured Salinas Kitchen Remodel Projects
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of kitchen remodel projects throughout Salinas' most prestigious agricultural neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/salinas-kitchen-remodel-1.webp"
                alt="Custom kitchen remodel in Salinas home with valley views and luxury finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold text-charcoal mb-2">Valley Views</h3>
                <p className="text-charcoal/70 mb-4">Kitchen remodel that maximizes valley and agricultural views while maintaining functionality and luxury.</p>
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/salinas-kitchen-remodel-2.webp"
                alt="Traditional kitchen remodel in Salinas with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/salinas-kitchen-remodel-3.webp"
                alt="Contemporary kitchen remodel in Salinas with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Salinas Kitchen Remodel FAQ
            </h2>
            <p className="text-xl text-charcoal/80">
              Common questions about kitchen remodel services in Salinas
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A complete kitchen remodel in Salinas typically takes 8-12 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for demolition and preparation, 4-6 weeks for construction and installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the scope of work and any unexpected issues that arise.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, most of our Salinas kitchen remodel clients choose to stay in their homes during the project. We work to minimize disruption by setting up temporary kitchen facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Transform Your Salinas Kitchen with a Complete Remodel?"
        description="Join Salinas' most discerning homeowners who have chosen PineWood Cabinets for their kitchen remodel needs. Schedule a private consultation to discuss how we can bring your vision to life with comprehensive remodeling services."
        primaryCTA={{
