...
export const metadata: Metadata = {
  title: 'Kitchen Cabinets Windsor | Kitchen Cabinets | PineWood Cabinets',
  description: 'Custom kitchen cabinets and cabinetry for Windsor luxury homes. Expert craftsmen serving North Bay with luxury kitchen solutions.',
  keywords: [
    'kitchen-cabinets windsor',
    'kitchen-cabinets windsor',
    'luxury kitchen-cabinets windsor',
    'custom kitchen-cabinets windsor',
    'kitchen-cabinets north bay',
    'kitchen-cabinets California'
  ],
  openGraph: {
    title: 'Kitchen Cabinets Windsor | Kitchen Cabinets | PineWood Cabinets',
    description: 'Custom kitchen cabinets and cabinetry for Windsor luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Cabinets Windsor",
  "Custom kitchen cabinets and cabinetry for Windsor luxury homes for Windsor luxury homes in North Bay",
  "Kitchen Cabinets",
  ["Windsor, CA", "North Bay, CA", "California"]
)

export default function KitchenCabinetsWindsorPage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Kitchen Cabinets Windsor"
        subtitle="Kitchen Cabinets"
        description="Serving Windsor's most discerning homeowners with Custom kitchen cabinets and cabinetry that transform North Bay homes into luxury culinary spaces."
        imageSrc="service-areas/windsor-kitchen-cabinets-hero.webp"
        imageAlt="Kitchen Cabinets in Windsor home with luxury finishes and North Bay views"
      />

      {/* Windsor Kitchen Cabinets Overview */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
                Windsor Kitchen Cabinets Excellence
              </h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Windsor represents the pinnacle of North Bay luxury—where sophistication meets refined elegance. Our Windsor kitchen-cabinets clients understand that true luxury lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic estates to contemporary architectural gems, Windsor's diverse residential landscape demands kitchen-cabinets solutions that seamlessly blend North Bay sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/windsor-kitchen-cabinets-overview.webp"
                alt="Kitchen Cabinets in Windsor home with luxury finishes and North Bay views"
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Kitchen Cabinets Services for Windsor
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive kitchen-cabinets services are tailored to meet the unique needs of Windsor's diverse architectural styles and North Bay lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Full kitchen-cabinets from concept to completion, tailored to your Windsor home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive renovation services that update your Windsor kitchen-cabinets while preserving its architectural integrity and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cosmetic updates that give your Windsor kitchen-cabinets a fresh, modern look without the complexity of a full renovation.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Strategic expansion of your Windsor kitchen-cabinets space to improve functionality and accommodate your growing needs.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Modern updates that bring your Windsor kitchen-cabinets up to current standards while maintaining its unique character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert restoration of historic and vintage Windsor kitchen-cabinets to preserve their original beauty and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven process ensures your Windsor kitchen-cabinets exceeds expectations and perfectly reflects your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your Windsor kitchen-cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your Windsor kitchen-cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
                <li>• Material selection</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional construction and installation of your approved Windsor kitchen-cabinets design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Demolition</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive final walkthrough and project completion for your Windsor kitchen-cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Windsor's unique North Bay environment creates distinct requirements for kitchen-cabinets. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Featured Windsor Kitchen Cabinets Projects
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of kitchen-cabinets projects throughout Windsor's most prestigious North Bay neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/windsor-kitchen-cabinets-1.webp"
                alt="Kitchen Cabinets in Windsor home with North Bay views and luxury finishes"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/windsor-kitchen-cabinets-2.webp"
                alt="Traditional kitchen-cabinets in Windsor with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/windsor-kitchen-cabinets-3.webp"
                alt="Contemporary kitchen-cabinets in Windsor with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Windsor Kitchen Cabinets FAQ
            </h2>
            <p className="text-xl text-charcoal/80">
              Common questions about kitchen-cabinets services in Windsor
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A complete kitchen-cabinets in Windsor typically takes 8-12 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for demolition and preparation, 4-6 weeks for construction and installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the scope of work and any unexpected issues that arise.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Create Your Dream Kitchen Cabinets in Windsor?"
        description="Join Windsor's most discerning homeowners who have chosen PineWood Cabinets for their kitchen-cabinets needs. Schedule a private consultation to discuss how we can bring your vision to life with comprehensive kitchen-cabinets services."
        primaryCTA={{
