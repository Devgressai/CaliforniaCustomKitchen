...
export const metadata: Metadata = {
  title: 'Kitchen Cabinets Marina | Custom Cabinet Design | PineWood Cabinets',
  description: 'Custom kitchen cabinets for Marina luxury homes. Expert cabinet makers serving Monterey County with bespoke cabinetry solutions.',
  keywords: [
    'kitchen cabinets Marina',
    'custom cabinets Marina',
    'cabinet design Marina',
    'cabinet makers Marina',
    'kitchen cabinetry Marina',
  ...
  openGraph: {
    title: 'Kitchen Cabinets Marina | Custom Cabinet Design | PineWood Cabinets',
    description: 'Custom kitchen cabinets for Marina luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Cabinets Marina",
  "Custom kitchen cabinets for Marina luxury homes in Monterey County",
  "Kitchen Cabinets",
...
export default function KitchenCabinetsMarinaPage() {
  return (
    <>
      ...
      <HeroQuiet
        title="Kitchen Cabinets Marina"
        subtitle="Custom Cabinet Design"
        description="Serving Marina's discerning homeowners with custom kitchen cabinets that transform Monterey County homes into luxury culinary spaces."
        imageSrc="service-areas/marina-kitchen-cabinets-hero.webp"
        imageAlt="Custom kitchen cabinets in Marina home with ocean views and luxury finishes"
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
                Marina Kitchen Cabinets Excellence
              </h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Marina represents the sophisticated heart of California's Central Coast—where coastal elegance meets refined luxury. Our Marina kitchen cabinet clients understand that true elegance lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic cottages to contemporary architectural gems, Marina's diverse residential landscape demands kitchen cabinet solutions that seamlessly blend coastal sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                ...
                alt="Custom kitchen cabinets in Marina home with ocean views and luxury finishes"
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Kitchen Cabinet Services for Marina
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive kitchen cabinet services are tailored to meet the unique needs of Marina's diverse architectural styles and coastal lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Handcrafted kitchen cabinets designed and built specifically for your Marina kitchen space.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Transform your existing Marina kitchen cabinets with new doors, drawer fronts, and hardware.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert restoration of historic and vintage Marina kitchen cabinets to preserve their original beauty and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Modern updates that bring your Marina kitchen cabinets up to current standards while maintaining their unique character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Strategic expansion of your Marina kitchen cabinet space to improve functionality and accommodate your growing needs.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cosmetic updates that give your Marina kitchen cabinets a fresh, modern look without the complexity of a full replacement.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven cabinet design process ensures your Marina kitchen cabinets exceed expectations and perfectly reflect your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your Marina kitchen cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed cabinet design plans and 3D renderings for your Marina kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional construction and installation of your approved Marina kitchen cabinet design.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Demolition</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive final walkthrough and project completion for your Marina kitchen cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Marina's unique coastal environment creates distinct requirements for kitchen cabinets. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with ocean views to evening entertaining that showcases the home's refined character, every cabinet decision reflects an understanding of how Marina residents truly live and enjoy their coastal lifestyle.
              </p>
            </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Featured Marina Kitchen Cabinet Projects
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of kitchen cabinet projects throughout Marina's most prestigious coastal neighborhoods.
            </p>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Marina Kitchen Cabinets FAQ
            </h2>
            <p className="text-xl text-charcoal/80">
              Common questions about kitchen cabinet services in Marina
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Custom kitchen cabinets in Marina typically take 8-12 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for demolition and preparation, 4-6 weeks for construction and installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the complexity of the design and any custom features requested.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, most of our Marina kitchen cabinet clients choose to stay in their homes during the installation. We work to minimize disruption by setting up temporary kitchen facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Create Your Dream Kitchen Cabinets in Marina?"
        description="Join Marina's most discerning homeowners who have chosen PineWood Cabinets for their kitchen cabinet needs. Schedule a private consultation to discuss how we can bring your vision to life with bespoke design and craftsmanship."
        primaryCTA={{
