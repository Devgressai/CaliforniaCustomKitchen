...
export const metadata: Metadata = {
  title: 'Custom Kitchen Belvedere | Custom Kitchen Design | PineWood Cabinets',
  description: 'Custom kitchen design for Belvedere luxury homes. Expert custom kitchen designers serving Marin County with bespoke cabinetry.',
  keywords: [
    ...
    'custom kitchen San Rafael',
    'custom kitchen Novato',
    'custom kitchen Sausalito',
    'custom kitchen Fairfax',
    'custom kitchen San Anselmo',
    'custom kitchen Ross',
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Belvedere represents the pinnacle of Marin County living—where island sophistication meets unparalleled luxury. Our Belvedere custom kitchen clients understand that true elegance lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From waterfront estates to hillside architectural gems, Belvedere's diverse residential landscape demands custom kitchen solutions that seamlessly blend island sophistication with luxury functionality and uncompromising quality.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Handcrafted custom cabinetry designed and built specifically for your Belvedere kitchen space.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Complete kitchen renovation services that transform your Belvedere space while preserving its character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive kitchen remodel services that update your Belvedere kitchen while maintaining its architectural integrity.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven design process ensures your Belvedere custom kitchen exceeds expectations and perfectly reflects your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional installation and final walkthrough of your Belvedere custom kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Belvedere's unique Marin County environment creates distinct requirements for custom kitchen design. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-charcoal/70 mb-4">Custom kitchen design that maximizes San Francisco Bay and city views while maintaining functionality and luxury.</p>
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A complete custom kitchen project in Belvedere typically takes 10-14 weeks from start to finish. This includes 2-3 weeks for design and planning, 6-8 weeks for custom construction in our workshop, 1-2 weeks for installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the complexity of your custom requirements.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A truly custom kitchen is designed and built specifically for your Belvedere home's unique space, architectural style, and your personal needs. This includes custom measurements, handcrafted cabinetry, personalized storage solutions, and design elements that reflect your individual style and lifestyle requirements.
              </p>
            </div>
      ...
      <CTASection
        ...
        description="Join Belvedere's most discerning homeowners who have chosen PineWood Cabinets for their custom kitchen needs. Schedule a private consultation to discuss how we can bring your vision to life with bespoke design and craftsmanship."
        primaryCTA={{
