...
export const metadata: Metadata = {
  title: 'Custom Kitchen Alameda | Custom Kitchen Design | PineWood Cabinets',
  description: 'Custom kitchen design for Alameda luxury homes. Expert custom kitchen designers serving East Bay with bespoke cabinetry.',
  keywords: [
...
export default function CustomKitchenAlamedaPage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Custom Kitchen Alameda"
        ...
        imageSrc="service-areas/alameda-custom-kitchen-hero.webp"
        imageAlt="Custom kitchen design in Alameda home with East Bay views and luxury finishes"
      />

      {/* Alameda Custom Kitchen Overview */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
                Alameda Custom Kitchen Excellence
              </h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Alameda represents the sophisticated heart of East Bay living—where island charm meets refined luxury. Our Alameda custom kitchen clients understand that true elegance lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From Victorian homes to contemporary architectural gems, Alameda's diverse residential landscape demands custom kitchen solutions that seamlessly blend island sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/alameda-custom-kitchen-overview.webp"
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Custom Kitchen Services for Alameda
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive custom kitchen services are tailored to meet the unique needs of Alameda's diverse architectural styles and East Bay lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Handcrafted custom cabinetry designed and built specifically for your Alameda kitchen space.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Complete kitchen renovation services that transform your Alameda space while preserving its character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive kitchen remodel services that update your Alameda kitchen while maintaining its architectural integrity.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven design process ensures your Alameda custom kitchen exceeds expectations and perfectly reflects your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your Alameda custom kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your Alameda custom kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
                <li>• Material selection</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional installation and final walkthrough of your Alameda custom kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Alameda's unique East Bay environment creates distinct requirements for custom kitchen design. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Featured Alameda Custom Kitchen Projects
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of custom kitchen projects throughout Alameda's most prestigious East Bay neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/alameda-custom-kitchen-1.webp"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/alameda-custom-kitchen-2.webp"
                alt="Traditional custom kitchen in Alameda with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/alameda-custom-kitchen-3.webp"
                alt="Contemporary custom kitchen in Alameda with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Alameda Custom Kitchen FAQ
            </h2>
            <p className="text-xl text-charcoal/80">
              Common questions about custom kitchen services in Alameda
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A complete custom kitchen project in Alameda typically takes 10-14 weeks from start to finish. This includes 2-3 weeks for design and planning, 6-8 weeks for custom construction in our workshop, 1-2 weeks for installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the complexity of your custom requirements.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A truly custom kitchen is designed and built specifically for your Alameda home's unique space, architectural style, and your personal needs. This includes custom measurements, handcrafted cabinetry, personalized storage solutions, and design elements that reflect your individual style and lifestyle requirements.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Create Your Dream Custom Kitchen in Alameda?"
        description="Join Alameda's most discerning homeowners who have chosen PineWood Cabinets for their custom kitchen needs. Schedule a private consultation to discuss how we can bring your vision to life with bespoke design and craftsmanship."
        primaryCTA={{
