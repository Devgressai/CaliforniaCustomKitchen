...
export const metadata: Metadata = {
  title: 'Custom Kitchen Carmel | Luxury Kitchen Design | PineWood Cabinets',
  description: 'Custom kitchen design and cabinetry for Carmel luxury homes. Expert craftsmen serving Carmel-by-the-Sea with bespoke kitchen solutions.',
  keywords: [
  ...
  openGraph: {
    title: 'Custom Kitchen Carmel | Luxury Kitchen Design | PineWood Cabinets',
    description: 'Custom kitchen design and cabinetry for Carmel luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Custom Kitchen Carmel",
  "Custom kitchen design and cabinetry for Carmel luxury homes in Monterey County",
  "Custom Kitchens",
  ["Carmel, CA", "Carmel-by-the-Sea, CA", "Big Sur, CA", "Monterey, CA", "Pacific Grove, CA"]
)

export default function CustomKitchenCarmelPage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Custom Kitchen Carmel"
        subtitle="Luxury Kitchen Design"
        description="Serving Carmel's discerning homeowners with bespoke kitchen design and cabinetry that transforms Monterey County homes into luxury culinary spaces."
        imageSrc="service-areas/carmel-custom-kitchen-hero.webp"
        imageAlt="Custom kitchen in Carmel home with ocean views and luxury finishes"
      />

      {/* Carmel Custom Kitchen Overview */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
                Carmel Custom Kitchen Excellence
              </h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Carmel represents the sophisticated heart of California's Central Coast—where coastal elegance meets refined luxury. Our Carmel custom kitchen clients understand that true elegance lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic cottages to contemporary architectural gems, Carmel's diverse residential landscape demands custom kitchen solutions that seamlessly blend coastal sophistication with luxury functionality and uncompromising quality.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-ivory p-6 rounded-lg">
                  <h3 className="font-semibold text-charcoal mb-2">Kitchen Projects</h3>
                  <p className="text-2xl font-bold text-brass">300+</p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/carmel-custom-kitchen-overview.webp"
                alt="Custom kitchen in Carmel home with ocean views and luxury finishes"
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Custom Kitchen Services for Carmel
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive custom kitchen services are tailored to meet the unique needs of Carmel's diverse architectural styles and coastal lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Hand-crafted custom cabinetry designed and built specifically for your Carmel kitchen space and requirements.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Complete kitchen renovation services that transform your Carmel kitchen while preserving its architectural integrity.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven design process ensures your Carmel custom kitchen exceeds expectations and perfectly reflects your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Comprehensive consultation to understand your vision, needs, and budget for your Carmel custom kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Creation of detailed design plans and 3D renderings for your Carmel custom kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Space planning</li>
                <li>• 3D renderings</li>
                <li>• Material selection</li>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Hand-crafted construction of your approved Carmel custom kitchen design in our workshop.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional installation and final walkthrough for your Carmel custom kitchen.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Carmel's unique coastal environment creates distinct requirements for custom kitchens. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Featured Carmel Custom Kitchen Projects
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of custom kitchen projects throughout Carmel's most prestigious coastal neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/carmel-custom-kitchen-1.webp"
                alt="Custom kitchen in Carmel with ocean views and luxury finishes"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/carmel-custom-kitchen-2.webp"
                alt="Traditional custom kitchen in Carmel with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/carmel-custom-kitchen-3.webp"
                alt="Contemporary custom kitchen in Carmel with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Carmel Custom Kitchen FAQ
            </h2>
            <p className="text-xl text-charcoal/80">
              Common questions about custom kitchen services in Carmel
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A complete custom kitchen project in Carmel typically takes 10-16 weeks from start to finish. This includes 2-3 weeks for design and planning, 6-10 weeks for fabrication in our workshop, and 2-3 weeks for installation and finishing. The timeline may vary depending on the complexity of the design and any custom features.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Our Carmel custom kitchens are hand-crafted in our workshop using only the finest materials and traditional techniques. Each kitchen is designed specifically for your space and lifestyle, ensuring perfect fit and functionality. We also provide comprehensive project management and quality control throughout the entire process.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, we can design your Carmel custom kitchen to work with your existing appliances, or we can help you select new ones that perfectly complement your design. We work with all major appliance brands and can provide recommendations based on your cooking style and preferences.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Create Your Dream Custom Kitchen in Carmel?"
        description="Join Carmel's most discerning homeowners who have chosen PineWood Cabinets for their custom kitchen needs. Schedule a private consultation to discuss how we can bring your vision to life with bespoke design and craftsmanship."
        primaryCTA={{
