...
export const metadata: Metadata = {
  title: "Custom Kitchen Cabinets Trousdale Estates | Luxury Cabinetry Beverly Hills | PineWood Cabinets",
  description: "Museum-grade custom kitchens & bespoke cabinetry for Trousdale Estates' most prestigious homes. Serving Beverly Hills' elite with uncompromising craftsmanship since 2006.",
  keywords: [
    'custom kitchens Trousdale Estates',
    'luxury cabinetry Beverly Hills',
    'bespoke millwork Trousdale Estates CA',
    'high-end kitchen design Beverly Hills',
    'custom cabinets Trousdale Estates',
    'architectural millwork Beverly Hills',
    'luxury home renovations Trousdale Estates',
    'kitchen design Trousdale Estates',
    'custom cabinetry Beverly Hills',
    'premium kitchen cabinets Trousdale Estates'
  ],
  openGraph: {
    title: "Custom Kitchen Cabinets Trousdale Estates | PineWood Cabinets",
    description: "Museum-grade custom kitchens for Trousdale Estates' most discerning homeowners. Serving Beverly Hills' elite with uncompromising craftsmanship.",
    images: ['/images/trousdale-estates-kitchen-hero.webp'],
  },
}

const trousdaleProjects = [
  {
    id: 1,
    title: 'Modernist Masterpiece Kitchen',
    location: 'Trousdale Estates, CA',
    imageSrc: '/images/portfolio/gallery-luxury-custom-kitchen-17-sacramento-california.webp',
    alt: 'Ultra-modern kitchen with high-gloss lacquer cabinetry in Trousdale Estates contemporary home',
    description: 'A symphony of high-gloss lacquer and integrated technology for a Beverly Hills entertainment industry executive.'
  },
  {
    id: 2,
    title: 'Spanish Colonial Revival Kitchen',
    location: 'Trousdale Estates, CA',
    imageSrc: '/images/portfolio/gallery-luxury-custom-kitchen-18-sacramento-california.webp',
    alt: 'Spanish Colonial Revival kitchen with hand-carved details in Trousdale Estates historic home',
    description: 'Hand-carved details and warm wood tones honoring the neighborhood\'s architectural heritage.'
  },
  {
    id: 3,
    title: 'Entertainment Industry Chef\'s Kitchen',
    location: 'Trousdale Estates, CA',
    imageSrc: '/images/portfolio/gallery-luxury-custom-kitchen-19-sacramento-california.webp',
    alt: 'Professional chef\'s kitchen with commercial-grade appliances in Trousdale Estates home',
    description: 'Professional-grade equipment seamlessly integrated with residential luxury for a celebrity chef.'
  }
]

export default function TrousdaleEstatesPage() {
  const localBusinessSchema = generateLocalBusinessSchema("Trousdale Estates, Beverly Hills, California", {
    lat: "34.0736",
    lng: "-118.4004"
  })
  ...
  return (
    <>
      ...
      <HeroQuiet
        title="Trousdale Estates' Premier Custom Cabinetry"
        subtitle="Beverly Hills Excellence"
        description="Where Hollywood glamour meets architectural innovation. Museum-grade craftsmanship for Beverly Hills' most exclusive community, serving entertainment industry leaders and visionaries who demand nothing less than perfection."
        imageSrc="trousdale-estates-kitchen-hero.webp"
        imageAlt="Luxury custom kitchen in Trousdale Estates with high-gloss cabinetry and city views"
        primaryCTA={{
          text: "Schedule Private Consultation",
          href: "/contact"
        }}
        secondaryCTA={{
          text: "View Trousdale Estates Portfolio",
          href: "/portfolio?location=trousdale-estates"
        }}
      />
      ...
      <div className="bg-ivory py-4">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <LocationBreadcrumbs pathname="/service-areas/los-angeles/trousdale-estates" />
        </div>
      </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose-luxury">
              ...
              <p className="text-lg leading-relaxed text-charcoal/70 mb-6">
                Our Trousdale Estates clients represent the pinnacle of achievement in entertainment, technology, and global business—individuals who have shaped culture and influenced millions worldwide. They understand that true luxury lies not in ostentation, but in the quiet confidence of uncompromising quality, meticulous attention to detail, and the kind of craftsmanship that improves with age rather than diminishing over time.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Trousdale Estates Design Philosophy */}
            ...
            <div>
              ...
              <div className="prose-luxury">
                ...
                <p className="text-base leading-relaxed text-charcoal/70 mb-6">
                  We understand that our Trousdale Estates clients live at the intersection of glamour and innovation. They appreciate the heritage of fine craftsmanship while embracing the possibilities of modern technology and design. This duality informs every aspect of our work—from the selection of sustainably harvested hardwoods to the integration of smart home systems that anticipate needs before they're expressed.
                </p>
                <p className="text-base leading-relaxed text-charcoal/70">
                  The result is cabinetry that feels both timeless and thoroughly contemporary—pieces that honor the past while embracing the future, much like the visionary leaders who call Trousdale Estates home.
                </p>
              </div>
            </div>
            <div className="relative">
              <OptimizedImage
                filename="trousdale-estates-design-process.webp"
                alt="Custom kitchen design process for Trousdale Estates home showing architectural drawings and material samples"
                width={600}
                height={800}
      ...
      {/* Material Intelligence for Entertainment Elite */}
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="bg-charcoal text-ivory p-12 rounded-lg">
            <h3 className="font-display text-2xl font-bold mb-6">
              The Trousdale Estates Advantage: Exclusive Material Access
            </h3>
      ...
      <section className="py-24 bg-grain">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <OptimizedImage
                filename="trousdale-estates-engineering-precision.webp"
                alt="Precision engineering and tolerances in custom cabinetry manufacturing for Trousdale Estates homes"
                width={600}
                height={800}
                className="rounded-lg shadow-2xl"
              />
      ...
      {/* Trousdale Estates Lifestyle Integration */}
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl font-bold text-charcoal mb-6">Luxury Kitchen Design in trousdale-estates</h2>
          ...
          <div className="bg-grain p-12 rounded-lg">
            <h3 className="font-display text-3xl font-bold text-charcoal mb-8 text-center">
              The Beverly Hills Executive Kitchen: A Case Study
            </h3>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <OptimizedImage
                  filename="trousdale-estates-executive-kitchen-case-study.webp"
                  alt="Custom kitchen designed for Beverly Hills entertainment executive featuring smart technology integration"
                  width={600}
                  height={400}
              ...
              <div>
                <p className="text-lg leading-relaxed text-charcoal/80 mb-6">
                  For a prominent entertainment industry executive's 15,000-square-foot Trousdale Estates estate, we created a kitchen that seamlessly balances the demands of high-level business entertaining with the intimacy of family life.
                </p>
                <div className="space-y-4 text-charcoal/70">
                  <div className="flex items-start">
                    <span className="w-3 h-3 bg-brass rounded-full mt-1 mr-3 flex-shrink-0"></span>
                    <span><strong>Challenge:</strong> Accommodate 50-person industry events while maintaining daily family functionality</span>
                  </div>
                  <div className="flex items-start">
                    <span className="w-3 h-3 bg-brass rounded-full mt-1 mr-3 flex-shrink-0"></span>
      ...
      {/* Featured Trousdale Estates Projects */}
      <ProjectGrid
        projects={trousdaleProjects}
        title="Recent Trousdale Estates Commissions"
        description="Each project represents a unique collaboration with Beverly Hills' most visionary leaders, creating spaces that reflect both personal style and professional excellence."
      />

      {/* Trousdale Estates-Specific Services */}
      <section className="py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: 'Entertainment Industry Home Offices',
      ...
      {/* Trousdale Estates Architecture Integration */}
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl font-bold text-charcoal mb-6">Luxury Kitchen Design in trousdale-estates</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              ...
              <div className="prose-luxury">
                <p className="text-base leading-relaxed text-charcoal/80 mb-4">
                  Many of Trousdale Estates' most prestigious properties are iconic mid-century modern homes dating to the 1950s and 1960s. Our restoration work honors original architectural intent while incorporating modern functionality and technology.
                </p>
                <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <div className="relative">
              <OptimizedImage
                filename="trousdale-estates-mid-century-restoration.webp"
                alt="Mid-century modern kitchen restoration with period-appropriate cabinetry in Trousdale Estates home"
                width={600}
                height={800}
                className="rounded-lg shadow-2xl"
              />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative order-2 lg:order-1">
              <OptimizedImage
                filename="trousdale-estates-contemporary-design.webp"
                alt="Contemporary Trousdale Estates home with minimalist custom cabinetry design"
                width={600}
                height={800}
                className="rounded-lg shadow-2xl"
              />
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="prose-luxury">
                <p className="text-base leading-relaxed text-charcoal/80 mb-4">
                  Trousdale Estates' newer construction represents the pinnacle of contemporary residential design, often featuring dramatic architectural elements like soaring ceilings, walls of glass, and open-plan living spaces.
                </p>
                <p className="text-base leading-relaxed text-charcoal/70 mb-6">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="bg-charcoal text-ivory p-12 rounded-lg">
            <h3 className="font-display text-2xl font-bold mb-8 text-center">
              The Trousdale Estates Design Process: A Collaborative Journey
            </h3>
      ...
      {/* Frequently Asked Questions - Trousdale Estates Specific */}
      <section className="py-24 bg-grain">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="space-y-8">
            {[
              {
                question: "What makes PineWood Cabinets the preferred choice for Trousdale Estates' entertainment elite?",
                answer: "Our clients choose us because we understand the intersection of glamour and innovation that defines Beverly Hills leadership. We combine cutting-edge engineering and manufacturing techniques with time-honored craftsmanship traditions, creating cabinetry that reflects the same pursuit of excellence that drives success in entertainment and business. Our ability to integrate smart home technology, accommodate complex entertaining requirements, and deliver museum-quality finishing sets us apart in serving the unique needs of Trousdale Estates residents."
              },
              {
      ...
      {/* Final CTA */}
      <CTASection
        title="Ready to Begin Your Trousdale Estates Kitchen Journey?"
        description="Join Beverly Hills' most discerning homeowners who have chosen PineWood Cabinets for their custom cabinetry needs. Schedule a private consultation to discuss how we can bring your vision to life with uncompromising craftsmanship."
        primaryCTA={{
          text: "Schedule Private Consultation",
          href: "/contact"
        }}
