...
export const metadata: Metadata = {
  title: 'Custom Kitchens Newport Beach | Luxury Cabinetry | AV\'s Cabinets California',
  description: 'Custom kitchens and luxury cabinetry for Newport Beach\'s most prestigious coastal estates. AV\'s Cabinets brings European craftsmanship to California\'s premier beach community.',
  keywords: 'custom kitchens Newport Beach, luxury cabinetry Newport Beach, coastal estate kitchens, beach home cabinetry, luxury kitchens California',
  openGraph: {
    title: 'Custom Kitchens Newport Beach | Luxury Cabinetry | AV\'s Cabinets California',
    description: 'Custom kitchens and luxury cabinetry for Newport Beach\'s most prestigious coastal estates.',
    type: 'website',
  },
}
...
const localArchitecture = [
  {
    ...
    description: 'Newport Beach\'s coastal contemporary homes feature clean lines, natural materials, and expansive windows that frame the stunning ocean views. Our cabinetry complements these elements with minimalist designs and premium materials.',
  ...
  },
  {
    ...
    description: 'Mediterranean Revival homes in Newport Beach feature warm materials and elegant details. Our cabinetry enhances these spaces with sophisticated designs and premium materials.',
...
const localInsights = [
  {
    ...
    description: 'Newport Beach residents value the connection to the ocean and outdoor living. We design cabinetry that enhances this connection while providing the luxury and functionality expected in coastal estates.',
    icon: '🌊'
  },
  {
    title: 'Entertainment Focus',
    description: 'Many Newport Beach homes are designed for entertaining, with open floor plans and integrated indoor-outdoor living. We create cabinetry that supports this lifestyle with flexible storage and serving solutions.',
    icon: '🍽️'
  },
  {
    title: 'Luxury Living',
    description: 'Newport Beach residents expect the finest materials and finishes. We work exclusively with premium hardwoods, custom hardware, and luxury finishes that meet the highest standards.',
    icon: '💎'
  },
  {
...
const coastalConsiderations = [
  {
    ...
    description: 'Newport Beach\'s coastal environment requires special consideration for salt air and humidity. We use marine-grade materials and finishes that withstand these conditions while maintaining luxury aesthetics.',
    features: ['Marine-grade materials', 'Salt air resistance', 'Humidity protection', 'Luxury finishes']
  },
  {
    aspect: 'Ocean Views',
    description: 'Many Newport Beach homes feature stunning ocean views. Our cabinetry designs enhance these views while providing practical storage and functionality.',
...
const localMaterials = [
  {
    name: 'Teak',
    description: 'Natural oils in teak provide excellent weather resistance, making it perfect for Newport Beach\'s coastal environment. Its golden color and tight grain create a sophisticated appearance.',
...
const yachtClubCommunities = [
  {
    name: 'Balboa Island',
    description: 'An exclusive island community with stunning harbor views and luxury amenities. Our cabinetry designs complement the luxury island lifestyle.',
    features: ['Island community', 'Harbor views', 'Luxury amenities', 'Exclusive access']
  },
  {
    name: 'Newport Coast',
    description: 'A premier coastal community with custom homes and resort-style amenities. Our designs enhance the luxury coastal living experience.',
    features: ['Coastal community', 'Custom homes', 'Resort amenities', 'Ocean views']
  },
  {
    name: 'Lido Isle',
    description: 'A private island community with custom homes and marina access. Our cabinetry designs complement the luxury island lifestyle and water access.',
    features: ['Private island', 'Custom homes', 'Marina access', 'Luxury lifestyle']
  }
]
    ...
    <div className="min-h-screen bg-ivory">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="prose-luxury text-charcoal/80 mb-8">
                ...
                <p>
                  We understand the unique challenges of coastal living, from the corrosive effects of salt air to the emphasis on indoor-outdoor living. Our designs incorporate marine-grade materials and finishes that withstand coastal conditions while providing the luxury experience our clients expect.
                </p>
                <p>
                  Our local knowledge extends to Newport Beach\'s diverse architectural styles, from contemporary coastal homes to traditional beach houses. We work closely with each client to ensure our cabinetry complements their home\'s unique character while meeting their specific lifestyle requirements.
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="bg-french-gray/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-charcoal/70">Serving Newport Beach</p>
                </div>
                <div className="bg-french-gray/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-charcoal mb-2">60+ Projects</h4>
                  <p className="text-sm text-charcoal/70">Completed in Newport Beach</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-french-gray/10 p-4 rounded-lg">
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {yachtClubCommunities.map((community, index) => (
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-french-gray/20">
              <h3 className="text-lg font-semibold text-charcoal mb-3 font-display">
                How do you handle salt air and humidity in Newport Beach?
              </h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-french-gray/20">
              ...
              <p className="text-charcoal/80 leading-relaxed">
                Absolutely. Many Newport Beach homes feature seamless indoor-outdoor living. We design cabinetry that works with these spaces, including weather-resistant outdoor kitchen components and storage solutions that support entertaining.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm border border-french-gray/20">
              <h3 className="text-lg font-semibold text-charcoal mb-3 font-display">
                Do you work with yacht club communities?
              </h3>
              <p className="text-charcoal/80 leading-relaxed">
                Yes, we have extensive experience working with yacht club communities throughout Newport Beach. We understand the unique requirements and luxury standards expected in these exclusive communities.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm border border-french-gray/20">
              <h3 className="text-lg font-semibold text-charcoal mb-3 font-display">
                What is the typical timeline for a Newport Beach project?
              </h3>
              <p className="text-charcoal/80 leading-relaxed">
                Most Newport Beach projects take 6-8 months from consultation to completion. This includes 2-3 months for design and planning, 3-4 months for fabrication, and 2-3 weeks for installation. We can work around vacation schedules and seasonal considerations.
              </p>
            </div>
          </div>
        </div>
