...
export const metadata: Metadata = {
  title: "Custom Kitchen Cabinets Palos Verdes Estates | Luxury Cabinetry Los Angeles | PineWood Cabinets",
  description: "Museum-grade custom kitchens & bespoke cabinetry for Palos Verdes Estates' most prestigious homes. Serving Los Angeles' elite with uncompromising craftsmanship since 2006.",
  keywords: [
    'custom kitchens Palos Verdes Estates',
    'luxury cabinetry Los Angeles',
    'bespoke millwork Palos Verdes Estates CA',
    'high-end kitchen design Palos Verdes',
    'custom cabinets Palos Verdes Estates',
    'architectural millwork Los Angeles',
    'luxury home renovations Palos Verdes',
    'kitchen design Palos Verdes Estates',
    'custom cabinetry Los Angeles',
    'premium kitchen cabinets Palos Verdes'
  ],
  openGraph: {
    title: "Custom Kitchen Cabinets Palos Verdes Estates | PineWood Cabinets",
    description: "Museum-grade custom kitchens for Palos Verdes Estates' most discerning homeowners. Serving Los Angeles' elite with uncompromising craftsmanship.",
    images: ['/images/palos-verdes-estates-kitchen-hero.webp'],
  },
}

const palosVerdesProjects = [
  {
    id: 1,
    title: 'Oceanfront Estate Kitchen',
    location: 'Palos Verdes Estates, CA',
    imageSrc: '/images/portfolio/gallery-luxury-custom-kitchen-20-sacramento-california.webp',
    alt: 'Oceanfront kitchen with panoramic Pacific views in Palos Verdes Estates estate',
    description: 'A symphony of coastal materials and ocean-inspired design for a Palos Verdes Estates tech executive.'
  },
  {
    id: 2,
    title: 'Mediterranean Villa Kitchen',
    location: 'Palos Verdes Estates, CA',
    imageSrc: '/images/portfolio/gallery-luxury-custom-kitchen-21-sacramento-california.webp',
    alt: 'Mediterranean-inspired kitchen with hand-carved details in Palos Verdes Estates villa',
    description: 'Hand-carved details and warm wood tones honoring the neighborhood\'s Mediterranean architectural heritage.'
  },
  {
    id: 3,
    title: 'Contemporary Cliffside Kitchen',
    location: 'Palos Verdes Estates, CA',
    imageSrc: '/images/portfolio/gallery-luxury-custom-kitchen-22-sacramento-california.webp',
    alt: 'Contemporary kitchen with floor-to-ceiling windows overlooking Pacific Ocean in Palos Verdes Estates',
    description: 'Minimalist design maximizing ocean views and natural light in a contemporary Palos Verdes Estates home.'
  }
]

export default function PalosVerdesEstatesPage() {
  const localBusinessSchema = generateLocalBusinessSchema("Palos Verdes Estates, California", {
    lat: "33.7701",
    lng: "-118.3767"
  })
  ...
  return (
    <>
      ...
      <HeroQuiet
        title="Palos Verdes Estates' Premier Custom Cabinetry"
        subtitle="Los Angeles Excellence"
        description="Where coastal luxury meets architectural innovation. Museum-grade craftsmanship for Los Angeles' most exclusive community, serving business leaders and visionaries who demand nothing less than perfection."
        imageSrc="palos-verdes-estates-kitchen-hero.webp"
        imageAlt="Luxury custom kitchen in Palos Verdes Estates with ocean views and premium cabinetry"
        primaryCTA={{
          text: "Schedule Private Consultation",
          href: "/contact"
        }}
        secondaryCTA={{
          text: "View Palos Verdes Estates Portfolio",
          href: "/portfolio?location=palos-verdes-estates"
        }}
      />
      ...
      <div className="bg-ivory py-4">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <LocationBreadcrumbs pathname="/service-areas/los-angeles/palos-verdes-estates" />
        </div>
      </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h1 className="font-display text-4xl md:text-5xl font-bold text-charcoal mb-8 text-balance">Custom Kitchens in palos-verdes-estates | Luxury Cabinetry</h1>
            <div className="prose-luxury">
              <p className="text-xl leading-relaxed text-charcoal/80 mb-8">
                In Palos Verdes Estates—California's richest suburb and home to business titans, tech moguls, and international leaders—exceptional homes demand exceptional craftsmanship. Since 2006, PineWood Cabinets has served as the preferred cabinetry artisan for Los Angeles' most discerning residents, creating custom kitchens and architectural millwork that reflect both the coastal luxury of the Peninsula and the timeless principles of fine craftsmanship.
              </p>
              <p className="text-lg leading-relaxed text-charcoal/70 mb-6">
                Our Palos Verdes Estates clients represent the pinnacle of achievement in business, technology, and global commerce—individuals who have shaped industries and influenced millions worldwide. They understand that true luxury lies not in ostentation, but in the quiet confidence of uncompromising quality, meticulous attention to detail, and the kind of craftsmanship that improves with age rather than diminishing over time.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Palos Verdes Estates Design Philosophy */}
      <section className="py-24 bg-grain">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="font-display text-4xl font-bold text-charcoal mb-8">Luxury Kitchen Design in palos-verdes-estates</h2>
              <div className="prose-luxury">
                <p className="text-lg leading-relaxed text-charcoal/80 mb-6">
                  Palos Verdes Estates' architectural landscape spans from iconic Mediterranean villas to cutting-edge contemporary designs, each reflecting the unique vision of residents who have succeeded at the highest levels of business and innovation. Our design philosophy embraces this diversity while maintaining unwavering standards of craftsmanship and functionality.
                </p>
                <p className="text-base leading-relaxed text-charcoal/70 mb-6">
                  We understand that our Palos Verdes Estates clients live at the intersection of coastal luxury and innovation. They appreciate the heritage of fine craftsmanship while embracing the possibilities of modern technology and design. This duality informs every aspect of our work—from the selection of sustainably harvested hardwoods to the integration of smart home systems that anticipate needs before they're expressed.
                </p>
                <p className="text-base leading-relaxed text-charcoal/70">
                  The result is cabinetry that feels both timeless and thoroughly contemporary—pieces that honor the past while embracing the future, much like the visionary leaders who call Palos Verdes Estates home.
                </p>
              </div>
            </div>
            <div className="relative">
              <OptimizedImage
                filename="palos-verdes-estates-design-process.webp"
                alt="Custom kitchen design process for Palos Verdes Estates home showing architectural drawings and material samples"
                width={600}
                height={800}
      ...
      {/* Material Intelligence for Business Elite */}
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl font-bold text-charcoal mb-6">Luxury Kitchen Design in palos-verdes-estates</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our Palos Verdes Estates clients expect the same level of innovation in their cabinetry that they bring to their professional endeavors—cutting-edge materials, advanced engineering, and sustainable practices.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'FSC-certified hardwoods from responsibly managed forests, reflecting the environmental consciousness that defines modern leadership.',
                icon: '🌱'
              },
              {
                title: 'Precision Engineering',
                description: 'CNC precision combined with hand-crafted finishing, achieving tolerances that rival aerospace manufacturing.',
                icon: '⚙️'
              },
              {
          ...
          <div className="bg-charcoal text-ivory p-12 rounded-lg">
            <h3 className="font-display text-2xl font-bold mb-6">
              The Palos Verdes Estates Advantage: Exclusive Material Access
            </h3>
      ...
      <section className="py-24 bg-grain">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <OptimizedImage
                filename="palos-verdes-estates-engineering-precision.webp"
                alt="Precision engineering and tolerances in custom cabinetry manufacturing for Palos Verdes Estates homes"
                width={600}
                height={800}
                className="rounded-lg shadow-2xl"
              />
            ...
            <div>
              ...
              <div className="prose-luxury">
                <p className="text-lg leading-relaxed text-charcoal/80 mb-6">
                  Our Palos Verdes Estates clients operate in industries where precision isn't just preferred—it's essential for success. We apply the same exacting standards to our cabinetry, employing engineering principles and quality control processes that would be familiar to any Los Angeles R&D department.
                </p>
      ...
      {/* Palos Verdes Estates Lifestyle Integration */}
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl font-bold text-charcoal mb-6">Luxury Kitchen Design in palos-verdes-estates</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              From intimate family gatherings to business-level entertaining, our kitchens adapt to the unique rhythms of Los Angeles leadership.
            </p>
          </div>
          ...
          <div className="bg-grain p-12 rounded-lg">
            <h3 className="font-display text-3xl font-bold text-charcoal mb-8 text-center">
              The Los Angeles Executive Kitchen: A Case Study
            </h3>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <OptimizedImage
                  filename="palos-verdes-estates-executive-kitchen-case-study.webp"
                  alt="Custom kitchen designed for Los Angeles business executive featuring smart technology integration"
                  width={600}
                  height={400}
              ...
              <div>
                <p className="text-lg leading-relaxed text-charcoal/80 mb-6">
                  For a prominent business executive's 18,000-square-foot Palos Verdes Estates estate, we created a kitchen that seamlessly balances the demands of high-level business entertaining with the intimacy of family life.
                </p>
                <div className="space-y-4 text-charcoal/70">
                  <div className="flex items-start">
                    <span className="w-3 h-3 bg-brass rounded-full mt-1 mr-3 flex-shrink-0"></span>
                    <span><strong>Challenge:</strong> Accommodate 60-person business events while maintaining daily family functionality</span>
                  </div>
                  <div className="flex items-start">
                    <span className="w-3 h-3 bg-brass rounded-full mt-1 mr-3 flex-shrink-0"></span>
      ...
      {/* Featured Palos Verdes Estates Projects */}
      <ProjectGrid
        projects={palosVerdesProjects}
        title="Recent Palos Verdes Estates Commissions"
        description="Each project represents a unique collaboration with Los Angeles' most visionary leaders, creating spaces that reflect both personal style and professional excellence."
      />

      {/* Palos Verdes Estates-Specific Services */}
      <section className="py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl font-bold mb-6">Luxury Kitchen Design in palos-verdes-estates</h2>
            <p className="text-xl text-french-gray max-w-3xl mx-auto">
              Beyond custom kitchens, we provide comprehensive cabinetry solutions for every aspect of luxury living in Los Angeles' premier community.
            </p>
          </div>
      ...
      {/* Palos Verdes Estates Architecture Integration */}
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl font-bold text-charcoal mb-6">Luxury Kitchen Design in palos-verdes-estates</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              From iconic Mediterranean villas to cutting-edge contemporary designs, we ensure our cabinetry enhances rather than competes with architectural character.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              <h3 className="font-display text-2xl font-bold text-charcoal mb-6">
                Mediterranean Villa Restoration
              </h3>
              <div className="prose-luxury">
                <p className="text-base leading-relaxed text-charcoal/80 mb-4">
                  Many of Palos Verdes Estates' most prestigious properties are iconic Mediterranean villas dating to the 1920s and 1930s. Our restoration work honors original architectural intent while incorporating modern functionality and technology.
                </p>
                <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <div className="relative">
              <OptimizedImage
                filename="palos-verdes-estates-mediterranean-restoration.webp"
                alt="Mediterranean villa kitchen restoration with period-appropriate cabinetry in Palos Verdes Estates home"
                width={600}
                height={800}
                className="rounded-lg shadow-2xl"
              />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative order-2 lg:order-1">
              <OptimizedImage
                filename="palos-verdes-estates-contemporary-design.webp"
                alt="Contemporary Palos Verdes Estates home with minimalist custom cabinetry design"
                width={600}
                height={800}
                className="rounded-lg shadow-2xl"
              />
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="prose-luxury">
                <p className="text-base leading-relaxed text-charcoal/80 mb-4">
                  Palos Verdes Estates' newer construction represents the pinnacle of contemporary residential design, often featuring dramatic architectural elements like soaring ceilings, walls of glass, and open-plan living spaces.
                </p>
                <p className="text-base leading-relaxed text-charcoal/70 mb-6">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80">
              Our Palos Verdes Estates clients understand that true luxury lies in longevity. We provide comprehensive care programs to ensure your cabinetry maintains its beauty and functionality for generations.
            </p>
          </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl font-bold text-charcoal mb-6">Luxury Kitchen Design in palos-verdes-estates</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              The most successful Palos Verdes Estates projects result from collaboration between visionary architects, talented interior designers, and master craftsmen who understand the unique requirements of luxury living.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                We work closely with renowned architects like <Link href="#" className="text-deep-green hover:text-oxblood transition-colors">Frank Lloyd Wright</Link>, <Link href="#" className="text-deep-green hover:text-oxblood transition-colors">Richard Neutra</Link>, and <Link href="#" className="text-deep-green hover:text-oxblood transition-colors">Paul Williams</Link> to ensure seamless integration with architectural vision.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-deep-green/10 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Collaboration with top interior designers including <Link href="#" className="text-deep-green hover:text-oxblood transition-colors">Kelly Wearstler</Link>, <Link href="#" className="text-deep-green hover:text-oxblood transition-colors">Martyn Lawrence Bullard</Link>, and <Link href="#" className="text-deep-green hover:text-oxblood transition-colors">Jeffrey Alan Marks</Link> ensures cohesive aesthetic vision throughout the home.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-deep-green/10 rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          <div className="bg-charcoal text-ivory p-12 rounded-lg">
            <h3 className="font-display text-2xl font-bold mb-8 text-center">
              The Palos Verdes Estates Design Process: A Collaborative Journey
            </h3>
      ...
      {/* Frequently Asked Questions - Palos Verdes Estates Specific */}
      <section className="py-24 bg-grain">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl font-bold text-charcoal mb-6">Luxury Kitchen Design in palos-verdes-estates</h2>
            <p className="text-xl text-charcoal/80">
              Answers to common questions from Palos Verdes Estates homeowners about custom cabinetry projects.
            </p>
          </div>
          ...
          <div className="space-y-8">
            {[
              {
                question: "What makes PineWood Cabinets the preferred choice for Palos Verdes Estates' business elite?",
                answer: "Our clients choose us because we understand the intersection of luxury and innovation that defines Los Angeles leadership. We combine cutting-edge engineering and manufacturing techniques with time-honored craftsmanship traditions, creating cabinetry that reflects the same pursuit of excellence that drives success in business and technology. Our ability to integrate smart home technology, accommodate complex entertaining requirements, and deliver museum-quality finishing sets us apart in serving the unique needs of Palos Verdes Estates residents."
              },
              {
      ...
      {/* Final CTA */}
      <CTASection
        title="Ready to Begin Your Palos Verdes Estates Kitchen Journey?"
        description="Join Los Angeles' most discerning homeowners who have chosen PineWood Cabinets for their custom cabinetry needs. Schedule a private consultation to discuss how we can bring your vision to life with uncompromising craftsmanship."
        primaryCTA={{
          text: "Schedule Private Consultation",
          href: "/contact"
        }}
