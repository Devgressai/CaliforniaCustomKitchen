...
export const metadata: Metadata = {
  title: 'Custom Kitchens Livermore | Luxury Cabinetry East Bay | PineWood Cabinets',
  description: 'Museum-grade custom kitchens and bespoke cabinetry for Livermore\'s most prestigious homes. Serving East Bay\'s luxury market with uncompromising craftsmanship since 2006.',
  keywords: [
    'custom kitchens Livermore',
    'luxury cabinetry East Bay',
    'bespoke cabinetry Livermore',
    'custom kitchen cabinets Livermore',
    'architectural millwork East Bay',
    'luxury kitchen design Livermore',
    'custom cabinets Livermore',
    'high-end kitchen renovation',
    'premium cabinetry Livermore',
    'custom millwork East Bay',
    'kitchen design consultation Livermore',
    'luxury home renovation East Bay',
    'custom storage solutions Livermore',
    'wine cellar design Livermore',
    'kitchen remodeling Livermore'
  ],
  openGraph: {
    title: 'Custom Kitchens Livermore | Luxury Cabinetry East Bay',
    description: 'Museum-grade custom kitchens and bespoke cabinetry for Livermore\'s most prestigious homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Custom Kitchens Livermore",
  "Museum-grade custom kitchens and bespoke cabinetry for Livermore's most prestigious homes in East Bay",
  "Custom Kitchens",
  ["Livermore, CA", "East Bay, CA", "Pleasanton, CA", "Dublin, CA", "San Ramon, CA"]
)
...
export default function LivermorePage() {
  return (
    <>
      ...
      <HeroQuiet
        title="Custom Kitchens Livermore"
        subtitle="Museum-Grade Cabinetry for East Bay Luxury"
        description="Serving Livermore's discerning homeowners with uncompromising craftsmanship and luxury kitchen design since 2006."
        imageSrc="service-areas/livermore-hero.webp"
        imageAlt="Luxury custom kitchen in Livermore home with premium cabinetry and East Bay views"
      />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in livermore</h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Livermore represents the sophisticated heart of East Bay living—where suburban tranquility meets refined luxury. Our Livermore clients understand that true elegance lies in creating spaces that honor both the neighborhood's charming character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From traditional family homes to contemporary architectural gems, Livermore's diverse residential landscape demands cabinetry solutions that seamlessly blend suburban comfort with luxury design and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/livermore-overview.webp"
                alt="Livermore neighborhood landscape with luxury homes and East Bay views"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our deep understanding of Livermore's unique East Bay environment enables us to deliver cabinetry solutions that perfectly complement both the neighborhood's character and sophisticated living standards.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Livermore's East Bay setting requires cabinetry that works with the natural environment and maximizes views while maintaining functionality.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Livermore's suburban setting requires cabinetry that balances family functionality with sophisticated design and luxury materials.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Livermore's social lifestyle demands kitchens that can host both intimate family meals and larger social gatherings.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in livermore</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              From the historic downtown to the exclusive hillside communities, we serve all of Livermore's most prestigious neighborhoods.
            </p>
          </div>
      ...
      <section className="py-24 bg-charcoal text-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 font-display">Luxury Kitchen Design in livermore</h2>
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Livermore's unique East Bay environment creates distinct requirements for luxury kitchen design. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with East Bay views to evening entertaining that showcases the home's refined character, every design decision reflects an understanding of how Livermore residents truly live and enjoy their East Bay lifestyle.
              </p>
            </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in livermore</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of custom kitchens and cabinetry projects throughout Livermore's most prestigious East Bay neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/livermore-east-bay-kitchen.webp"
                alt="East Bay kitchen in Livermore with custom cabinetry and valley views"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/livermore-traditional-kitchen.webp"
                alt="Traditional kitchen in Livermore with classic cabinetry and sophisticated design"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/livermore-contemporary-kitchen.webp"
                alt="Contemporary kitchen in Livermore with modern cabinetry and clean design"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">Luxury Kitchen Design in livermore</h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our Livermore kitchens are designed to support the unique East Bay lifestyle and values of this special community.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80">
              Common questions about custom kitchen design in Livermore
            </p>
          </div>

          <div className="space-y-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              <h3 className="text-xl font-semibold text-charcoal mb-4">How do you handle Livermore's East Bay construction challenges?</h3>
              <p className="text-charcoal/70 leading-relaxed">
                Livermore's East Bay locations often present unique structural and access challenges. We work closely with local contractors and engineers to ensure our cabinetry installations are properly supported and accessible. This includes custom mounting systems, reinforced wall attachments, and careful consideration of seismic requirements. Our project management approach includes detailed site analysis and coordination with all trades to ensure smooth installation.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Create Your Livermore Dream Kitchen?"
        description="Join Livermore's most discerning homeowners who have chosen PineWood Cabinets for their custom cabinetry needs. Schedule a private consultation to discuss how we can bring your vision to life with uncompromising craftsmanship."
        primaryCTA={{
