...
export const metadata: Metadata = {
  title: 'Custom Kitchen Pebble Beach | Luxury Kitchen Design | PineWood Cabinets',
  description: 'Custom kitchen design and cabinetry for Pebble Beach luxury homes. Expert kitchen designers serving Monterey County with bespoke culinary spaces.',
  keywords: [
    'custom kitchen Pebble Beach',
    'kitchen design Pebble Beach',
    'custom cabinets Pebble Beach',
    'luxury kitchen Pebble Beach',
...
const serviceSchema = generateServiceSchema(
  "Custom Kitchen Pebble Beach",
  "Custom kitchen design and cabinetry for Pebble Beach luxury homes in Monterey County",
  "Custom Kitchens",
  ...
  return (
    <>
      ...
      <HeroQuiet
        ...
        description="Serving Pebble Beach's discerning homeowners with custom kitchen design and cabinetry that transforms Monterey County homes into luxury culinary spaces."
        imageSrc="service-areas/pebble-beach-custom-kitchen-hero.webp"
        imageAlt="Custom kitchen in Pebble Beach home with ocean views and luxury finishes"
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Pebble Beach represents the sophisticated heart of California's Central Coast—where coastal elegance meets refined luxury. Our Pebble Beach custom kitchen clients understand that true elegance lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From historic cottages to contemporary architectural gems, Pebble Beach's diverse residential landscape demands custom kitchen solutions that seamlessly blend coastal sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                ...
                alt="Custom kitchen in Pebble Beach home with ocean views and luxury finishes"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive custom kitchen services are tailored to meet the unique needs of Pebble Beach's diverse architectural styles and coastal lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Full custom kitchen design and installation from concept to completion, tailored to your Pebble Beach home's unique character and your lifestyle needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive design services that create the perfect custom kitchen for your Pebble Beach home's unique character and your lifestyle.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Bespoke cabinetry solutions that perfectly complement your Pebble Beach home's architectural style and your personal preferences.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Custom design</li>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Complete kitchen renovation services that transform your Pebble Beach kitchen while preserving its unique character and charm.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Design consultation</li>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Comprehensive kitchen remodel services that update your Pebble Beach kitchen while maintaining its architectural integrity and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Cosmetic updates that give your Pebble Beach kitchen a fresh, modern look without the complexity of a full renovation.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven design process ensures your Pebble Beach custom kitchen exceeds expectations and perfectly reflects your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Pebble Beach's unique coastal environment creates distinct requirements for custom kitchens. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of custom kitchen projects throughout Pebble Beach's most prestigious coastal neighborhoods.
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A complete custom kitchen in Pebble Beach typically takes 10-14 weeks from start to finish. This includes 2-3 weeks for design and planning, 1-2 weeks for demolition and preparation, 6-8 weeks for construction and installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the scope of work and any unexpected issues that arise.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, most of our Pebble Beach custom kitchen clients choose to stay in their homes during the project. We work to minimize disruption by setting up temporary kitchen facilities, protecting other areas of your home, and maintaining a clean, organized work environment. We'll discuss your specific needs and preferences during the planning phase.
              </p>
            </div>
      ...
      <CTASection
        ...
        description="Join Pebble Beach's most discerning homeowners who have chosen PineWood Cabinets for their custom kitchen needs. Schedule a private consultation to discuss how we can bring your vision to life with bespoke design and craftsmanship."
        primaryCTA={{
