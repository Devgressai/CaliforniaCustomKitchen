...
export const metadata: Metadata = {
  title: 'Kitchen Cabinets Alamo | Custom Kitchen Cabinets | PineWood Cabinets',
  description: 'Custom kitchen cabinets for Alamo luxury homes. Expert cabinet makers serving East Bay with bespoke cabinetry solutions.',
  keywords: [
    'kitchen cabinets Alamo',
    'custom kitchen cabinets Alamo',
    'kitchen cabinet makers Alamo',
  ...
  openGraph: {
    title: 'Kitchen Cabinets Alamo | Custom Kitchen Cabinets | PineWood Cabinets',
    description: 'Custom kitchen cabinets for Alamo luxury homes.',
    type: 'website',
  },
}
...
const serviceSchema = generateServiceSchema(
  "Kitchen Cabinets Alamo",
  "Custom kitchen cabinets for Alamo luxury homes in East Bay",
  "Kitchen Cabinets",
  ["Alamo, CA", "East Bay, CA", "Dublin, CA", "Pleasanton, CA", "Livermore, CA"]
)

export default function KitchenCabinetsAlamoPage() {
  return (
    <>
      <StructuredData service={serviceSchema} />
      
      <HeroQuiet
        title="Kitchen Cabinets Alamo"
        subtitle="Custom Kitchen Cabinets"
        description="Serving Alamo's discerning homeowners with custom kitchen cabinets that transform East Bay homes into luxury culinary spaces."
        imageSrc="service-areas/alamo-kitchen-cabinets-hero.webp"
        imageAlt="Custom kitchen cabinets in Alamo home with East Bay views and luxury finishes"
      />

      {/* Alamo Kitchen Cabinets Overview */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
                Alamo Kitchen Cabinets Excellence
              </h2>
              <p className="text-xl text-charcoal/80 mb-6 leading-relaxed">
                Alamo represents the sophisticated heart of East Bay living—where suburban elegance meets refined luxury. Our Alamo kitchen cabinet clients understand that true elegance lies in creating spaces that honor both the neighborhood's unique character and their own sophisticated lifestyle.
              </p>
              <p className="text-lg text-charcoal/70 mb-8 leading-relaxed">
                From traditional estates to contemporary architectural gems, Alamo's diverse residential landscape demands kitchen cabinet solutions that seamlessly blend suburban sophistication with luxury functionality and uncompromising quality.
              </p>
            ...
            <div className="relative">
              <img
                src="/images/service-areas/alamo-kitchen-cabinets-overview.webp"
                alt="Custom kitchen cabinets in Alamo home with East Bay views and luxury finishes"
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Kitchen Cabinet Services for Alamo
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our comprehensive kitchen cabinet services are tailored to meet the unique needs of Alamo's diverse architectural styles and East Bay lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Handcrafted custom kitchen cabinets designed and built specifically for your Alamo home's unique space and style.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Transform your existing Alamo kitchen cabinets with new doors, drawer fronts, and finishes while keeping the existing structure.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert restoration of historic and vintage Alamo kitchen cabinets to preserve their original beauty and character.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Expert repair services for your existing Alamo kitchen cabinets to restore their functionality and appearance.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 mb-4">
                Custom cabinet design services that create the perfect storage solutions for your Alamo kitchen.
              </p>
              <ul className="text-sm text-charcoal/60 space-y-1">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Our proven construction process ensures your Alamo kitchen cabinets exceed expectations and perfectly reflect your vision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Detailed design and planning for your Alamo kitchen cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal/70 mb-4">Professional installation and final walkthrough of your Alamo kitchen cabinets.</p>
              <ul className="text-sm text-charcoal/60 space-y-1">
                <li>• Professional installation</li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ivory/90 mb-6 leading-relaxed">
                Alamo's unique East Bay environment creates distinct requirements for kitchen cabinets. Our approach honors the neighborhood's character while delivering the functionality and elegance modern residents demand.
              </p>
              <p className="text-lg text-ivory/80 mb-8 leading-relaxed">
                From morning coffee with East Bay views to evening entertaining that showcases the home's refined character, every cabinet decision reflects an understanding of how Alamo residents truly live and enjoy their suburban lifestyle.
              </p>
            </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Featured Alamo Kitchen Cabinet Projects
            </h2>
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto">
              Explore our portfolio of kitchen cabinet projects throughout Alamo's most prestigious East Bay neighborhoods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/alamo-kitchen-cabinets-1.webp"
                alt="Custom kitchen cabinets in Alamo with East Bay views and luxury finishes"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/alamo-kitchen-cabinets-2.webp"
                alt="Traditional kitchen cabinets in Alamo with classic design and sophisticated finishes"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <img
                src="/images/portfolio/alamo-kitchen-cabinets-3.webp"
                alt="Contemporary kitchen cabinets in Alamo with modern design and clean lines"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 font-display">
              Alamo Kitchen Cabinets FAQ
            </h2>
            <p className="text-xl text-charcoal/80">
              Common questions about kitchen cabinet services in Alamo
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                A complete custom kitchen cabinet project in Alamo typically takes 8-12 weeks from start to finish. This includes 2-3 weeks for design and planning, 4-6 weeks for custom construction in our workshop, 1-2 weeks for installation, and 1-2 weeks for finishing and cleanup. The timeline may vary depending on the complexity of your custom requirements.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                We use only the finest materials for our Alamo kitchen cabinets, including premium hardwoods like oak, maple, cherry, and walnut, as well as high-quality plywood and MDF for painted finishes. All materials are carefully selected for durability, beauty, and suitability for your specific design requirements.
              </p>
            </div>
            ...
            <div className="bg-ivory p-8 rounded-lg shadow-sm">
              ...
              <p className="text-charcoal/70 leading-relaxed">
                Yes, we can match your existing Alamo kitchen cabinets or create new ones that complement your current design. We'll assess your existing cabinets, discuss your needs and preferences, and recommend the best approach for your specific situation and budget.
              </p>
            </div>
      ...
      <CTASection
        title="Ready to Transform Your Alamo Kitchen with Custom Cabinets?"
        description="Join Alamo's most discerning homeowners who have chosen PineWood Cabinets for their kitchen cabinet needs. Schedule a private consultation to discuss how we can bring your vision to life with bespoke cabinetry solutions."
        primaryCTA={{
