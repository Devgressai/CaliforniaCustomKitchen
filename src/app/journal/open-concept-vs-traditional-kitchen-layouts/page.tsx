...
export const metadata: Metadata = {
  title: 'Open Concept vs. Traditional Kitchen Layouts | Kitchen Design Blog | PineWood Cabinets',
  description: 'Discover the latest open concept vs. traditional kitchen layouts shaping luxury kitchen design in California's most prestigious homes.',
  keywords: 'custom kitchens, luxury cabinetry, kitchen design, California, kitchen trends, design inspiration, modern kitchens',
  openGraph: {
    title: 'Open Concept vs. Traditional Kitchen Layouts | PineWood Cabinets',
    description: 'Discover the latest open concept vs. traditional kitchen layouts shaping luxury kitchen design in California's most prestigious homes.',
    type: 'article',
...
const breadcrumbs = [
  ...
  { name: 'Open Concept vs. Traditional Kitchen Layouts', href: '/journal/open-concept-vs-traditional-kitchen-layouts' }
]

export default function openconceptvstraditionalkitchenlayouts() {
  const articleSchema = {
    headline: "Open Concept vs. Traditional Kitchen Layouts",
    description: "Discover the latest open concept vs. traditional kitchen layouts shaping luxury kitchen design in California's most prestigious homes.",
  ...
  return (
    <>
      ...
      <JournalPageLayout article="Open Concept vs. Traditional Kitchen Layouts">
        <Breadcrumbs items={breadcrumbs} />
        
        <JournalHero
          title="Open Concept vs. Traditional Kitchen Layouts"
          excerpt="Expert insights on open concept vs. traditional kitchen layouts for luxury kitchen design. Discover how California's finest homes incorporate these elements for exceptional results."
          imageSrc="journal/open-concept-vs-traditional-kitchen-layouts.webp"
          imageAlt="open concept vs. traditional kitchen layouts - luxury kitchen design"
