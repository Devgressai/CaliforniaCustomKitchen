...
export const metadata: Metadata = {
  title: 'Finishing Techniques: From Raw Wood to Masterpiece | Kitchen Design Blog | PineWood Cabinets',
  description: 'Understand finishing techniques: from raw wood to masterpiece in the creation of premium custom cabinetry.',
  keywords: 'custom kitchens, luxury cabinetry, kitchen design, California, custom cabinetry, craftsmanship, quality',
  openGraph: {
    title: 'Finishing Techniques: From Raw Wood to Masterpiece | PineWood Cabinets',
    description: 'Understand finishing techniques: from raw wood to masterpiece in the creation of premium custom cabinetry.',
    type: 'article',
    publishedTime: '2025-02-21T08:00:00.000Z',
...
const breadcrumbs = [
  ...
  { name: 'Finishing Techniques: From Raw Wood to Masterpiece', href: '/journal/finishing-techniques-from-raw-wood-to-masterpiece' }
]

export default function finishingtechniquesfromrawwoodtomasterpiece() {
  const articleSchema = {
    headline: "Finishing Techniques: From Raw Wood to Masterpiece",
    description: "Understand finishing techniques: from raw wood to masterpiece in the creation of premium custom cabinetry.",
    author: "PineWood Cabinets",
    datePublished: "2025-02-21T08:00:00.000Z",
    dateModified: "2025-02-21T08:00:00.000Z",
  ...
  return (
    <>
      ...
      <JournalPageLayout article="Finishing Techniques: From Raw Wood to Masterpiece">
        <Breadcrumbs items={breadcrumbs} />
        
        <JournalHero
          title="Finishing Techniques: From Raw Wood to Masterpiece"
          excerpt="Expert insights on finishing techniques: from raw wood to masterpiece for luxury kitchen design. Discover how California's finest homes incorporate these elements for exceptional results."
          imageSrc="journal/finishing-techniques-from-raw-wood-to-masterpiece.webp"
          imageAlt="finishing techniques: from raw wood to masterpiece - luxury kitchen design"
