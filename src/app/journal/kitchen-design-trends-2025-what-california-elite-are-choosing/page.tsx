...
export const metadata: Metadata = {
  title: 'Kitchen Design Trends 2025: What California Elite Are Choosing | Kitchen Design Blog | PineWood Cabinets',
  description: 'Discover the latest kitchen design trends 2025: what california elite are choosing shaping luxury kitchen design in California's most prestigious homes.',
  keywords: 'custom kitchens, luxury cabinetry, kitchen design, California, kitchen trends, design inspiration, modern kitchens',
  openGraph: {
    title: 'Kitchen Design Trends 2025: What California Elite Are Choosing | PineWood Cabinets',
    description: 'Discover the latest kitchen design trends 2025: what california elite are choosing shaping luxury kitchen design in California's most prestigious homes.',
    type: 'article',
...
const breadcrumbs = [
  ...
  { name: 'Kitchen Design Trends 2025: What California Elite Are Choosing', href: '/journal/kitchen-design-trends-2025-what-california-elite-are-choosing' }
]

export default function kitchendesigntrends2025whatcaliforniaelitearechoosing() {
  const articleSchema = {
    headline: "Kitchen Design Trends 2025: What California Elite Are Choosing",
    description: "Discover the latest kitchen design trends 2025: what california elite are choosing shaping luxury kitchen design in California's most prestigious homes.",
    author: "PineWood Cabinets",
    datePublished: "2025-01-01T08:00:00.000Z",
    dateModified: "2025-01-01T08:00:00.000Z",
  ...
  return (
    <>
      ...
      <JournalPageLayout article="Kitchen Design Trends 2025: What California Elite Are Choosing">
        <Breadcrumbs items={breadcrumbs} />
        
        <JournalHero
          title="Kitchen Design Trends 2025: What California Elite Are Choosing"
          excerpt="Expert insights on kitchen design trends 2025: what california elite are choosing for luxury kitchen design. Discover how California's finest homes incorporate these elements for exceptional results."
          imageSrc="journal/kitchen-design-trends-2025-what-california-elite-are-choosing.webp"
          imageAlt="kitchen design trends 2025: what california elite are choosing - luxury kitchen design"
