...
export const metadata: Metadata = {
  title: 'Design Challenge: Small Space, Big Impact | Kitchen Design Blog | PineWood Cabinets',
  description: 'Real-world examples of design challenge: small space, big impact in custom kitchen projects.',
  keywords: 'custom kitchens, luxury cabinetry, kitchen design, California, case studies, client stories, portfolio',
  openGraph: {
    title: 'Design Challenge: Small Space, Big Impact | PineWood Cabinets',
    description: 'Real-world examples of design challenge: small space, big impact in custom kitchen projects.',
    type: 'article',
    publishedTime: '2025-05-13T07:00:00.000Z',
...
const breadcrumbs = [
  ...
  { name: 'Design Challenge: Small Space, Big Impact', href: '/journal/design-challenge-small-space-big-impact' }
]

export default function designchallengesmallspacebigimpact() {
  const articleSchema = {
    headline: "Design Challenge: Small Space, Big Impact",
    description: "Real-world examples of design challenge: small space, big impact in custom kitchen projects.",
    author: "PineWood Cabinets",
    datePublished: "2025-05-13T07:00:00.000Z",
    dateModified: "2025-05-13T07:00:00.000Z",
  ...
  return (
    <>
      ...
      <JournalPageLayout article="Design Challenge: Small Space, Big Impact">
        <Breadcrumbs items={breadcrumbs} />
        
        <JournalHero
          title="Design Challenge: Small Space, Big Impact"
          excerpt="Expert insights on design challenge: small space, big impact for luxury kitchen design. Discover how California's finest homes incorporate these elements for exceptional results."
          imageSrc="journal/design-challenge-small-space-big-impact.webp"
          imageAlt="design challenge: small space, big impact - luxury kitchen design"
