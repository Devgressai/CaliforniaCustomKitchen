...
export const metadata: Metadata = {
  title: 'Pantry Organization Systems for Large Homes | Kitchen Design Blog | PineWood Cabinets',
  description: 'Learn about pantry organization systems for large homes for maximizing kitchen efficiency and organization.',
  keywords: 'custom kitchens, luxury cabinetry, kitchen design, California, kitchen storage, organization, functionality',
  openGraph: {
    title: 'Pantry Organization Systems for Large Homes | PineWood Cabinets',
    description: 'Learn about pantry organization systems for large homes for maximizing kitchen efficiency and organization.',
    type: 'article',
    publishedTime: '2025-01-30T08:00:00.000Z',
...
const breadcrumbs = [
  ...
  { name: 'Pantry Organization Systems for Large Homes', href: '/journal/pantry-organization-systems-for-large-homes' }
]

export default function pantryorganizationsystemsforlargehomes() {
  const articleSchema = {
    headline: "Pantry Organization Systems for Large Homes",
    description: "Learn about pantry organization systems for large homes for maximizing kitchen efficiency and organization.",
    author: "PineWood Cabinets",
    datePublished: "2025-01-30T08:00:00.000Z",
    dateModified: "2025-01-30T08:00:00.000Z",
  ...
  return (
    <>
      ...
      <JournalPageLayout article="Pantry Organization Systems for Large Homes">
        <Breadcrumbs items={breadcrumbs} />
        
        <JournalHero
          title="Pantry Organization Systems for Large Homes"
          excerpt="Expert insights on pantry organization systems for large homes for luxury kitchen design. Discover how California's finest homes incorporate these elements for exceptional results."
          imageSrc="journal/pantry-organization-systems-for-large-homes.webp"
          imageAlt="pantry organization systems for large homes - luxury kitchen design"
