...
export const metadata: Metadata = {
  title: 'Professional Maintenance Services | Kitchen Design Blog | PineWood Cabinets',
  description: 'Essential tips for professional maintenance services to preserve your investment cabinetry.',
  keywords: 'custom kitchens, luxury cabinetry, kitchen design, California, cabinet care, maintenance, preservation',
  openGraph: {
    title: 'Professional Maintenance Services | PineWood Cabinets',
    description: 'Essential tips for professional maintenance services to preserve your investment cabinetry.',
    type: 'article',
    publishedTime: '2025-04-08T07:00:00.000Z',
...
const breadcrumbs = [
  ...
  { name: 'Professional Maintenance Services', href: '/journal/professional-maintenance-services' }
]

export default function professionalmaintenanceservices() {
  const articleSchema = {
    headline: "Professional Maintenance Services",
    description: "Essential tips for professional maintenance services to preserve your investment cabinetry.",
    author: "PineWood Cabinets",
    datePublished: "2025-04-08T07:00:00.000Z",
    dateModified: "2025-04-08T07:00:00.000Z",
  ...
  return (
    <>
      ...
      <JournalPageLayout article="Professional Maintenance Services">
        <Breadcrumbs items={breadcrumbs} />
        
        <JournalHero
          title="Professional Maintenance Services"
          excerpt="Expert insights on professional maintenance services for luxury kitchen design. Discover how California's finest homes incorporate these elements for exceptional results."
          imageSrc="journal/professional-maintenance-services.webp"
          imageAlt="professional maintenance services - luxury kitchen design"
