...
export const metadata: Metadata = {
  title: 'Before and After: Silicon Valley Tech Executive Kitchen | Kitchen Design Blog | PineWood Cabinets',
  description: 'Real-world examples of before and after: silicon valley tech executive kitchen in custom kitchen projects.',
  keywords: 'custom kitchens, luxury cabinetry, kitchen design, California, case studies, client stories, portfolio',
  openGraph: {
    title: 'Before and After: Silicon Valley Tech Executive Kitchen | PineWood Cabinets',
    description: 'Real-world examples of before and after: silicon valley tech executive kitchen in custom kitchen projects.',
    type: 'article',
    publishedTime: '2025-05-07T07:00:00.000Z',
...
const breadcrumbs = [
  ...
  { name: 'Before and After: Silicon Valley Tech Executive Kitchen', href: '/journal/before-and-after-silicon-valley-tech-executive-kitchen' }
]

export default function beforeandaftersiliconvalleytechexecutivekitchen() {
  const articleSchema = {
    headline: "Before and After: Silicon Valley Tech Executive Kitchen",
    description: "Real-world examples of before and after: silicon valley tech executive kitchen in custom kitchen projects.",
    author: "PineWood Cabinets",
    datePublished: "2025-05-07T07:00:00.000Z",
    dateModified: "2025-05-07T07:00:00.000Z",
  ...
  return (
    <>
      ...
      <JournalPageLayout article="Before and After: Silicon Valley Tech Executive Kitchen">
        <Breadcrumbs items={breadcrumbs} />
        
        <JournalHero
          title="Before and After: Silicon Valley Tech Executive Kitchen"
          excerpt="Expert insights on before and after: silicon valley tech executive kitchen for luxury kitchen design. Discover how California's finest homes incorporate these elements for exceptional results."
          imageSrc="journal/before-and-after-silicon-valley-tech-executive-kitchen.webp"
          imageAlt="before and after: silicon valley tech executive kitchen - luxury kitchen design"
