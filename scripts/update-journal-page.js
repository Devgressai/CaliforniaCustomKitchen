...
// Generate the updated journal page content
...
// Write the updated journal page
const journalPagePath = path.join(__dirname, '..', 'src', 'app', 'journal', 'page.tsx');
fs.writeFileSync(journalPagePath, generateJournalPage());

console.log('Journal page updated successfully with all blog posts!');
